CLASS ZESZCLFI_APP_APROV_ISENCAO_JUROS DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters      TYPE string,
             ov_principal TYPE RANGE OF zsdt0090-vbeln,
           END OF ty_filter.
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zfitt_aprov_isencao_juros_lote.

ENDCLASS.



CLASS ZESZCLFI_APP_APROV_ISENCAO_JUROS IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_lotes TYPE zfitt_aprov_isencao_juros_lote.
    ...
    TRY.
        ...
        IF gs_filter IS NOT INITIAL.
          ...
          IF gs_filter-ov_principal IS NOT INITIAL.
            DELETE lt_lotes WHERE ov_principal NOT IN gs_filter-ov_principal.
          ENDIF.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_ISENCAO_JUROS WITH NON-UNIQUE KEY simul_venda ov_principal.
...
* ----------------------------------------------------------------------
    ...
    SELECT * FROM @lt_itens AS dados
         ORDER BY simul_venda , ov_principal
