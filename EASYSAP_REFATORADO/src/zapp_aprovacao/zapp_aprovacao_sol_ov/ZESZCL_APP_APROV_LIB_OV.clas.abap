CLASS ZESZCL_APP_APROV_LIB_OV DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_filter,
        filters  TYPE string,
        nrosolov TYPE RANGE OF zsds018-nro_sol_ov,
      END OF ty_filter .
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zsdtt_aprov_pagto_lote.

ENDCLASS.

CLASS ZESZCL_APP_APROV_LIB_OV IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE zsdtt_aprov_pagto_lote.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSSD_APROV_PAGTO_OV_LOTE WITH NON-UNIQUE KEY nrosolov .
