CLASS ZESZCLSD_APP_APROV_LIB_OV_ESTR DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters  TYPE string,
             nrosolov TYPE RANGE OF ZESZSSD_APROV_PAGTP_OV_ESTR-nrosolov,
             nivel    TYPE RANGE OF ZESZSSD_APROV_PAGTP_OV_ESTR-nivel,
           END OF ty_filter.
  PROTECTED SECTION.
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zsdtt_aprov_pagto_estr.

ENDCLASS.



CLASS ZESZCLSD_APP_APROV_LIB_OV_ESTR IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE zsdtt_aprov_pagto_estr.
...
** ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSSD_APROV_PAGTP_OV_ESTR WITH NON-UNIQUE KEY nrosolov nivel.
