CLASS ZESZCLFI_APP_APROV_LANC_MANUAL_ES DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             lote    TYPE RANGE OF ZESZSFI_APROV_ADIAFORN_ESTR-lote,
             empresa TYPE RANGE OF ZESZSFI_APROV_ADIAFORN_ESTR-empresa,
             nivel   TYPE RANGE OF ZESZSFI_APROV_ADIAFORN_ESTR-nivel,
           END OF ty_filter.
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS ZESZCLFI_APP_APROV_LANC_MANUAL_ES IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE  zfitt_aprov_lancmanual_estr.
...
** ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_LANCMANUAL_ESTR WITH NON-UNIQUE KEY lote empresa nivel.
