CLASS ZESZCL_APP_APROV_LANC_MANUAL_IT DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zfitt_itens_aprov_lancm.

ENDCLASS.



CLASS ZESZCL_APP_APROV_LANC_MANUAL_IT IMPLEMENTATION.
  METHOD if_rap_query_provider~select.


    DATA lt_itens TYPE TABLE OF ZESZSFI_APROV_LANCMANUAL_IT.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_LANCMANUAL_IT WITH NON-UNIQUE KEY lote.
