CLASS ZESZCLMM_APP_APROV_REQUISICAO_IT DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters  TYPE string,
             sww_wiid TYPE RANGE OF ZESZSMM_APROV_REQUISICAO_IT-sww_wiid,
             banfn    TYPE RANGE OF ZESZSMM_APROV_REQUISICAO_IT-banfn,
             bnfpo    TYPE RANGE OF ZESZSMM_APROV_REQUISICAO_IT-bnfpo,
           END OF ty_filter.
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zmmtt_aprov_requisicao_it.

ENDCLASS.

CLASS ZESZCLMM_APP_APROV_REQUISICAO_IT IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF ZESZSMM_APROV_REQUISICAO_IT.
...
*        lv_exp_msg = lo_ex_filter->get_longtext( ).
    ...
    TRY.
        ...
        IF gs_filter IS NOT INITIAL.
          ...
          IF gs_filter-banfn IS NOT INITIAL.
            DELETE lt_itens WHERE banfn NOT IN gs_filter-banfn.
          ENDIF.
...
* ---------------------------------------------------------------------------
    ...
    IF it_filters IS NOT INITIAL.
      ...
      ENDTRY.
      TRY.
          gs_filter-banfn   = CORRESPONDING #( it_filters[ name = 'BANFN' ]-range ). "#EC CI_STDSEQ
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSMM_APROV_REQUISICAO_IT WITH NON-UNIQUE KEY sww_wiid banfn bnfpo.
