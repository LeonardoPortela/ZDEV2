CLASS ZESZCLMM_APP_APROV_REQUISICAO DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             ebeln   TYPE RANGE OF ZESZSMM_APROV_REQUISICAO-ebeln,
             bnfpo   TYPE RANGE OF ZESZSMM_APROV_REQUISICAO-bnfpo,
           END OF ty_filter.
...
CLASS ZESZCLMM_APP_APROV_REQUISICAO IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF ZESZSMM_APROV_REQUISICAO.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSMM_APROV_REQUISICAO WITH NON-UNIQUE KEY sww_wiid ebeln.
