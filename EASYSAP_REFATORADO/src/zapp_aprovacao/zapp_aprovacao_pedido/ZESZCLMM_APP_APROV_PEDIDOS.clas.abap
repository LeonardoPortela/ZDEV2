CLASS ZESZCLMM_APP_APROV_PEDIDOS DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             ebeln   TYPE RANGE OF ZESZSMM_APROV_PEDIDOS-ebeln,
             empresa TYPE RANGE OF ZESZSMM_APROV_PEDIDOS-bukrs,
           END OF ty_filter.
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zmmtt_aprov_pedidos.
ENDCLASS.



CLASS ZESZCLMM_APP_APROV_PEDIDOS IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF ZESZSMM_APROV_PEDIDOS.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSMM_APROV_PEDIDOS WITH NON-UNIQUE KEY sww_wiid ebeln.
