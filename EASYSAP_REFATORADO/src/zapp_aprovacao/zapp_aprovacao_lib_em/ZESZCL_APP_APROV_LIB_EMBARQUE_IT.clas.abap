CLASS ZESZCL_APP_APROV_LIB_EMBARQUE_IT DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_filter,
        filters   TYPE string,
        orgvenda  TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_ITEM-orgvenda,
        vbeln     TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_ITEM-vbeln,
        posnr     TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_ITEM-posnr,
        seq       TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_ITEM-seq,
        esc_venda TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_ITEM-esc_venda,
      END OF ty_filter .
...
CLASS ZESZCL_APP_APROV_LIB_EMBARQUE_IT IMPLEMENTATION.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSSD_APROV_LIB_EMB_ITEM
