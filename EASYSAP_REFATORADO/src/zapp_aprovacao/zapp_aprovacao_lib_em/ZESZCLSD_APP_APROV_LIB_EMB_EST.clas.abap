CLASS ZESZCLSD_APP_APROV_LIB_EMB_EST DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_filter,
        filters   TYPE string,
        orgvenda  TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_EST-orgvenda,
        vbeln     TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_EST-vbeln,
        seq       TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_EST-seq,
        esc_venda TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_EST-esc_venda,
        nivel     TYPE RANGE OF ZESZSSD_APROV_LIB_EMB_EST-nivel,
      END OF ty_filter .
  PROTECTED SECTION.
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zsdtt_aprov_lib_emb_est.

ENDCLASS.



CLASS ZESZCLSD_APP_APROV_LIB_EMB_EST IMPLEMENTATION.

  METHOD get_paging.

    DATA lt_itens TYPE SORTED TABLE OF ZESZSSD_APROV_LIB_EMB_EST
              WITH NON-UNIQUE KEY orgvenda vbeln esc_venda seq nivel.
...
* ----------------------------------------------------------------------
    ...
    SELECT * FROM @lt_itens AS dados
         ORDER BY orgvenda, vbeln, esc_venda, seq, nivel
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA lt_itens TYPE zsdtt_aprov_lib_emb_est.
