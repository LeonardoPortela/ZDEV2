CLASS ZESZCL_APP_APROV_PAGTO_IMP DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zfitt_aprov_pagtimp.

ENDCLASS.



CLASS ZESZCL_APP_APROV_PAGTO_IMP IMPLEMENTATION.
  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF ZESZSFI_APROV_PAGTOIMP.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_PAGTOIMP WITH NON-UNIQUE KEY lote.
