CLASS ZESZCL_APP_APROV_PAGTO_IMP_IT DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             ...
             empresa TYPE RANGE OF zfi_lotes_imp-empresa,
           END OF ty_filter.
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zfitt_aprov_pagtimp_itens.

ENDCLASS.



CLASS ZESZCL_APP_APROV_PAGTO_IMP_IT IMPLEMENTATION.
  METHOD if_rap_query_provider~select.

    DATA lt_doc TYPE TABLE OF ZESZSFI_APROV_PAGTOIMP_IT.
    ...
    TRY.
        ...
        IF gs_filter IS NOT INITIAL.
          ...
          IF gs_filter-lote IS NOT INITIAL.
            DELETE lt_doc WHERE lote NOT IN gs_filter-lote.
          ENDIF.
...
** ---------------------------------------------------------------------------
        ...
        IF lines( lt_requested_sort ) > 0.
          ...
          SORT lt_doc BY (lt_sort).
        ENDIF.


        io_response->set_total_number_of_records( lines( lt_doc ) ).
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_PAGTOIMP_IT WITH NON-UNIQUE KEY lote.
