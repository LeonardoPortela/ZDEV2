CLASS ZESZCLFI_APP_APROV_ADIA_FORN_ES DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZESZCLFI_APP_APROV_ADIA_FORN_ES IMPLEMENTATION.
  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE  zttfi_adi_forn_estr.
...
** ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_ADIAFORN_ESTR WITH NON-UNIQUE KEY lote empresa nivel.
