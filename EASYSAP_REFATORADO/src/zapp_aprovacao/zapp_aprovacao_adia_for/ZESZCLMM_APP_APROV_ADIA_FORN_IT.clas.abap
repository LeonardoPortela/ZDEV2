CLASS ZESZCLMM_APP_APROV_ADIA_FORN_IT DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             lote    TYPE RANGE OF ZESZSFI_APROV_ADIAFORN_IT-lote,
             empresa TYPE RANGE OF ZESZSFI_APROV_ADIAFORN_IT-empresa,
             ebeln   TYPE RANGE OF ZESZSFI_APROV_ADIAFORN_IT-ebeln,
             ebelp   TYPE RANGE OF ZESZSFI_APROV_ADIAFORN_IT-ebelp,
           END OF ty_filter.
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zfitt_adi_forn_itens.

ENDCLASS.



CLASS ZESZCLMM_APP_APROV_ADIA_FORN_IT IMPLEMENTATION.


  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE  zfitt_adi_forn_itens.
...
*        lv_exp_msg = lo_ex_filter->get_longtext( ).
    ...
    TRY.
        CALL FUNCTION 'ZSVPL_FCN_GETWORKLIST04_APP'
          EXPORTING
            in_usuario = sy-uname
          IMPORTING
            et_item    = lt_itens.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_ADIAFORN_IT WITH NON-UNIQUE KEY lote.
