CLASS ZESZCLMM_APP_APROV_ADIA_FORN DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zfitt_adi_forn_lotes.

ENDCLASS.



CLASS ZESZCLMM_APP_APROV_ADIA_FORN IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_lotes TYPE  zfitt_adi_forn_lotes.
    ...
    TRY.
        ...
        IF gs_filter IS NOT INITIAL.
          ...
          IF gs_filter-empresa IS NOT INITIAL.
            DELETE lt_lotes WHERE empresa NOT IN gs_filter-empresa.
          ENDIF.

          IF gs_filter-lote IS NOT INITIAL.
            DELETE lt_lotes WHERE lote NOT IN gs_filter-lote.
          ENDIF.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_ADIAFORN WITH NON-UNIQUE KEY lote.
