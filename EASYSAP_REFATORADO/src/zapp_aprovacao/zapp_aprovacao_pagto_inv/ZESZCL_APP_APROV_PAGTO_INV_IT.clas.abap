CLASS ZESZCL_APP_APROV_PAGTO_INV_IT DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZESZCL_APP_APROV_PAGTO_INV_IT IMPLEMENTATION.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_PAGTOINV_DOC WITH NON-UNIQUE KEY lote.
