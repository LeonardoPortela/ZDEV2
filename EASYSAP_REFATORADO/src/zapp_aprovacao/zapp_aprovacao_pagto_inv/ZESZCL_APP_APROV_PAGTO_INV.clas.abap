CLASS ZESZCL_APP_APROV_PAGTO_INV DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zfitt_aprov_pagtoinv.

ENDCLASS.

CLASS ZESZCL_APP_APROV_PAGTO_INV IMPLEMENTATION.

  METHOD if_rap_query_provider~select.


    DATA lt_itens TYPE zfitt_aprov_pagtoinv.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_PAGTOINV_LOTE WITH NON-UNIQUE KEY lote.
