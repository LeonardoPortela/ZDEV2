CLASS ZESZCLFI_APP_APROV_PAGTO_INV_EST DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             lote    TYPE RANGE OF ZESZSFI_APROV_PAGTOINV_EST-lote,
             empresa TYPE RANGE OF ZESZSFI_APROV_PAGTOINV_EST-empresa,
             nivel   TYPE RANGE OF ZESZSFI_APROV_PAGTOINV_EST-nivel,
           END OF ty_filter.
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS ZESZCLFI_APP_APROV_PAGTO_INV_EST IMPLEMENTATION.
  METHOD get_paging.
...
* ----------------------------------------------------------------------
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA lt_itens TYPE  zfitt_aprov_pagtoinv_est.
