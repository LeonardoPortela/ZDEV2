CLASS ZESZCL_APP_APROV_LIMI_CRED_IT DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_filter,
        filters TYPE string,
        lote    TYPE RANGE OF ZESZSFI_APROV_LIM_CRED_DOC-lote,
        matnr   TYPE RANGE OF ZESZSFI_APROV_LIM_CRED_DOC-matnr,
      END OF ty_filter .
  PROTECTED SECTION.
  PRIVATE SECTION.
    ...
    METHODS get_paging
      ...
      CHANGING  ct_report   TYPE zfitt_aprov_limcred_doc.

ENDCLASS.

CLASS ZESZCL_APP_APROV_LIMI_CRED_IT IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE zfitt_aprov_limcred_doc.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF ZESZSFI_APROV_LIM_CRED_DOC WITH NON-UNIQUE KEY lote matnr.
