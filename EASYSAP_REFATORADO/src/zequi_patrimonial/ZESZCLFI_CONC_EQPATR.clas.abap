CLASS ZESZCLFI_CONC_EQPATR DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    DATA:
      gt_mep TYPE TABLE OF ZESZSFI_MEP .
    DATA:
      gt_alv1 TYPE TABLE OF ZESZSFI_CONC .
    DATA:
      gt_alv2 TYPE TABLE OF ZESZSFI_CONC .
    DATA:
...
CLASS ZESZCLFI_CONC_EQPATR IMPLEMENTATION.
