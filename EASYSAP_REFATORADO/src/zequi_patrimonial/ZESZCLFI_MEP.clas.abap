CLASS ZESZCLFI_MEP DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS gc_cta_param TYPE ZESZ_MEP_PARAMETRO VALUE '03 - CTA - Ajuste acumulado de conversão'.
    CONSTANTS gc_result_param TYPE ZESZ_MEP_PARAMETRO VALUE '15 - Resultado Período'.
    CONSTANTS gc_reserva_lucro TYPE ZESZ_MEP_PARAMETRO VALUE '09-Reserva de lucros'.

    METHODS constructor
      IMPORTING
        is_mep     TYPE ZESZSFI_MEP_PROCESS
...
private section.
  ...
  data GS_HEADER type ZESZSFI_MEP_HEADER .
  data GS_MEP_PROC type ZESZSFI_MEP_PROCESS .
  ...
  data:
    gt_mep_alv TYPE TABLE OF ZESZSFI_MEP .
  data:
    gt_mep_tab_param TYPE TABLE OF ZESZSFI_MEP .
  data:
  ...
  data GV_PARTICIPACAO type ZESZ_PART_PERC .
  ...
  methods VISUALIZAR_LOG
    importing
      !IS_LINE type ZESZSFI_MEP .
ENDCLASS.



CLASS ZESZCLFI_MEP IMPLEMENTATION.
...
*                        AND saldo_mes_ant_usd IS INITIAL
  ...
  METHOD busca_contas_config.
    ...
    DATA: lr_contasnot TYPE RANGE OF ZESZ_TP_LAN_EQ.
...
*       WITH SY-MSGV1 SY-MSGV2 SY-MSGV3 SY-MSGV4.
  ...
  METHOD gera_unico_documento.
    ...
    DATA: lva_num_lote  TYPE ZESZLOTE_NUM,
          ...
          lva_equiv_brl TYPE ZESZSLD_BRL_ANT,
          lva_equiv_usd TYPE ZESZSLD_USD_ANT,
...
*
  ...
  METHOD verifica_saldo_ano.
    ...
    DATA: lv_valor_brl TYPE ZESZ_VAL_PAT_LIQ,
          lv_valor_usd TYPE ZESZ_VAL_PAT_LIQ.
  ...
  METHOD get_saldo_ano_ant.
    ...
    DATA: lv_data_base TYPE dats.
    DATA: lv_ano TYPE gjahr .
    DATA: lr_tp_saldo TYPE RANGE OF ZESZ_TP_SALDO_EQ.
