...
SELECTION-SCREEN POSITION 71.
PARAMETERS    :  p_svinc     AS CHECKBOX             MODIF ID g1 DEFAULT ' '.
SELECTION-SCREEN COMMENT (19) text-211 FOR FIELD p_svinc.
*PARAMETERS    :  p_nvinc     AS CHECKBOX             MODIF ID g1 DEFAULT 'X'.
*SELECTION-SCREEN COMMENT (21) text-210 FOR FIELD p_nvinc.
SELECTION-SCREEN END   OF LINE.
...
MODULE user_command_0100 INPUT.
  ...
  CASE ok_code.
    ...
    WHEN 'PARAMETRO'.
      CALL TRANSACTION 'ZSDT0202'.

    WHEN 'FATURA'.
      SUBMIT zsdr0147 AND RETURN.
