class ZCL_MEMORY_VARIAVEIS_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_MEMORY_VARIAVEIS_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_MEMORY_VARIAVEIS read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_MEMORY_VARIAVEIS_AREA
    raising
      CX_SHM_INCONSISTENT
...
CLASS ZCL_MEMORY_VARIAVEIS_AREA IMPLEMENTATION.
