class ZCL_INT_OB_FUNCIONARIOS_LEGADO definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '116' ##NO_TEXT.
  data AT_DADOS_FUNCIONARIOS type ZHCMT0007_T .
...
CLASS ZCL_INT_OB_FUNCIONARIOS_LEGADO IMPLEMENTATION.
  ...
  METHOD zif_integracao_outbound~build_info_request.
    ...
    me->at_dados_funcionarios = lit_zhcmt0007.
  ...
  method ZIF_INTEGRACAO_OUTBOUND~GET_INSTANCE.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_funcionarios_legado.
    ENDIF.
  ...
  METHOD zif_integracao_outbound~set_url.
    ...
    SELECT SINGLE *
     ...
     WHERE service = 'SISTEMAS_LEGADOS_ENV_FUNCIONARIOS'.
