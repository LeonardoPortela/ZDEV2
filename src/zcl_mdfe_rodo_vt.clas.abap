class ZCL_MDFE_RODO_VT definition
  public
  final
  create public .

*"* public components of class ZCL_MDFE_RODO_VT
...
public section.
  ...
  methods GET_UF
    returning
      value(UF) type ZCHAR02 .
  methods ADD_CONDUTOR
    importing
      !XNOME type CHAR060
      !CPF type STCD2 .
protected section.
*"* protected components of class ZCL_MDFE_RODO_VT
*"* do not include other source files here!!!
private section.
*"* private components of class ZCL_MDFE_RODO_VT
*"* do not include other source files here!!!

  types:
    begin of it_condutor,
           xnome(60) type c,
           cpf type stcd2,
      end of it_condutor .

  data AT_CINT type CHAR10 .
  data AT_PLACA type CHAR07 .
  ...
  data AT_UF_PROP type ZCHAR02 .
  data AT_TPPROP type NUM1 .
  data AT_TPROD type NUM2 .
  data AT_TPCAR type NUM2 .
  data AT_UF type ZCHAR02 .
ENDCLASS.



CLASS ZCL_MDFE_RODO_VT IMPLEMENTATION.


method ADD_CONDUTOR.

   "me->it_condutor-xnome = 'teste'.
  " it_condutor->cpf   = cpf.
  " APPEND it_condutor.
