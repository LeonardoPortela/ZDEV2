interface ZIF_PERMISSAO_USUARIOS
  public .


  class-data AT_IF_PERMISSAO_USUARIO type ref to ZIF_PERMISSAO_USUARIOS .
  ...
  class-data AT_DADOS_USUARIO type ZTPM_D_M_USUARIO .
  ...
  methods SET_DS_URL_PUT
    returning
      value(R_IF_INTEGRACAO_COMB) type ref to ZIF_INTEGRACAO_COMB .
  methods POST_PERMISSAO_USUARIO
    importing
      !I_USUARIO type ZTPM_D_M_USUARIO
    exporting
      !E_ID_INTEGRACAO type ZDE_ID_INTEGRACAO
      !E_INTEGRACAO type ZINTEGRACAO
      !E_DATA type STRING
    returning
      value(R_IF_PERMISSAO_USUARIOS) type ref to ZIF_PERMISSAO_USUARIOS
    raising
      ZCX_INTEGRACAO
      ZCX_ERROR .
  methods MONTA_JSON
