CLASS zcl_int_thunders_token DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    INTERFACES zif_int_thunders_token .
...
CLASS ZCL_INT_THUNDERS_TOKEN IMPLEMENTATION.


  METHOD constructor.

    me->zif_integracao_inject~at_id_interface    = zif_integracao=>at_id_interf_thunders_token.
...
*    ENDTRY.
  ...
  METHOD zif_int_thunders_token~get_instance.

    IF zif_int_thunders_token~at_if_int_thunders_token IS NOT BOUND.
      CREATE OBJECT zif_int_thunders_token~at_if_int_thunders_token
        TYPE zcl_int_thunders_token.
    ENDIF.

    r_if_int_thunders_token = zif_int_thunders_token~at_if_int_thunders_token.

  ENDMETHOD.


  METHOD zif_int_thunders_token~get_token.
      ...
      RAISE EXCEPTION TYPE zcx_integracao
        EXPORTING
          textid = VALUE #( msgid = zcx_integracao=>zcx_servico_http_config-msgid
                            ...
                            attr1 = 'K'
                            attr2 = me->zif_int_thunders_token~at_servico )
          msgid  = zcx_integracao=>zcx_servico_http_config-msgid
          msgno  = zcx_integracao=>zcx_servico_http_config-msgno
          msgty  = 'E'
          msgv1  = 'K'
          msgv2  = CONV #( me->zif_int_thunders_token~at_servico ).
    ENDIF.
...
*    me->zif_integracao_inject~at_info_request_http-ds_body = l_xml.
    ...
    TRY.
        me->zif_int_thunders_token~set_ds_url( ).
        me->zif_int_thunders_token~set_send_msg( IMPORTING
  ...
  METHOD zif_int_thunders_token~set_ds_url.
    DATA: const_grant_type         VALUE 'grant_type',
          const_client_credentials VALUE 'client_credentials'.
...
*    me->zif_integracao_inject~at_info_request_http-ds_not_content_length = abap_true.
  ...
  METHOD zif_int_thunders_token~set_send_msg.
