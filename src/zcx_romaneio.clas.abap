...
public section.
  ...
  constants:
    begin of ZCX_ERRO_GERAL,
      msgid type symsgid value 'ZROMANEIO',
  ...
  constants:
    begin of ZCX_ERRO_QTD_EMBALAGENS,
      msgid type symsgid value 'ZROMANEIO',
    ...
    end of ZCX_ERRO_QTD_EMBALAGENS .
  constants:
    begin of ZCX_ERRO_CONSULTA_OPUS,
      msgid type symsgid value 'ZROMANEIO',
      ...
      attr3 type scx_attrname value 'MSGV3',
      attr4 type scx_attrname value 'MSGV4',
    end of ZCX_ERRO_CONSULTA_OPUS .
  constants:
    begin of ZCX_ERRO_ROM_NAO_ENCONTRADO,
      msgid type symsgid value 'ZROMANEIO',
      ...
      attr3 type scx_attrname value 'MSGV3',
      attr4 type scx_attrname value 'MSGV4',
    end of ZCX_ERRO_ROM_NAO_ENCONTRADO .
...
CLASS ZCX_ROMANEIO IMPLEMENTATION.
