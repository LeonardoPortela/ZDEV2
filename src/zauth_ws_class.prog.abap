  ...
  METHOD HANDLE_USER_COMMAND.
    ...
    CASE E_UCOMM.
      WHEN C_DEL.
        ...
        DELETE FROM ZAUTH_WEBSERVICE WHERE SERVICE = WA_SAIDA_0100-SERVICE.
      ...
      WHEN C_NOVO.
        ...
        CALL SCREEN 0110 STARTING AT 10 05." ENDING AT 130 07 .
      ...
      WHEN C_CHANGE.
        ...
        MOVE-CORRESPONDING WA_SAIDA_0100 TO ZAUTH_WEBSERVICE.
  ...
  METHOD HANDLE_USER_COMMAND.
    ...
    CASE E_UCOMM.
      WHEN C_NOVO.
        ...
        WA_SAIDA_0120-SERVICE = WA_SAIDA_0100-SERVICE.
      ...
      WHEN C_DEL.
        ...
        SELECT SINGLE *
          FROM ZAUTH_WS_0001 INTO @DATA(_WL_AUTH_WS)
         WHERE SERVICE = @WA_SAIDA_0120-SERVICE
           AND BUKRS   = @WA_SAIDA_0120-BUKRS.

        IF ( SY-SUBRC              EQ 0           ) AND
           ( WA_SAIDA_0120-SERVICE IS NOT INITIAL ) AND
           ( WA_SAIDA_0120-BUKRS   IS NOT INITIAL ).
          DELETE FROM ZAUTH_WS_0001 WHERE SERVICE = WA_SAIDA_0120-SERVICE
                                      AND BUKRS   = WA_SAIDA_0120-BUKRS.
        ELSE.
          SY-SUBRC = 0.
        ENDIF.
        ...
        IF SY-SUBRC = 0.
          DELETE IT_SAIDA_0120 WHERE SERVICE = WA_SAIDA_0120-SERVICE
                                 AND BUKRS   = WA_SAIDA_0120-BUKRS.
          MESSAGE 'Registro deletado com sucesso!' TYPE 'S'.
          PERFORM: F_REFRESH_ALV USING '0120'.
        ELSE.
