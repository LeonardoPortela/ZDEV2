...
PARAMETERS: P_CHAVE TYPE CHAR30 NO-DISPLAY. "Parâmetro que é preenchido quando chamado pelo report ZHCM_HRST_48_PA_COCKPIT_FORM
...
* Get objects
  ...
  RP_PROVIDE_FROM_LAST P0030 '01'  PN-BEGDA PN-ENDDA.
...
FORM FORM_IMPRIMIR.
  ...
  DATA: VL_FORMNAME      TYPE TDSFNAME,
        ...
        V_ADVERTENCIA    TYPE STRING.

  DATA: WA_CONTROL_PARAMETERS TYPE SSFCTRLOP,
        WA_OUTPUT_OPTIONS     TYPE SSFCOMPOP.


  VL_FORMNAME = 'ZHCMS_PA0026'.
  ...
  SELECT SINGLE * FROM T513S  INTO @DATA(WA_T513S)
    ...
    loop at l_tb_text into data(l_text).
      ...
      V_ADVERTENCIA = |{ V_ADVERTENCIA } { l_text }|.
