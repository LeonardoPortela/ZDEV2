  ...
  METHOD on_function_selected.
    ...
    CASE fcode.
      ...
      WHEN '&CLOSETREE'.
        ...
        CALL METHOD cl_gui_cfw=>dispatch.
        CALL METHOD tree1->delete_all_nodes.
        PERFORM create_hierarchy USING '2'.
      ...
      WHEN '&SELALL'.
        ...
        LOOP AT t_node_key INTO w_node_key.
          ...
          ENDLOOP.
        ENDLOOP.
        CALL METHOD tree1->frontend_update. "call this onces all updates have been made

      WHEN '&DELALL'.
        CLEAR w_item_layout.
        w_item_layout-chosen   = abap_off.
        w_item_layout-u_chosen = abap_on.
