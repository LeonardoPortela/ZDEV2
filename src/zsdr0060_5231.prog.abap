...
*   User Story 153510 // MMSILVA
    <f_lote_5231>-desc_status_icone2 =
    SWITCH #( wa_zsdt0133-status
                WHEN 1 THEN 'Carga Criada'
                WHEN 2 THEN 'Carga sem Cotação'
                WHEN 3 THEN 'Carga Cotada'
                WHEN 4 THEN 'Frete Contratado'
                WHEN 5 THEN 'Embarque Autorizado'
                WHEN 6 THEN 'Romaneio Gerado'
            ).
*   User Story 153510 // MMSILVA
...
*   User Story 153510 // MMSILVA
    <f_lote_5231>-desc_status_icone =
    SWITCH #( <f_lote_5231>-status
                WHEN 0 THEN 'Lote não Aprovado'
                WHEN 1 THEN 'Lote Aprovado'
                WHEN 2 THEN 'Lote em Carga'
                WHEN 3 THEN 'Carga sem Cotação'
                WHEN 4 THEN ''
            ).
*   User Story 153510 // MMSILVA
