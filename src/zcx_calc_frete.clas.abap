class ZCX_CALC_FRETE definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_FORN_SEM_TAB_PRECO,
      msgid type symsgid value 'ZLES',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_FORN_SEM_TAB_PRECO .
  constants:
    begin of ZCX_FORN_PC_SEM_TAB_PRECO,
      msgid type symsgid value 'ZLES',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_FORN_PC_SEM_TAB_PRECO .
...
CLASS ZCX_CALC_FRETE IMPLEMENTATION.
