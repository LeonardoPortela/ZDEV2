...
public section.
  ...
  methods ZIF_DOC_ELETRONICO~GET_URLS_DOCS
    redefinition .
  methods ZIF_DOC_ELETRONICO~SET_ENVIAR_CANCELAMENTO
    redefinition .
protected section.
private section.
ENDCLASS.
...
CLASS ZCL_MDFE_ IMPLEMENTATION.
...
*CONTINGENCIA MDF-E - JT - 06.05.2024 =================================
  ...
  METHOD ZIF_DOC_ELETRONICO~SET_ENVIAR_CANCELAMENTO.
    ...
    SUPER->ZIF_DOC_ELETRONICO~SET_ENVIAR_CANCELAMENTO(
        I_RESEND = I_RESEND
    ).

*    R_INSTANCIA = ME.
*    I_JUSTIFICATIVA_CANCEL = ME->ZIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-REASON1 &&
*             ME->ZIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-REASON2 &&
*             ME->ZIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-REASON3 &&
*             ME->ZIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-REASON4.
*
*    CALL FUNCTION 'Z_J_1B_MDFE_CANCEL'
*      EXPORTING
*        I_DOCNUM               = ME->ZIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-DOCNUM
**       I_MODE                 = '1'
