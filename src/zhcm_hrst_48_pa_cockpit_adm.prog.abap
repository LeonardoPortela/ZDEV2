*----------------------------------------------------------------------*
*  Módulo    : HCM                                                     *
*  Programa  : ZHCM_HRST_48_PA_COCKPIT_ADM                             *
*  Autor     : Henrique Martins                                        *
*  Descrição : HCM - Cockpit de Formulários na Admissão de Func. TGG   *
*  Obs.      :                                                         *
*----------------------------------------------------------------------*

REPORT zhcm_hrst_48_pa_cockpit_adm.
...
*    PF_22 AS CHECKBOX USER-COMMAND IMEDIATO, PF_23     AS CHECKBOX USER-COMMAND IMEDIATO.
    ...
    pf_18 AS CHECKBOX USER-COMMAND imediato,
    pf_19 AS CHECKBOX USER-COMMAND imediato,
    pf_20 AS CHECKBOX USER-COMMAND imediato,
    pf_21 AS CHECKBOX USER-COMMAND imediato,
    pf_22 AS CHECKBOX USER-COMMAND imediato,
    pf_23 AS CHECKBOX USER-COMMAND imediato,
    pf_24 AS CHECKBOX USER-COMMAND imediato,
    pf_25 AS CHECKBOX USER-COMMAND imediato,
    pf_26 AS CHECKBOX USER-COMMAND imediato,
    pf_27 AS CHECKBOX USER-COMMAND imediato.
