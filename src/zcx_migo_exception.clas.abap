class ZCX_MIGO_EXCEPTION definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_ESTORNADO,
      msgid type symsgid value 'ZMIGO',
      msgno type symsgno value '003',
      attr1 type scx_attrname value 'MSGV1',
      attr2 type scx_attrname value 'MSGV2',
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_ESTORNADO .
  constants:
    begin of ZCX_INFORMAR_AVISO_RECEB,
      msgid type symsgid value 'ZMIGO',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_INFORMAR_AVISO_RECEB .
...
CLASS ZCX_MIGO_EXCEPTION IMPLEMENTATION.
