...
*     TEXT_BUTTON_2         = 'Não'(101)
  ...
  IF w_answer EQ 1.
    ...
    LOOP AT gt_saida ASSIGNING FIELD-SYMBOL(<ls_saida>) WHERE check EQ abap_true.
      ...
      IF sy-subrc EQ 0.
        IF sy-uname = 'ASILVA' OR sy-uname = 'ASILVA'.
          ws_j_1bnflin-netwr  = <ls_saida>-zvlr_nf - <ls_saida>-zvg_vlr_icm. "Liq
          ws_j_1bnflin-netwrt = <ls_saida>-zvlr_nf - <ls_saida>-zvg_vlr_icm. "liq
        ELSE.
