CLASS zcl_app_aprov_pagto_inv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_app_aprov_pagto_inv IMPLEMENTATION.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_pagtoinv_lote WITH NON-UNIQUE KEY lote.
