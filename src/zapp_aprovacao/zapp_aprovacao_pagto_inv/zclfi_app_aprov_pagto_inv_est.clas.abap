CLASS zclfi_app_aprov_pagto_inv_est DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             lote    TYPE RANGE OF zsfi_aprov_pagtoinv_est-lote,
             empresa TYPE RANGE OF zsfi_aprov_pagtoinv_est-empresa,
             nivel   TYPE RANGE OF zsfi_aprov_pagtoinv_est-nivel,
           END OF ty_filter.
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS zclfi_app_aprov_pagto_inv_est IMPLEMENTATION.
  METHOD get_paging.
