CLASS zclsd_app_aprov_lib_ov_estr DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters  TYPE string,
             nrosolov TYPE RANGE OF zssd_aprov_pagtp_ov_estr-nrosolov,
             nivel    TYPE RANGE OF zssd_aprov_pagtp_ov_estr-nivel,
           END OF ty_filter.
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS zclsd_app_aprov_lib_ov_estr IMPLEMENTATION.
...
** ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zssd_aprov_pagtp_ov_estr WITH NON-UNIQUE KEY nrosolov nivel.
