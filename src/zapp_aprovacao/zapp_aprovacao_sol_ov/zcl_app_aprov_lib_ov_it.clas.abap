CLASS zcl_app_aprov_lib_ov_it DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_filter,
        filters  TYPE string,
        nrosolov TYPE RANGE OF zssd_aprov_pagto_ov_doc-nrosolov,
        item     TYPE RANGE OF zssd_aprov_pagto_ov_doc-item,
      END OF ty_filter .
...
CLASS zcl_app_aprov_lib_ov_it IMPLEMENTATION.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zssd_aprov_pagto_ov_doc WITH NON-UNIQUE KEY nrosolov item .
