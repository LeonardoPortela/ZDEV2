CLASS zcl_app_aprov_lib_ov DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_app_aprov_lib_ov IMPLEMENTATION.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zssd_aprov_pagto_ov_lote WITH NON-UNIQUE KEY nrosolov .
