CLASS zclmm_app_aprov_requisicao_it DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters  TYPE string,
             sww_wiid TYPE RANGE OF zsmm_aprov_requisicao_it-sww_wiid,
             banfn    TYPE RANGE OF zsmm_aprov_requisicao_it-banfn,
             bnfpo    TYPE RANGE OF zsmm_aprov_requisicao_it-bnfpo,
           END OF ty_filter.
...
CLASS zclmm_app_aprov_requisicao_it IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF zsmm_aprov_requisicao_it.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsmm_aprov_requisicao_it WITH NON-UNIQUE KEY sww_wiid banfn bnfpo.
