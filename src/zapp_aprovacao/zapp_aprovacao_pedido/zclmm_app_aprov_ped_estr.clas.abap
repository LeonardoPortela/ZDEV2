CLASS zclmm_app_aprov_ped_estr DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters  TYPE string,
             sww_wiid TYPE RANGE OF zsmm_aprov_ped_estr-sww_wiid,
             ebeln    TYPE RANGE OF zsmm_aprov_ped_estr-ebeln,
             frgsx    TYPE RANGE OF zsmm_aprov_ped_estr-frgsx,
             nivel    TYPE RANGE OF zsmm_aprov_ped_estr-nivel,
           END OF ty_filter.
...
CLASS zclmm_app_aprov_ped_estr IMPLEMENTATION.
  METHOD get_paging.

    DATA lt_itens TYPE SORTED TABLE OF zsmm_aprov_ped_estr WITH NON-UNIQUE KEY sww_wiid ebeln frgsx nivel.
...
* ----------------------------------------------------------------------
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA lt_itens TYPE TABLE OF zsmm_aprov_ped_estr.
