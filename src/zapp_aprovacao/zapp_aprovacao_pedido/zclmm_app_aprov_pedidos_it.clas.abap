CLASS zclmm_app_aprov_pedidos_it DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             empresa TYPE RANGE OF zsmm_aprov_pedidos_item-bukrs,
             ebeln   TYPE RANGE OF zsmm_aprov_pedidos_item-ebeln,
             ebelp   TYPE RANGE OF zsmm_aprov_pedidos_item-ebelp,
           END OF ty_filter.
...
CLASS zclmm_app_aprov_pedidos_it IMPLEMENTATION.
  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF zsmm_aprov_pedidos_item.
...
** ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsmm_aprov_pedidos_item WITH NON-UNIQUE KEY sww_wiid ebeln ebelp.
