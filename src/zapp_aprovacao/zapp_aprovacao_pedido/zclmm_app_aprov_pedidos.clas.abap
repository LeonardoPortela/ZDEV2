CLASS zclmm_app_aprov_pedidos DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             ebeln   TYPE RANGE OF zsmm_aprov_pedidos-ebeln,
             empresa TYPE RANGE OF zsmm_aprov_pedidos-bukrs,
           END OF ty_filter.
...
CLASS zclmm_app_aprov_pedidos IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF zsmm_aprov_pedidos.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsmm_aprov_pedidos WITH NON-UNIQUE KEY sww_wiid ebeln.
