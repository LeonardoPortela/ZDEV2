CLASS zcl_app_aprov_lib_embarque DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_filter,
        filters   TYPE string,
        org_venda TYPE RANGE OF zssd_aprov_lib_emb_ov-orgvenda,
        vbeln     TYPE RANGE OF zssd_aprov_lib_emb_ov-vbeln,
        seq       TYPE RANGE OF zssd_aprov_lib_emb_ov-seq,
        esc_venda TYPE RANGE OF zssd_aprov_lib_emb_ov-esc_venda,
      END OF ty_filter .
...
CLASS zcl_app_aprov_lib_embarque IMPLEMENTATION.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zssd_aprov_lib_emb_ov
