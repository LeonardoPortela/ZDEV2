CLASS zclsd_app_aprov_lib_emb_est DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_filter,
        filters   TYPE string,
        orgvenda  TYPE RANGE OF zssd_aprov_lib_emb_est-orgvenda,
        vbeln     TYPE RANGE OF zssd_aprov_lib_emb_est-vbeln,
        seq       TYPE RANGE OF zssd_aprov_lib_emb_est-seq,
        esc_venda TYPE RANGE OF zssd_aprov_lib_emb_est-esc_venda,
        nivel     TYPE RANGE OF zssd_aprov_lib_emb_est-nivel,
      END OF ty_filter .
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS zclsd_app_aprov_lib_emb_est IMPLEMENTATION.

  METHOD get_paging.

    DATA lt_itens TYPE SORTED TABLE OF zssd_aprov_lib_emb_est
