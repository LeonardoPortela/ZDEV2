CLASS zclfi_app_aprov_limi_cred_est DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters   TYPE string,
             lote      TYPE RANGE OF zsfi_aprov_lim_cred_doc_est-lote,
             nivel     TYPE RANGE OF zsfi_aprov_lim_cred_doc_est-nivel,
             aprovador TYPE RANGE OF zsfi_aprov_lim_cred_doc_est-aprovador,
           END OF ty_filter.
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS zclfi_app_aprov_limi_cred_est IMPLEMENTATION.

  METHOD get_paging.

    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_lim_cred_doc_est WITH NON-UNIQUE KEY lote nivel.
