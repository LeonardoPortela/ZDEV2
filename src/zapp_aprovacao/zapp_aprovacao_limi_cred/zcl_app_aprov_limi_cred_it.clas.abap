CLASS zcl_app_aprov_limi_cred_it DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_filter,
        filters TYPE string,
        lote    TYPE RANGE OF zsfi_aprov_lim_cred_doc-lote,
        matnr   TYPE RANGE OF zsfi_aprov_lim_cred_doc-matnr,
      END OF ty_filter .
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS zcl_app_aprov_limi_cred_it IMPLEMENTATION.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_lim_cred_doc WITH NON-UNIQUE KEY lote matnr.
