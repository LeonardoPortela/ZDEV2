CLASS zcl_app_aprov_limi_cred DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_app_aprov_limi_cred IMPLEMENTATION.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_lim_cred_lote WITH NON-UNIQUE KEY lote.
