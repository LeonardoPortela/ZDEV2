CLASS zcl_app_lib_pagto_imposto DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             lote    TYPE RANGE OF zsfi_lib_pagto_imposto_lote-lote,
             bukrs   TYPE RANGE OF zsfi_lib_pagto_imposto_lote-bukrs,
           END OF ty_filter.
...
CLASS zcl_app_lib_pagto_imposto IMPLEMENTATION.
...
*        lv_exp_msg = lo_ex_filter->get_longtext( ).
    ...
    TRY.
        ...
        DATA: lv_lote  TYPE zsfi_lib_pagto_imposto_lote-lote,
              lv_bukrs TYPE zsfi_lib_pagto_imposto_lote-bukrs.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_lib_pagto_imposto_lote WITH NON-UNIQUE KEY bukrs lote.
