CLASS zclfi_app_aprov_pagto_imp_es DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             lote    TYPE RANGE OF zsfi_aprov_pagtoimp_estr-lote,
             empresa TYPE RANGE OF zsfi_aprov_pagtoimp_estr-empresa,
             nivel   TYPE RANGE OF zsfi_aprov_pagtoimp_estr-nivel,
           END OF ty_filter.
...
CLASS zclfi_app_aprov_pagto_imp_es IMPLEMENTATION.
...
** ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_pagtoimp_estr WITH NON-UNIQUE KEY lote empresa nivel.
