CLASS zcl_app_aprov_pagto_imp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_app_aprov_pagto_imp IMPLEMENTATION.
  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF zsfi_aprov_pagtoimp.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_pagtoimp WITH NON-UNIQUE KEY lote.
