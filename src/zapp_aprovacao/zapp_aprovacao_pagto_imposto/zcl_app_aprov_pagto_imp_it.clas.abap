CLASS zcl_app_aprov_pagto_imp_it DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_app_aprov_pagto_imp_it IMPLEMENTATION.
  METHOD if_rap_query_provider~select.

    DATA lt_doc TYPE TABLE OF zsfi_aprov_pagtoimp_it.
...
*      gs_filter-param_puanos[]        = CORRESPONDING #( it_puanos[] ).
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_pagtoimp_it WITH NON-UNIQUE KEY lote.
