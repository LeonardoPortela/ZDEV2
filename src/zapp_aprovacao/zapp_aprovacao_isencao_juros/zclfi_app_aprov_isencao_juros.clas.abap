CLASS zclfi_app_aprov_isencao_juros DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zclfi_app_aprov_isencao_juros IMPLEMENTATION.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_isencao_juros WITH NON-UNIQUE KEY simul_venda ov_principal.
