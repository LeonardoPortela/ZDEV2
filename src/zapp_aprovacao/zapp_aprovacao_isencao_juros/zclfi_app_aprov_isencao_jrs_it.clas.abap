CLASS zclfi_app_aprov_isencao_jrs_it DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters      TYPE string,
             simul_venda  TYPE RANGE OF zsded003,
...
CLASS zclfi_app_aprov_isencao_jrs_it IMPLEMENTATION.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_isencao_juros_it WITH NON-UNIQUE KEY simul_venda ov_principal vbeln.
