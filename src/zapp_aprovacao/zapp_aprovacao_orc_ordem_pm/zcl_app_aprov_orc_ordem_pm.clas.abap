CLASS zcl_app_aprov_orc_ordem_pm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS gc_sup TYPE zde_tipo_ordem VALUE '2'.
    CONSTANTS gc_ord TYPE zde_tipo_ordem VALUE '1'.
    ...
    TYPES: BEGIN OF ty_filter,
             ...
             tipo    TYPE RANGE OF zde_tipo_ordem,
           END OF ty_filter.
...
CLASS zcl_app_aprov_orc_ordem_pm IMPLEMENTATION.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zspm_aprov_orc_ordem_pm WITH NON-UNIQUE KEY werks equnr aufnr.
