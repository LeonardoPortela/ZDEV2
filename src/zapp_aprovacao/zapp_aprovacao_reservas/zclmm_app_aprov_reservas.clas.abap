CLASS zclmm_app_aprov_reservas DEFINITION
...
PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             rsnum   TYPE RANGE OF zsmm_aprov_remessas-rsnum,
             rspos   TYPE RANGE OF zsmm_aprov_remessas-rspos,
             matnr   TYPE RANGE OF zsmm_aprov_remessas-matnr,
             werks   TYPE RANGE OF zsmm_aprov_remessas-werks,
           END OF ty_filter.
...
CLASS zclmm_app_aprov_reservas IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_itens TYPE TABLE OF zsmm_aprov_remessas.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsmm_aprov_remessas WITH NON-UNIQUE KEY rsnum rspos.
