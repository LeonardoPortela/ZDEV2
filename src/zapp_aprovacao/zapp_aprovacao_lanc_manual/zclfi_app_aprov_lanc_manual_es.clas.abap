CLASS zclfi_app_aprov_lanc_manual_es DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             lote    TYPE RANGE OF zsfi_aprov_adiaforn_estr-lote,
             empresa TYPE RANGE OF zsfi_aprov_adiaforn_estr-empresa,
             nivel   TYPE RANGE OF zsfi_aprov_adiaforn_estr-nivel,
           END OF ty_filter.
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS zclfi_app_aprov_lanc_manual_es IMPLEMENTATION.
...
** ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_lancmanual_estr WITH NON-UNIQUE KEY lote empresa nivel.
