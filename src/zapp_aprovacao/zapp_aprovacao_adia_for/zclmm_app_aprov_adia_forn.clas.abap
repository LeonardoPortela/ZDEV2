CLASS zclmm_app_aprov_adia_forn DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zclmm_app_aprov_adia_forn IMPLEMENTATION.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_adiaforn WITH NON-UNIQUE KEY lote.
