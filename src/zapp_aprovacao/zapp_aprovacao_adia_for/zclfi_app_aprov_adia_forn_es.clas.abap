CLASS zclfi_app_aprov_adia_forn_es DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zclfi_app_aprov_adia_forn_es IMPLEMENTATION.
...
** ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_adiaforn_estr WITH NON-UNIQUE KEY lote empresa nivel.
