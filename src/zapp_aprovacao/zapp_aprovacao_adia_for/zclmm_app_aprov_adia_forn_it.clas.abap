CLASS zclmm_app_aprov_adia_forn_it DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_filter,
             filters TYPE string,
             lote    TYPE RANGE OF zsfi_aprov_adiaforn_it-lote,
             empresa TYPE RANGE OF zsfi_aprov_adiaforn_it-empresa,
             ebeln   TYPE RANGE OF zsfi_aprov_adiaforn_it-ebeln,
             ebelp   TYPE RANGE OF zsfi_aprov_adiaforn_it-ebelp,
           END OF ty_filter.
...
CLASS zclmm_app_aprov_adia_forn_it IMPLEMENTATION.
...
* ---------------------------------------------------------------------------
  ...
  METHOD get_paging.
    ...
    DATA lt_itens TYPE SORTED TABLE OF zsfi_aprov_adiaforn_it WITH NON-UNIQUE KEY lote.
