interface ZIF_DOC_ELETRONICO
  ...
  class-data AT_INSTANCE type ref to ZIF_DOC_ELETRONICO .
  ...
  class-methods GET_INSTANCE
    ...
    returning
      value(R_INSTANCIA) type ref to ZIF_DOC_ELETRONICO
    raising
      ZCX_DOC_ELETRONICO .
  ...
  methods GET_CK_NAO_PROC_CANCEL
    exporting
      !R_INSTANCIA type ref to ZIF_DOC_ELETRONICO
    raising
      ZCX_DOC_ELETRONICO .
  ...
  methods SET_AUTORIZA_VIAGEM_TIP_FRETE
    importing
      !I_ACAO type CHAR01 default ZIF_DOC_ELETRONICO=>AT_ACAO_VIAGEM_FRETE_CRIAR
  ...
  methods SET_AUTORIZA_MDFE
    importing
      !I_ACAO type CHAR01 default ZIF_DOC_ELETRONICO=>AT_ACAO_MDFE_AUTORIZA
