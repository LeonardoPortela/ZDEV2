class ZCL_MEMORY_NFE_INBOUND definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_MEMORY_NFE_INBOUND' ##NO_TEXT.
  data ROOT type ref to ZCL_MEMORY_NFE_INBOUND_HANDLE read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_MEMORY_NFE_INBOUND
    raising
      CX_SHM_INCONSISTENT
...
CLASS ZCL_MEMORY_NFE_INBOUND IMPLEMENTATION.
