...
FORM f_selecionar_dados.
  ...
  IF tg_dd03l[] IS INITIAL.
    MESSAGE | Dados da tabela { p_db_tab } não encontrados! Tabela DD03L!| TYPE 'S' DISPLAY LIKE 'E'.
    RAISE error.
  ENDIF.
...
*-------------------------------------------------------------------------------*
  ...
  IF tg_dd03l[] IS INITIAL.
    MESSAGE | Dados da tabela { p_stcnam } não encontrados! Tabela DD03L!| TYPE 'S' DISPLAY LIKE 'E'.
    RAISE error.
  ENDIF.
  ...
  TRY.
    ...
    CATCH cx_sy_dynamic_osql_error.
      MESSAGE 'Erro ao executar o SQL Dinamico!' TYPE 'S' DISPLAY LIKE 'E'.
      RAISE error.
  ENDTRY.

  IF sy-subrc <> 0.
    MESSAGE 'Não foram selecionados dados.' TYPE 'S' DISPLAY LIKE 'E'.
    RAISE error.
  ENDIF.
