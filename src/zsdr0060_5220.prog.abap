...
TYPES: BEGIN OF ty_carga_5220,
         ...
         desc_status_icon TYPE icon-name.
...
*         User Story 153510 - MMSILVA
          19 'DESC_STATUS_ICON'     'ZSDT0133'     ' '  ' '  ' '  ' '   ''    ' '   ' '   ' '   'Desc. Status Icone'.
*         User Story 153510 - MMSILVA
    ...
    PERFORM fill_it_fieldcatalog TABLES it_fieldcatalog_ccot_5220 USING:
          ...
          08 'DESC_TRANSP'          'ZSDT0133'     ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Transportadora',
          09 'PRECO_FRETE'          'ZSDT0133'     ' '  'X'  ' '  ' '   'X'   ' '   ' '   ' '   'Valor Frete',
          10 'PLACA_CAV'            'ZSDT0133'     ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Placa Cavalo',
          11 'PLACA_CAR1'           'ZSDT0133'     ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Placa Carreta I',
          12 'PLACA_CAR2'           'ZSDT0133'     ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Placa Carreta II',
          13 'PLACA_CAR3'           'ZSDT0133'     ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Placa Dolly',
    ...
    CREATE OBJECT ctl_alv2_5220
      EXPORTING
        i_parent = dg_parent_2_5220.           "ALV Oderm
...
*** Stefanini - IR216112 - 21/01/2025 - LAZAROSR - Início de Alteração
      SORT it_zsdt0129 BY nro_cg.
*** Stefanini - IR216112 - 21/01/202 - LAZAROSR - Fim de Alteração
...
*** Stefanini - IR216112 - 21/01/2025 - LAZAROSR - Início de Alteração
      READ TABLE it_zsdt0129 TRANSPORTING NO FIELDS
                             WITH KEY nro_cg = wa_carga_5220-nro_cg
                                                      BINARY SEARCH.
      IF sy-subrc IS INITIAL.

        LOOP AT  it_zsdt0129 INTO wa_zsdt0129 FROM sy-tabix.

          IF wa_zsdt0129-nro_cg NE wa_carga_5220-nro_cg.
            EXIT.
          ENDIF.
*** Stefanini - IR216112 - 21/01/202 - LAZAROSR - Fim de Alteração
...
* User Story 153510 - MMSILVA
    IF wa_carga_5220-status EQ '2'.
      ...
      wa_carga_5220-desc_status_icon = 'Carga sem Cotação'.
    ELSEIF wa_carga_5220-status EQ '3'.
      wa_carga_5220-icone = '@FD@'.
      wa_carga_5220-desc_status_icon = 'Carga Cotada'.
    ELSEIF wa_carga_5220-status EQ '4'.
      wa_carga_5220-icone = '@4A@'.
      wa_carga_5220-desc_status_icon = 'Frete Contratado'.
    ELSEIF wa_carga_5220-status EQ '5'.
      wa_carga_5220-icone = '@96@'.
      wa_carga_5220-desc_status_icon = 'Embarque Autorizado'.
    ELSEIF wa_carga_5220-status EQ '6'.
      wa_carga_5220-icone =  '@0Q@'.
      wa_carga_5220-desc_status_icon = 'Romaneio Gerado'.
    ENDIF.
* User Story 153510 - MMSILVA
