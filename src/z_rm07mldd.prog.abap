...
*$*$-Start: RM07MLDD_01-------------------------------------------------------------------------$*$*
"enhancement 3  ad_mpn_pur2_rm07mlbd.    "active version
* DI A&D MPN
...
"endenhancement.
"enhancement 7  dipcs_rm07mlbd.    "active version
...
*---> S4 Migration - 13/07/2023 - PS
        /cwm/labst LIKE mard-/cwm/labst,           "frei verwendbarer Bestand
...
*---> S4 Migration - 13/07/2023 - PS
        /cwm/clabs LIKE mchb-/cwm/clabs,           "frei verwendbarer Chargenbestand
...
*$*$-Start: RM07MLDD_02-------------------------------------------------------------------------$*$*
"enhancement 2  ad_mpn_pur2_rm07mlbd.    "active version
* DI A&D MPN IC
DATA:
...
TYPES : BEGIN OF stype_totals_header,
        ...
        stab_totals_header   TYPE STANDARD TABLE OF
                             stype_totals_header
                             WITH DEFAULT KEY,
