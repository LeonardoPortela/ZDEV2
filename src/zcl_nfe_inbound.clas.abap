class ZCL_NFE_INBOUND definition
  public
...
public section.
  ...
  data AT_PEDIDO_MASSA type ZDE_NFE_PED_MASSA .
  ...
  methods VALIDA_ATRIBUTO_ALTERAVEL_LOTE
    importing
      ...
      !I_CD_LOTE_ITEM type ZDE_CD_LOTE_ITEM optional
  ...
  class-methods GET_NFE_INBOUND_ALV_SAIDA
    importing
      !I_NFE_DIST type ZIB_NFE_DIST_TER_T
    returning
      value(E_ALV) type ZDE_NFE_DIST_ALV_T .
  ...
  methods NFE_INBOUND_ACEITE_FATURA
    raising
      ZCX_NFE_INBOUND_EXCEPTION
      ZCX_CADASTRO .
  class-methods NFE_INBOUND_ACEITE_SEM_CHAVE
    importing
      !I_NUMERO_NFE type ZDE_NR_NFE
      !I_SERIE_NFE type J_1BSERIES
      !I_EBELN type EBELN optional
      !I_EBELP type EBELP optional
      !I_FORNE_CNPJ type ZDE_FORN_CNPJ optional
      !I_FORNE_CPF type ZDE_FORN_CPF optional
      !I_FORNE_IE type ZDE_FORN_INSC_ES optional
      !I_EMISSOR type LIFNR optional
      !I_ARMAZEM type ZDE_F_ARMAZEM optional
      !I_TRANSPORTE type ZDE_F_TRANSPORTE optional
      !I_PC_PARTINER type LIFNR
      !I_LR_PARTINER type KUNNR
      !I_MATNR type MATNR optional
      !I_MENGE type J_1BNETQTY
      !I_CHARG type CHARG_D
      !I_NR_FASE type ZDE_NR_FASE optional
    exporting
      !E_NFE_INBOUND type ZIB_NFE_DIST_TER
      !E_AVISO_RECEBIMENTO type VBELN_VL
    returning
      value(R_ACEITO) type CHAR01
    raising
      ZCX_NFE_INBOUND_EXCEPTION
      ZCX_CADASTRO
      ZCX_PEDIDO_COMPRA_EXCEPTION
  ...
  methods SET_ACEITAR_DOCUMENTO
    raising
      ...
      ZCX_CADASTRO
      ZCX_PEDIDO_COMPRA_EXCEPTION .
  methods NFE_INBOUND_CANCELA_FISICO
    importing
      !I_NAO_ESTORNAR_AVISO type CHAR01 default ' '
      !I_ESTORNAR_SOMENTE_AVISO type CHAR01 default ' '
    exporting
      !E_MBLNR type MBLNR
      !E_MJAHR type MJAHR
    raising
  ...
  methods NFE_INBOUND_REJEITA_ACEITE
    ...
    raising
      ZCX_NFE_INBOUND_EXCEPTION
      ZCX_CADASTRO .
  methods NFE_INBOUND_CANCELA_ACEITE
    raising
      ZCX_NFE_INBOUND_EXCEPTION
      ZCX_CADASTRO .
  methods NFE_INBOUND_CANCELA_FATURA
    raising
      ...
      ZCX_MIRO_EXCEPTION
      ZCX_CADASTRO .
  class-methods NFE_INBOUND_ACEITE_AVISO
    importing
      !I_AVISO_RECEBIMENTO type VBELN_VL
    exporting
      !E_DOCNUM_NFE type J_1BDOCNUM
      !E_MBLNR type MBLNR
      !E_MJAHR type MJAHR
  ...
  class-methods NFE_INBOUND_CAN_MIGO_MIRO
    ...
    raising
      ...
      ZCX_PEDIDO_COMPRA_EXCEPTION
      ZCX_MIRO_EXCEPTION .
  class-methods NFE_INBOUND_CAN_FISCAL_AVISO
    importing
      !I_VBELN type VBELN_VL
    returning
      value(R_CANCELOU) type CHAR01
  ...
  class-methods DANFE
    ...
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods NFE_SOL_MIRO_SOFTEXPERT
    importing
      !I_ESTORNAR type CHAR01 default ' '
      !I_DESATIVAR type CHAR01 optional
    returning
      value(R_INSTANCE) type ref to ZCL_NFE_INBOUND
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods NFE_SOL_ANEXA_MIRO_SOFTEXPERT
    returning
      value(R_INSTANCE) type ref to ZCL_NFE_INBOUND
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  class-methods GET_VALIDA_ITEM_PEDIDO
    ...
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods SET_NFE_EM_REVISAO
    importing
      !I_MOTIVO_REVISAO type STRING optional
      !I_USUARIO_SOLICITANTE type UNAME
    returning
      value(R_INSTANCE) type ref to ZCL_NFE_INBOUND
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods SET_NFE_REVISADA
    importing
      !I_USUARIO_REVISOR type SY-UNAME optional
    returning
      value(R_INSTANCE) type ref to ZCL_NFE_INBOUND
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  ...
  methods NFE_INBOUND_CAN_SAIDA_ARMAZEM
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods GET_INFO_TRANSPORTE
    exporting
      !E_ZIB_NFE_DIST_FRT type ZIB_NFE_DIST_FRT
    returning
      value(R_NFE_INBOUND) type ref to ZCL_NFE_INBOUND .
  methods SET_INFO_TRANSPORTE
    importing
      !I_CK_TRANS_NF_PROPRI type ZDE_TRANS_NF_PROPRI
      !I_ZIB_NFE_DIST_FRT type ZIB_NFE_DIST_FRT
    returning
      value(R_NFE_INBOUND) type ref to ZCL_NFE_INBOUND
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  ...
  methods CHECK_OBLIGATORY_CHARG
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods SET_PEDIDO_MASSA
    importing
      !I_SET_HEADER type CHAR01 optional
      !I_EBELN type EBELN optional
      !I_EBELP type EBELP optional
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods GET_PEDIDO_MASSA
    importing
      !I_GET_HEADER type CHAR01 optional
    returning
      value(R_PED_MASSA) type ZDE_NFE_PED_MASSA .
  methods GET_CHAVES_LOCK
    returning
      value(R_CHAVES) type ZDE_CHAVE_DOC_E_T .
  methods SET_FISCAL_TAXAS .
  methods SET_VALIDAR_CARACTERISTICAS
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods SET_CK_MIRO_AUTOMATICA
    importing
      !I_CLEAR type CHAR01 optional .
  methods GET_CK_MIRO_AUTOMATICA
    returning
      value(R_CK_MIRO_AUTOMATICA) type CHAR01 .
  methods GET_CK_LOTE_FORNECEDOR
    importing
      !I_CLINT type CLINT
    exporting
      !E_CAMPO type STRING
    returning
      value(R_CK_LOTE_FORNECEDOR) type CHAR01 .
  ...
  methods SET_ST_FISCAL_DATA
    importing
      !I_ST_FISCAL_DATA type ZST_FISCAL_DATA .
  methods SET_EXECUTA_ZFIS55 .
  methods SET_REINICIA_CARAC_LOTE .
  methods GET_CONFIG_TIPO_MOVIMENTO
    returning
      value(R_T156) type T156 .
  methods GET_LEIS_FISCAIS
    importing
      !I_MATNR type MATNR optional
    returning
      value(R_ZMMT0154) type ZMMT0154
    raising
      ZCX_NFE_INBOUND_EXCEPTION .
  methods GET_CK_MIGO_CAT_FISCAL
    returning
      value(R_CK_MIGO_CAT_FISCAL) type CHAR01 .
  methods GET_FORNECEDOR_IRF
    importing
      !I_BUKRS type BUKRS
      !I_LIFNR type LIFNR
    returning
      value(R_LFBW) type LFBW_TAB .
  methods GET_MARA
    importing
      !I_MATNR type MATNR
    returning
      value(R_MARA) type MARA .
  methods GET_LFA1
    importing
      !I_LIFNR type LIFNR
    returning
...
private section.
  ...
  data AT_CHAVES_PEDMASSA type ZDE_CHAVE_DOC_E_T .
  ...
  data CK_MIRO_AUTOMATICA type CHAR01 .
  data CK_LOTE_FORNECEDOR type CHAR01 .
  ...
  methods NFE_INBOUND_REMESSA
    ...
    raising
      ZCX_DELIVERY
      ZCX_CADASTRO .
  methods NFE_INBOUND_DOC_MATERIAL
    exporting
...
CLASS ZCL_NFE_INBOUND IMPLEMENTATION.
...
*-CS2025000249-08.04.2025-#173180-JT-inicio
    IF me->at_pedido_massa-confirma_ped_massa = abap_true.
      LOOP AT me->at_chaves_pedmassa INTO DATA(_chave_nfe).
        zcl_nfe_inbound=>set_denqueue_nfe( i_chave = _chave_nfe i_sem_bloqueio_registro = me->ck_sem_bloqueio_registro ).
      ENDLOOP.
    ELSEIF me->at_chaves_lock[] IS INITIAL.
      zcl_nfe_inbound=>set_denqueue_nfe( i_chave = me->nota-chave_nfe i_sem_bloqueio_registro = me->ck_sem_bloqueio_registro ).
    ELSE.
      me->desbloquear_objeto( ).
    ENDIF.
        ...
        IF sy-subrc IS INITIAL.
          SELECT * INTO TABLE it_likp
           ...
           WHERE lifnr EQ lv_lifnr
             AND ( lifex EQ lc_xblnr OR lifex EQ lc_xblnr2 ).
          IF sy-subrc IS INITIAL.
            READ TABLE it_likp INDEX 1 INTO r_likp.
          ENDIF.
...
*-CS2025000249-19.05.2025-#175013-JT-inicio
      IF r_zmmt0075 IS NOT INITIAL AND r_zmmt0075-ck_nao_vinc_miro_migo_ped EQ abap_true AND wa_zmmt0075-ck_nao_vinc_miro_migo_ped EQ abap_false.
        r_zmmt0075-ck_nao_vinc_miro_migo_ped = abap_false.
      ENDIF.
...
*ST_FISICO_99 Constant  Public  Type  ZDE_ST_NFE_FISICO Finalizado Com Aceite Físico  '99'
  ...
  METHOD get_info_nota.
    ...
    MOVE-CORRESPONDING me->nota TO r_nfe_inbound-nfe_base.

*-CS2025000249-04.06.2025-#168929-JT-inicio
    LOOP AT me->itens    INTO DATA(_itens).
      DATA(_tabix) = sy-tabix.
      IF _itens-lgort IS INITIAL.
        _itens-lgort = me->get_deposito( i_ebeln = _itens-ebeln i_ebelp = _itens-ebelp ).
        MODIFY me->itens FROM _itens INDEX _tabix TRANSPORTING lgort.
      ENDIF.
    ENDLOOP.
*-CS2025000249-04.06.2025-#168929-JT-fim
    ...
    MOVE me->pedidos[]               TO r_nfe_inbound-nfe_base-pedidos[].
    MOVE me->volumes_transp[]        TO r_nfe_inbound-nfe_base-volumes_transp[].
    MOVE me->dados_retorno[]         TO r_nfe_inbound-nfe_base-retornos[].

    DATA: it_nota TYPE zib_nfe_dist_ter_t.

    APPEND me->nota TO it_nota.

    DATA(it_alv) = me->get_nfe_inbound_alv_saida( EXPORTING i_nfe_dist = it_nota ).

    LOOP AT it_alv INTO DATA(wa_alv).
      MOVE-CORRESPONDING wa_alv TO r_nfe_inbound-nfe_alv.
      DATA(armazem) = me->get_info_fornecedor( i_lifnr = wa_alv-f_armazem ).
      r_nfe_inbound-nfe_alv-armazem_cnpj  = armazem-stcd1.
      r_nfe_inbound-nfe_alv-armazem_ie    = armazem-stcd3.
      r_nfe_inbound-nfe_alv-armazem_razao = armazem-name1.
    ENDLOOP.
    ...
    LOOP AT me->pedidos INTO DATA(wa_pedido).
      ...
      APPEND wa_ped_alv TO r_nfe_inbound-nfe_pedidos_alv.
    ENDLOOP.

  ENDMETHOD.


  METHOD GET_INFO_TRANSPORTE.

    R_NFE_INBOUND = ME.

    IF ME->FRETE IS INITIAL.

      ME->FRETE-CHAVE_NFE = ME->NOTA-CHAVE_NFE.

      IF ME->NOTA-F_TRANSPORTE IS NOT INITIAL.

        SELECT SINGLE * INTO @DATA(WA_LFA1)
          FROM LFA1
         WHERE LIFNR EQ @ME->NOTA-F_TRANSPORTE.

        IF SY-SUBRC IS INITIAL.
          ME->FRETE-ID_AGENT_FRETE  = ME->NOTA-F_TRANSPORTE.
          ME->FRETE-ID_PROPRIETARIO = ME->NOTA-F_TRANSPORTE.
          ME->FRETE-DS_AGENT_FRETE  = WA_LFA1-NAME1.
          ME->FRETE-DS_PROPRIETARIO = WA_LFA1-NAME1.
        ENDIF.

      ELSEIF ME->NOTA-TRANSPORTADOR_CNPJ IS NOT INITIAL OR ME->NOTA-TRANSPORTADOR_CPF IS NOT INITIAL.
        ...
        TRY .
            ZCL_FORNECEDORES=>ZIF_PARCEIROS~GET_INSTANCE(
                    ...
                    EXPORTING
                      I_CNPJ             = ME->NOTA-TRANSPORTADOR_CNPJ
                      I_CPF              = ME->NOTA-TRANSPORTADOR_CPF
                      I_INSC_ESTATUAL    = ME->NOTA-TRANSPORTADOR_IE
                      I_KTOKK            = I_KTOKK
             )->GET_ID_PARCEIRO( IMPORTING E_PARCEIRO = DATA(E_PARCEIRO)
             )->GET_NAME( IMPORTING E_NAME = WA_LFA1-NAME1
             ).

            ME->NOTA-F_TRANSPORTE     = E_PARCEIRO.
            ME->FRETE-ID_AGENT_FRETE  = E_PARCEIRO.
            ME->FRETE-ID_PROPRIETARIO = E_PARCEIRO.
            ME->FRETE-DS_AGENT_FRETE  = WA_LFA1-NAME1.
            ME->FRETE-DS_PROPRIETARIO = WA_LFA1-NAME1.
          CATCH ZCX_PARCEIROS.    " .
        ENDTRY.
    ...
    IF ( r_bstae EQ '0004' ) AND ( wa_item-deliv_numb IS NOT INITIAL ).
      ...
      SELECT SINGLE * INTO r_migo
       ...
       WHERE le_vbeln EQ wa_item-deliv_numb
         ...
         AND EXISTS ( SELECT * FROM mseg AS e
                       WHERE e~mblnr EQ m~mblnr
                       AND   e~mjahr EQ m~mjahr
                       "AND   ( e~lifnr EQ me->nota-p_emissor  )
                       AND e~smbln EQ space )
         AND NOT EXISTS ( SELECT * FROM mseg AS e WHERE e~smbln EQ m~mblnr AND e~sjahr EQ m~mjahr ).
    ENDIF.
...
*    ENDIF.
  ...
  METHOD get_nfe_inbound_alv_saida.
    ...
    DATA: it_doc_ter      TYPE TABLE OF zib_nfe_dist_ter,
          it_aux          TYPE zib_nfe_dist_ter_t,
          ...
          lv_qtitm        TYPE i,                          "*-CS2025000249-08.04.2025-#173180-JT-inicio
          it_nfe_dist_itm TYPE TABLE OF zib_nfe_dist_itm,  "*-CS2025000249-08.04.2025-#173180-JT-inicio
          wa_nfe_dist_itm TYPE zib_nfe_dist_itm.           "*-CS2025000249-08.04.2025-#173180-JT-inicio

    DATA: wa_doc_ter        TYPE zib_nfe_dist_ter.

    DATA: wa_nfe_dist	TYPE zib_nfe_dist_ter,
    ...
    IF i_nfe_dist[] IS NOT INITIAL.
      SELECT * INTO TABLE it_nfe_forn
        FROM zib_nfe_forn
         FOR ALL ENTRIES IN i_nfe_dist
       WHERE nu_chave = i_nfe_dist-chave_nfe.
...
*-CS2025000249-08.04.2025-#173180-JT-inicio
    IF i_nfe_dist[] IS NOT INITIAL.
      SELECT *
        INTO TABLE it_nfe_dist_itm
        FROM zib_nfe_dist_itm
         FOR ALL ENTRIES IN i_nfe_dist
       WHERE chave_nfe = i_nfe_dist-chave_nfe.
    ENDIF.
*-CS2025000249-08.04.2025-#173180-JT-fim
    ...
    IF i_nfe_dist[] IS NOT INITIAL.
      SELECT *
        FROM zsdt0410 INTO TABLE @DATA(lit_zsdt0410)
         FOR ALL ENTRIES IN @i_nfe_dist
       WHERE chave_nfe EQ @i_nfe_dist-chave_nfe
         AND cancel    EQ @abap_false.

      SORT lit_zsdt0410 BY chave_nfe.
    ENDIF.
    "SD - Faturamento Saida Insumos - Sementes US 169508 - WPP <<----

    LOOP AT i_nfe_dist INTO wa_nfe_dist.

      CLEAR: wa_alv, wa_nfe_forn.

      MOVE-CORRESPONDING wa_nfe_dist TO wa_alv.

      READ TABLE it_nfe_forn INTO wa_nfe_forn WITH KEY nu_chave = wa_nfe_dist-chave_nfe
                             BINARY SEARCH.
      ...
      "SD - Faturamento Saida Insumos - Sementes US 169508 - WPP --->>>
      READ TABLE lit_zsdt0410 INTO DATA(LWA_ZSDT0410) WITH KEY CHAVE_NFE = wa_nfe_dist-chave_nfe BINARY SEARCH.
      IF SY-SUBRC EQ 0.
        wa_alv-nro_cg_insumos = LWA_ZSDT0410-nro_cg.
        wa_alv-direcao_carga  = 'S'.
      ENDIF.
      "SD - Faturamento Saida Insumos - Sementes US 169508 - WPP <<----

      CLEAR: wa_alv-p_emissor_name.

      IF wa_nfe_dist-p_emissor IS NOT INITIAL.
        READ TABLE it_lfa1 INTO wa_lfa1 WITH KEY lifnr = wa_nfe_dist-p_emissor BINARY SEARCH.
        IF sy-subrc IS INITIAL.
          wa_alv-p_emissor_name = wa_lfa1-name1.
        ENDIF.
      ENDIF.

      IF wa_nfe_dist-docnum_nfe IS NOT INITIAL.
        wa_alv-ico_st_documento = icon_complete.
      ELSEIF wa_nfe_dist-docnum_nfe IS INITIAL.
      ...
      ELSEIF wa_nfe_dist-cd_departamento IS NOT INITIAL.
        wa_alv-rowcolor = 'C100'.
      ELSEIF wa_nfe_dist-p_emissor IS INITIAL.
        wa_alv-rowcolor = 'C601'.
      ELSEIF wa_nfe_dist-e_tomadora IS INITIAL.
        wa_alv-rowcolor = 'C600'.
      ENDIF.

      IF wa_nfe_dist-st_documento IS INITIAL.
        wa_nfe_dist-st_documento = '00'.
      ENDIF.

      IF wa_nfe_dist-st_fiscal IS INITIAL.
        wa_nfe_dist-st_fiscal = '00'.
      ENDIF.

      IF wa_nfe_dist-st_fisico IS INITIAL.
        wa_nfe_dist-st_fisico = '00'.
      ENDIF.

      IF wa_nfe_dist-st_armazem IS INITIAL.
        wa_nfe_dist-st_armazem = '00'.
      ENDIF.

      wa_alv-ico_st_documento = zcl_nfe_inbound=>get_icon_status_documento( i_status = wa_nfe_dist-st_documento ).
      wa_alv-ico_st_fiscal    = zcl_nfe_inbound=>get_icon_status_fiscal( i_status = wa_nfe_dist-st_fiscal ).
      wa_alv-ico_st_fisico    = zcl_nfe_inbound=>get_icon_status_fisico( i_status = wa_nfe_dist-st_fisico ).
      wa_alv-ico_st_armazem   = zcl_nfe_inbound=>get_icon_status_armazem( i_status = wa_nfe_dist-st_armazem ).

*-CS2025000249-08.04.2025-#173180-JT-inicio
      FREE lv_qtitm.
      LOOP AT it_nfe_dist_itm INTO wa_nfe_dist_itm WHERE chave_nfe = wa_nfe_dist-chave_nfe.
        lv_qtitm                 = lv_qtitm + 1.
        IF lv_qtitm > 1.
          FREE: wa_alv-ebelp, wa_alv-matnr, wa_alv-prod_qtd_comerci.
          EXIT.
        ENDIF.
        wa_alv-ebelp             = wa_nfe_dist_itm-ebelp.
        wa_alv-matnr             = wa_nfe_dist_itm-matnr.
        wa_alv-prod_qtd_comerci  = wa_nfe_dist_itm-prod_qtd_comerci.
      ENDLOOP.
*-CS2025000249-08.04.2025-#173180-JT-fim
...
*    clear: ws_pedido.
  ...
  method nfe_inbound_aceite.
    ...
    call function 'ZNFE_INBOUND_ACEITE'
      exporting
        i_nota = me.
  ...
  METHOD NFE_INBOUND_ACEITE_AVISO.

    DATA: NFE_INBOUND TYPE REF TO ZCL_NFE_INBOUND,
          LC_VALOR    TYPE NETWR_FP.

    SELECT SINGLE * INTO @DATA(WA_NFE_TER)
      FROM ZIB_NFE_DIST_TER
     WHERE VBELN = @I_AVISO_RECEBIMENTO.

    IF SY-SUBRC IS NOT INITIAL.
      RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
        EXPORTING
          TEXTID = VALUE #( MSGID = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_NAO_ENC_NFE_AVISO-MSGID
                            MSGNO = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_NAO_ENC_NFE_AVISO-MSGNO
                            ATTR1 = CONV #( I_AVISO_RECEBIMENTO ) )
          MSGID  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_NAO_ENC_NFE_AVISO-MSGID
          MSGTY  = 'E'
          MSGNO  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_NAO_ENC_NFE_AVISO-MSGNO
          MSGV1  = CONV #( I_AVISO_RECEBIMENTO ).
    ENDIF.

    CREATE OBJECT NFE_INBOUND.

    NFE_INBOUND->ZIF_CADASTRO~SET_REGISTRO( I_ID_REGISTRO = WA_NFE_TER-CHAVE_NFE ).

    NFE_INBOUND->SET_INFO_SAP( ).

    DATA(R_NFE_INBOUND) = NFE_INBOUND->GET_INFO_NOTA( ).

    IF R_NFE_INBOUND-NFE_BASE-MBLNR IS INITIAL.
      NFE_INBOUND->SET_ACEITAR_FISICO( ).
      DATA(I_GRAVOU) = NFE_INBOUND->ZIF_CADASTRO~GRAVAR_REGISTRO( ).
      CHECK I_GRAVOU EQ ABAP_TRUE.
      R_NFE_INBOUND = NFE_INBOUND->GET_INFO_NOTA( ).
      CHECK R_NFE_INBOUND-NFE_BASE-MBLNR IS NOT INITIAL.
      CHECK R_NFE_INBOUND-NFE_BASE-MJAHR IS NOT INITIAL.
    ENDIF.

    ZCL_MIRO=>GET_PROXIMO_VENC_FATURA( IMPORTING E_DATA_VENCIMENTO = R_NFE_INBOUND-NFE_BASE-DT_VENCIMENTO
      EXCEPTIONS
        ERRO              = 1
        OTHERS            = 2 ).
    ...
    NFE_INBOUND->SET_DT_VENCIMENTO( I_DT_VENCIMENTO = R_NFE_INBOUND-NFE_BASE-DT_VENCIMENTO ).

    NFE_INBOUND->GET_VALOR_NOTA_FISCAL_FATURA(
      IMPORTING
        E_WAERS       = R_NFE_INBOUND-NFE_BASE-CTR_WAERS
        E_WKURS       = R_NFE_INBOUND-NFE_BASE-CTR_WKURS
        E_KUFIX       = R_NFE_INBOUND-NFE_BASE-CTR_KUFIX
        E_SINAL       = R_NFE_INBOUND-NFE_BASE-CTR_SINAL
        E_VALOR_TOTAL = R_NFE_INBOUND-NFE_BASE-CTR_VALOR_TOTAL
        E_ZTERM       = R_NFE_INBOUND-NFE_BASE-CTR_ZTERM ).

    NFE_INBOUND->SET_CTR_VALOR_TOTAL( I_CTR_VALOR_TOTAL = R_NFE_INBOUND-NFE_BASE-CTR_VALOR_TOTAL ).

    DATA(R_ZMMT0075) = NFE_INBOUND->GET_CONFIG_TIPO_PEDIDO( ).
    NFE_INBOUND->SET_BLOQUEIO_PAGAMENTO( I_ZLSPR = R_ZMMT0075-ZLSPR ).

    R_NFE_INBOUND-NFE_BASE-ZBVTYP = '0001'.
    NFE_INBOUND->SET_BANCO_PARCEIRO( I_BVTYP = R_NFE_INBOUND-NFE_BASE-ZBVTYP ).

    MOVE NFE_INBOUND->NOTA-CTR_VALOR_TOTAL TO LC_VALOR.

    CALL FUNCTION 'Z_RET_FORMA_PAGAMENTO'
      EXPORTING
        P_BUKRS           = R_NFE_INBOUND-NFE_BASE-E_TOMADORA
        P_LIFNR           = R_NFE_INBOUND-NFE_BASE-P_EMISSOR
        P_ZLSCH           = R_NFE_INBOUND-NFE_BASE-PYMT_METH
        P_VALOR           = LC_VALOR
        P_BVTYP           = R_NFE_INBOUND-NFE_BASE-ZBVTYP
        P_WAERS           = R_NFE_INBOUND-NFE_BASE-CTR_WAERS
      IMPORTING
        P_FORMA_PAGAMENTO = R_NFE_INBOUND-NFE_BASE-PYMT_METH
        P_PRINC_BNC_EMP   = R_NFE_INBOUND-NFE_BASE-HOUSEBANKID
      EXCEPTIONS
        NAO_FORNECEDOR    = 1
        FORNECEDOR_CONTA  = 2
        FORNECEDOR_BANCO  = 3
    ...
    IF SY-SUBRC IS INITIAL.
      NFE_INBOUND->SET_MEIO_DE_PAGAMENTO( EXPORTING I_MEIO_PAGAMENTO = R_NFE_INBOUND-NFE_BASE-PYMT_METH ).
      NFE_INBOUND->SET_BANCO_EMPRESA( EXPORTING I_BANCO_EMPRESA = R_NFE_INBOUND-NFE_BASE-HOUSEBANKID ).
    ELSE.
      RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
        EXPORTING
          TEXTID = VALUE #( MSGNO = SY-MSGNO
    ...
    NFE_INBOUND->SET_ACEITAR_FATURAR( ).
    I_GRAVOU = NFE_INBOUND->ZIF_CADASTRO~GRAVAR_REGISTRO( ).
    CHECK I_GRAVOU EQ ABAP_TRUE.

    R_NFE_INBOUND = NFE_INBOUND->GET_INFO_NOTA( ).

    E_DOCNUM_NFE = R_NFE_INBOUND-NFE_BASE-DOCNUM_NFE.
    E_MBLNR = R_NFE_INBOUND-NFE_BASE-MBLNR.
    E_MJAHR = R_NFE_INBOUND-NFE_BASE-MJAHR.
    E_BELNR = R_NFE_INBOUND-NFE_BASE-BELNR.
    E_GJAHR = R_NFE_INBOUND-NFE_BASE-GJAHR.
    MOVE-CORRESPONDING R_NFE_INBOUND-NFE_BASE TO E_NFE_INBOUND.
    R_GEROU = ABAP_TRUE.
  ...
  METHOD nfe_inbound_aceite_sem_chave.

    DATA: nfe_inbound TYPE REF TO zcl_nfe_inbound.

    DATA: lc_forne_cnpj	TYPE zde_forn_cnpj,
          lc_forne_cpf  TYPE zde_forn_cpf,
          lc_forne_ie	  TYPE zde_forn_insc_es,
    ...
    "Localizar NF-e InBound """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

    IF i_forne_cnpj IS NOT INITIAL AND i_forne_ie IS NOT INITIAL.

      lc_forne_cnpj	= i_forne_cnpj.
      lc_forne_cpf  = i_forne_cpf.
      lc_forne_ie	  = i_forne_ie.

      DATA(wa_lfa1) = nfe_inbound->get_fornecedor( i_forne_cnpj = i_forne_cnpj  i_forne_cpf = i_forne_cpf i_forne_ie = i_forne_ie ).

      nfe_inbound->set_registro_outros(
        i_forne_cnpj = i_forne_cnpj
        i_forne_cpf  = i_forne_cpf
        i_forne_ie   = i_forne_ie
        i_numero     = i_numero_nfe
        i_serie      = i_serie_nfe ).

    ELSEIF i_ebeln IS NOT INITIAL.
      ...
      IF sy-subrc IS NOT INITIAL.
        ...
        IF lc_forne_cnpj IS NOT INITIAL.
          lc_texto = lc_forne_cnpj.
        ELSE.
          lc_texto = lc_forne_cpf.
        ENDIF.

        MESSAGE s011 WITH lc_texto i_forne_ie.
        RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
          EXPORTING
            msgty = 'E'
            msgno = sy-msgno
      ...
      MOVE: wa_lfa1-stcd1  TO lc_forne_cnpj,
            wa_lfa1-stcd2  TO lc_forne_cpf,
            wa_lfa1-stcd3  TO lc_forne_ie.

      wa_lfa1 = nfe_inbound->get_fornecedor( i_forne_cnpj = lc_forne_cnpj  i_forne_cpf = lc_forne_cpf  i_forne_ie = lc_forne_ie ).

      nfe_inbound->set_registro_outros(
          i_forne_cnpj          = lc_forne_cnpj
          i_forne_cpf           = lc_forne_cpf
          i_forne_ie            = lc_forne_ie
          i_numero              = i_numero_nfe
          i_serie               = i_serie_nfe ).

    ELSEIF i_emissor IS NOT INITIAL.
      ...
      wa_lfa1 = nfe_inbound->get_fornecedor(
          i_forne_cnpj         = lc_forne_cnpj
          i_forne_cpf          = lc_forne_cpf
          i_forne_ie           = lc_forne_ie ).
    ...
    ELSE.
      "043  Deve ser informado o Fornecedor ou Pedido ou Emissor.
      MESSAGE s043.
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
          msgty = 'E'
    ...
    IF r_nfe_inbound-nfe_base-f_tomadora IS INITIAL.
      MESSAGE s009.
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
          msgty = 'E'
    ...
    IF r_nfe_inbound-nfe_base-p_emissor IS INITIAL.
      ...
      MESSAGE s011 WITH lc_texto lc_forne_ie.
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
          msgty = 'E'
          msgno = sy-msgno
    ...
    IF i_armazem IS NOT INITIAL.
      CALL METHOD nfe_inbound->set_armazem
        EXPORTING
          i_f_armazem = i_armazem
        RECEIVING
          r_lfa1      = DATA(wa_armazem).
    ENDIF.

    IF i_transporte IS NOT INITIAL.
      DATA(wa_transportadora) = nfe_inbound->set_transportadora( EXPORTING i_f_transporte = i_transporte ).
    ENDIF.

    IF i_pc_partiner IS NOT INITIAL.
      nfe_inbound->set_pc_partiner( i_pc_partiner = i_pc_partiner ).
    ENDIF.

    IF i_lr_partiner IS NOT INITIAL.
      nfe_inbound->set_lr_partiner( i_lr_partiner = i_lr_partiner ).
    ENDIF.

    "Buscar Pedido e Itens
    IF i_ebeln IS NOT INITIAL.
      CALL METHOD zcl_pedido_compra=>get_pedido_itens
        EXPORTING
          i_ebeln          = i_ebeln
          i_ebelp          = i_ebelp
        IMPORTING
          e_ekko           = wa_ekko
          e_ekpo_t         = DATA(it_ekpo)
        EXCEPTIONS
          nao_achou_pedido = 1
          OTHERS           = 2.
    ...
    IF i_matnr IS NOT INITIAL.
      ...
      DELETE it_ekpo WHERE matnr NE i_matnr.
      DESCRIBE TABLE it_ekpo LINES DATA(lc_ekpo_qtd).
      IF lc_ekpo_qtd EQ 1.
        READ TABLE it_ekpo INTO DATA(wa_ekpo) INDEX 1.
      ELSE.
        "Mais de Um Item com Mesmo Material
      ENDIF.

    ELSEIF i_ebeln IS NOT INITIAL.

      DESCRIBE TABLE it_ekpo LINES lc_ekpo_qtd.
      IF lc_ekpo_qtd EQ 1.
        ...
        SELECT SINGLE * INTO wa_mara
         ...
         WHERE matnr EQ wa_ekpo-matnr.
      ELSE.
        DESCRIBE TABLE nfe_inbound->itens LINES DATA(lc_itens_qtd).
        IF lc_itens_qtd EQ 1.
          READ TABLE nfe_inbound->itens INDEX 1 INTO DATA(wa_item).
          IF wa_item-matnr IS NOT INITIAL.
            DELETE it_ekpo  WHERE matnr NE wa_item-matnr.
            DESCRIBE TABLE it_ekpo LINES lc_ekpo_qtd.
            IF lc_ekpo_qtd EQ 1.
              READ TABLE it_ekpo INTO wa_ekpo INDEX 1.
              SELECT SINGLE * INTO wa_mara
      ...
      ENDIF.
    ELSE.
      "044  Deve ser informado o Pedido e/ou Material.
      MESSAGE s044.
    ...
    IF i_ebeln IS NOT INITIAL.
      ...
      CALL METHOD zcl_pedido_compra=>get_pedido_compra_chave_e
        EXPORTING
          i_lifnr               = wa_ekko-lifre
          i_bukrs               = r_nfe_inbound-nfe_base-e_tomadora
          i_werks               = r_nfe_inbound-nfe_base-f_tomadora
      ...
      ELSE.
        ...
        "Atribuir Pedido/Item para Nota Fiscal
        LOOP AT nfe_inbound->itens INTO wa_item.
          nfe_inbound->set_item_material( i_prod_item = wa_item-prod_item
                                          i_matnr     = wa_mara-matnr
                                          i_ebeln     = wa_ekpo-ebeln
                                          i_ebelp     = wa_ekpo-ebelp
                                          i_lgort     = wa_ekpo-lgort  "*-CS2025000249-04.06.2025-#168929-JT
                                          i_menge     = i_menge
                                          i_meins     = wa_mara-meins
                                          i_netpr     = wa_item-netpr
                                          i_netwr     = wa_item-netwr ).
        ENDLOOP.

        IF i_nr_fase IS NOT INITIAL.
          nfe_inbound->set_nr_fase( i_nr_fase = i_nr_fase ).
        ENDIF.
        nfe_inbound->set_ck_possui_frete( i_ck_possui_frete = abap_true ).

        DATA(r_cd_departamento) = nfe_inbound->get_departamento_itens( i_itens  = nfe_inbound->itens ).

        "Determinar Departamento """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        IF r_cd_departamento NE nfe_inbound->nota-cd_departamento.
          nfe_inbound->set_departamento_nota( ).
        ENDIF.
        """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

        nfe_inbound->ck_alterou = abap_true.
        nfe_inbound->set_aceitar_documento( ).
        DATA(i_gravou) = nfe_inbound->zif_cadastro~gravar_registro( ).
        CHECK i_gravou EQ abap_true.

        IF i_charg IS NOT INITIAL.

          READ TABLE nfe_inbound->itens INDEX 1 INTO wa_item.

          CALL METHOD zcl_charg=>get_charg_werks_deposito
            EXPORTING
              i_matnr = wa_item-matnr
              i_charg = i_charg
              i_werks = nfe_inbound->nota-f_tomadora
              i_lgort = wa_ekpo-lgort
            RECEIVING
              r_mchb  = DATA(r_mchb).

          "Verificar se o Lote Existe

          READ TABLE nfe_inbound->lotes INDEX 1 INTO DATA(wa_lote).
          IF sy-subrc IS NOT INITIAL.
            "Cria Lote
            DATA(lc_lote) = nfe_inbound->add_lote_item( EXPORTING i_prod_item = wa_item-prod_item IMPORTING e_caracteristicas = e_caracteristicas ).
            wa_lote = lc_lote.
          ELSE.
            CLEAR: e_caracteristicas.
            LOOP AT nfe_inbound->lotes_caracteristicas INTO DATA(wa_carac) WHERE cd_lote_item EQ wa_lote-cd_lote_item.
              APPEND wa_carac TO e_caracteristicas.
            ENDLOOP.
          ENDIF.
          wa_lote-charg = i_charg.
          nfe_inbound->set_lote_item( CHANGING i_lote_caract = e_caracteristicas i_lote = wa_lote ).
        ENDIF.

        "Somente Aviso
        nfe_inbound->set_aceitar_fisico( ).
        nfe_inbound->set_ck_gerar_somente_aviso( ).
        i_gravou = nfe_inbound->zif_cadastro~gravar_registro( ).

        r_nfe_inbound = nfe_inbound->get_info_nota( ).
        IF r_nfe_inbound-nfe_base-st_fisico EQ zcl_nfe_inbound=>st_fisico_aviso_gerado.
          r_aceito = abap_true.
          MOVE-CORRESPONDING r_nfe_inbound-nfe_base TO e_nfe_inbound.
          e_aviso_recebimento = e_nfe_inbound-vbeln.
        ENDIF.
      ENDIF.
    ENDIF.
  ...
  method nfe_inbound_cancela_aceite.
...
*<<< IR085763 - Ajuste Mensagem erro - RMNI - 22/02/2022
    if me->nota-ck_fisico is not initial.
      raise exception type zcx_nfe_inbound_exception
        exporting
          ...
          msgid  = zcx_nfe_inbound_exception=>zcx_estorna_movimento_merc-msgid
          msgno  = zcx_nfe_inbound_exception=>zcx_estorna_movimento_merc-msgno.
    endif.
*>>> IR085763 - Ajuste Mensagem erro - RMNI - 22/02/2022
    ...
    if me->nota-tp_compra_futura eq zcl_nfe_inbound=>tp_compra_futura_fatura.
      me->nfe_sol_miro_softexpert( i_estornar = abap_true ).
    endif.
    ...
    me->set_st_documento( i_st_documento = zcl_nfe_inbound=>st_documento_00 ).
    me->set_nr_pedido_compra_clear( ).
    me->gravar_registro( ).
  ...
  METHOD nfe_inbound_cancela_fatura.
    ...
    IF me->nota-belnr IS NOT INITIAL.
      ...
      CALL METHOD lc_miro->estornar
        EXPORTING
          i_bapi_wait                = space
          i_chave_nfe                = me->nota-chave_nfe   "*-CS2025000249-17.04.2025-#173311-JT
          i_gerar_via_job            = abap_true            "*-CS2025000249-17.04.2025-#173311-JT
        IMPORTING
...
*-IR063194 - 22.07.2021 - JT - fim
  ...
  METHOD nfe_inbound_cancela_fisico.

    DATA: ex_cadastro  TYPE REF TO zcx_cadastro,
          ex_migo_erro TYPE REF TO zcx_migo_exception.
    ...
    IF me->nota-se_recordid IS NOT INITIAL AND me->nota-ck_revisao NE abap_true.
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
          textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_nfe_sem_revisao-msgid
                            msgno = zcx_nfe_inbound_exception=>zcx_nfe_sem_revisao-msgno
                            attr1 = me->nota-numero )
          msgid  = zcx_nfe_inbound_exception=>zcx_nfe_sem_revisao-msgid
          msgno  = zcx_nfe_inbound_exception=>zcx_nfe_sem_revisao-msgno
          msgty  = 'E'
          msgv1  = CONV #( me->nota-se_recordid ).
    ENDIF.

    IF me->nota-st_fisico EQ zcl_nfe_inbound=>st_fisico_00 AND me->ck_coleta_tudo EQ abap_false AND i_estornar_somente_aviso EQ abap_false.
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
          textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_nao_possui_aceite_fisico-msgid
                            msgno = zcx_nfe_inbound_exception=>zcx_nao_possui_aceite_fisico-msgno )
          msgid  = zcx_nfe_inbound_exception=>zcx_nao_possui_aceite_fisico-msgid
          msgno  = zcx_nfe_inbound_exception=>zcx_nao_possui_aceite_fisico-msgno
          msgty  = 'E'.
    ELSEIF me->nota-st_fisico EQ zcl_nfe_inbound=>st_fisico_00 AND me->ck_coleta_tudo NE abap_false.
      "Não existe aceite físico para estornar
      EXIT.
    ENDIF.

    IF me->nota-docnum_arm IS NOT INITIAL OR me->nota-docnum_dev IS NOT INITIAL.
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
          textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_existe_arm_dev-msgid
                            msgno = zcx_nfe_inbound_exception=>zcx_existe_arm_dev-msgno )
    ...
    IF me->nota-st_fisico EQ zcl_nfe_inbound=>st_fisico_99 AND me->nota-belnr IS NOT INITIAL.
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
          textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_possui_miro-msgid
                            msgno = zcx_nfe_inbound_exception=>zcx_possui_miro-msgno
                            attr1 = CONV #( me->nota-belnr )
                            attr2 = CONV #( me->nota-gjahr ) )
          msgid  = zcx_nfe_inbound_exception=>zcx_possui_miro-msgid
          msgno  = zcx_nfe_inbound_exception=>zcx_possui_miro-msgno
          msgty  = 'E'
          msgv1  = CONV #( me->nota-belnr )
          msgv2  = CONV #( me->nota-gjahr ).
    ENDIF.

    me->set_ck_nao_estornar_aviso( EXPORTING i_ck_nao_estornar_aviso = i_nao_estornar_aviso ).

    me->ck_eliminar_log = abap_false.
    me->ck_estornando_fisico = abap_true.
    lc_sequencia = me->get_sequencia_log( ).
    ...
    IF me->nota-mblnr IS NOT INITIAL.
      ...
      IF me->get_ck_cfop_retorno_armazena( ) EQ abap_false.
        ...
        CHECK wa_item-ebeln IS NOT INITIAL.
        CHECK wa_item-ebelp IS NOT INITIAL.
      ...
      IF ( r_bstae EQ '0004' ) AND ( me->nota-vbeln IS NOT INITIAL ).

        IF i_estornar_somente_aviso EQ abap_true.
          RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
            EXPORTING
              textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_est_somente_aviso-msgid msgno = zcx_nfe_inbound_exception=>zcx_est_somente_aviso-msgno )
              msgid  = zcx_nfe_inbound_exception=>zcx_est_somente_aviso-msgid
              msgno  = zcx_nfe_inbound_exception=>zcx_est_somente_aviso-msgno
              msgty  = 'E'.
        ENDIF.

        "Estorna Movimento de Mercadoria pelo Aviso de Rececimento
        DATA: lc_aviso TYPE REF TO zcl_aviso_recebimento.
        CREATE OBJECT lc_aviso.
        lc_aviso->set_nr_remessa( i_remessa = me->nota-vbeln ).
        DATA(r_estornou_mov) = lc_aviso->eliminar_movimento_mercadoria( ).
        DATA(r_retorno_mov) = lc_aviso->get_retorno( ).
        CLEAR: lc_aviso.

        IF r_estornou_mov EQ abap_true.
          ...
          me->set_nr_doc_material_clear( ).
          WAIT UP TO 2 SECONDS.
        ENDIF.

        LOOP AT r_retorno_mov INTO DATA(wa_retorno_mov).
          CALL METHOD me->set_add_log_nfe
            EXPORTING
              i_type         = wa_retorno_mov-type
              i_id           = wa_retorno_mov-id
              i_num          = wa_retorno_mov-number
              i_message_v1   = wa_retorno_mov-message_v1
              i_message_v2   = wa_retorno_mov-message_v2
              i_message_v3   = wa_retorno_mov-message_v3
              i_message_v4   = wa_retorno_mov-message_v4
            CHANGING
              p_lc_sequencia = lc_sequencia.
        ENDLOOP.

      ELSEIF i_estornar_somente_aviso NE abap_true.
        "Estornar MIGO
        ...
        TRY.
            ...
            IF me->get_ck_cfop_retorno_armazena( ) EQ abap_false.
              ...
              CALL METHOD lc_migo->estornar
                EXPORTING
                  i_bapi_wait        = abap_false
                IMPORTING
                  i_doc_year_estorno = e_mjahr
                  i_mat_doc_estorno  = e_mblnr
                CHANGING
                  i_doc_year         = me->nota-mjahr
                  i_mat_doc          = me->nota-mblnr
                RECEIVING
                  r_gerou            = DATA(r_estornou_migo).

              DATA(r_retorno_migo) = lc_migo->get_retorno_estorno( ).
              ...
              TRY .
                  DATA(lc_retorno) =
                    zcl_factory_mat_destinacao=>zif_factory_mat_destinacao~get_instance(
                      ...
                      )->set_estornar_movimento( IMPORTING e_estornou = r_estornou_migo e_retorno = r_retorno_migo
                      ).
            ...
            IF r_estornou_migo EQ abap_true.
              ...
              lc_ref = me->nota-mblnr && me->nota-mjahr.
              ...
              IF sy-subrc IS INITIAL.
                "Registro fiscal gerado por MIGO (Foi Estornado)
                CLEAR: me->nota-docnum_nfe.
              ENDIF.
*** PBI - 64541 - inicio - CBRAND
              "- Verifica dentro se é estorno+
              me->zif_cadastro~check_env_aprov_taxa( ).
*** PBI - 64541 - fim - CBRAND
            ENDIF.

          CATCH zcx_migo_exception INTO ex_migo_erro.
            ...
            IF ex_migo_erro->msgid = zcx_migo_exception=>zcx_estornado-msgid AND
              ...
              ex_migo_erro->published_erro( i_msgty = 'S' i_msgty_display = 'S' ).
            ...
            ELSE.
              RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
                EXPORTING
                  textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_erro_estorno_migo-msgid
                                    msgno = zcx_nfe_inbound_exception=>zcx_erro_estorno_migo-msgno
                                    attr1 = CONV #( me->nota-mjahr )
                                    attr2 = CONV #( me->nota-mblnr ) )
                  msgid  = zcx_nfe_inbound_exception=>zcx_erro_estorno_migo-msgid
                  msgno  = zcx_nfe_inbound_exception=>zcx_erro_estorno_migo-msgno
                  msgty  = 'E'
                  msgv1  = CONV #( me->nota-mjahr )
                  msgv2  = CONV #( me->nota-mblnr ).
            ENDIF.
        ENDTRY.
        ...
        LOOP AT r_retorno_migo INTO DATA(wa_retorno_migo).
          CALL METHOD me->set_add_log_nfe
            EXPORTING
              i_type         = wa_retorno_migo-type
              i_id           = wa_retorno_migo-id
              i_num          = wa_retorno_migo-number
              i_message_v1   = wa_retorno_migo-message_v1
              i_message_v2   = wa_retorno_migo-message_v2
              i_message_v3   = wa_retorno_migo-message_v3
              i_message_v4   = wa_retorno_migo-message_v4
            CHANGING
              p_lc_sequencia = lc_sequencia.
        ENDLOOP.
      ENDIF.
    ...
    IF me->nota-fknum IS NOT INITIAL.
      "Estornar Documento de Custo

    ENDIF.

    IF me->nota-tknum IS NOT INITIAL.
      "Estornar Documento de Transporte

    ENDIF.

    IF me->nota-vbeln IS NOT INITIAL AND me->ck_nao_estornar_aviso EQ abap_false.
      DATA: lv_aviso TYPE REF TO zcl_aviso_recebimento.
      "Estornar Aviso de Recebimento
      CREATE OBJECT lv_aviso.
      lv_aviso->set_nr_remessa( i_remessa = me->nota-vbeln ).

      TRY .
          DATA(r_estornou_aviso) = lv_aviso->eliminar( ).
        CATCH zcx_delivery INTO DATA(ls_delivery).

          RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
            EXPORTING
              textid = VALUE #( msgid = ls_delivery->msgid
                                msgno = ls_delivery->msgno )
              msgid  = ls_delivery->msgid
              msgno  = ls_delivery->msgno
              msgty  = 'E'.
      ...
      IF r_estornou_aviso EQ abap_true.
        ...
        IF i_estornar_somente_aviso EQ abap_true.
          IF me->nota-st_fisico EQ me->st_fisico_aviso_gerado.
      ...
      LOOP AT r_retorno_aviso INTO DATA(wa_retorno_aviso).
        CALL METHOD me->set_add_log_nfe
          EXPORTING
            i_type         = wa_retorno_aviso-type
            i_id           = wa_retorno_aviso-id
            i_num          = wa_retorno_aviso-number
            i_message_v1   = wa_retorno_aviso-message_v1
            i_message_v2   = wa_retorno_aviso-message_v2
            i_message_v3   = wa_retorno_aviso-message_v3
            i_message_v4   = wa_retorno_aviso-message_v4
          CHANGING
            p_lc_sequencia = lc_sequencia.
      ENDLOOP.
    ELSE.
      r_estornou_aviso = abap_true.
    ENDIF.

    me->set_ck_fisico( i_check = abap_false ).
    me->set_st_documento( i_st_documento = zcl_nfe_inbound=>st_documento_01 ).

    IF r_estornou_aviso EQ abap_false OR me->ck_nao_estornar_aviso EQ abap_true.
    ...
    me->gravar_registro( ).
    me->ck_estornando_fisico = abap_false.
  ...
  METHOD NFE_INBOUND_CAN_FISCAL_AVISO.
    ...
    IF NFE_INBOUND->NOTA-ST_FISICO NE ZCL_NFE_INBOUND=>ST_FISICO_AVISO_GERADO.

      NFE_INBOUND->SET_INFO_SAP( ).

      "Fiscal
      IF NFE_INBOUND->NOTA-ST_FISICO EQ ZCL_NFE_INBOUND=>ST_FISICO_99 OR NFE_INBOUND->NOTA-CK_FISICO EQ ABAP_TRUE.
        RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
          EXPORTING
            TEXTID = VALUE #( MSGNO = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_ACEITE_FISICO-MSGNO
                              MSGID = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_ACEITE_FISICO-MSGID )
            MSGTY  = 'E'
            MSGNO  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_ACEITE_FISICO-MSGNO
            MSGID  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_ACEITE_FISICO-MSGID.
      ...
      "Fiscal
      IF NFE_INBOUND->NOTA-ST_FISICO EQ ZCL_NFE_INBOUND=>ST_FISICO_FISCAL_GERADO.
        RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
          EXPORTING
            TEXTID = VALUE #( MSGNO = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_FISCAL-MSGNO
                              MSGID = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_FISCAL-MSGID
                              ATTR1 = CONV #( NFE_INBOUND->NOTA-DOCNUM_NFE ) )
            MSGTY  = 'E'
            MSGNO  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_FISCAL-MSGNO
            MSGID  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_FISCAL-MSGID
            MSGV1  = CONV #( NFE_INBOUND->NOTA-DOCNUM_NFE ).
      ENDIF.

      "Miro
      IF NFE_INBOUND->NOTA-ST_FISICO EQ ZCL_NFE_INBOUND=>ST_FISICO_MIRO_GERADA.
        RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
          EXPORTING
            TEXTID = VALUE #( MSGNO = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_MIRO-MSGNO
                              MSGID = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_MIRO-MSGID
                              ATTR1 = CONV #( NFE_INBOUND->NOTA-BELNR )
                              ATTR2 = CONV #( NFE_INBOUND->NOTA-GJAHR ) )
            MSGTY  = 'E'
            MSGNO  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_MIRO-MSGNO
            MSGID  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_MIRO-MSGID
            MSGV1  = CONV #( NFE_INBOUND->NOTA-BELNR )
            MSGV2  = CONV #( NFE_INBOUND->NOTA-GJAHR ).
      ENDIF.

      "Migo
      IF NFE_INBOUND->NOTA-ST_FISICO EQ ZCL_NFE_INBOUND=>ST_FISICO_MIGO_GERADA.
        RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
          EXPORTING
            TEXTID = VALUE #( MSGNO = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_MIGO-MSGNO
                              MSGID = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_MIGO-MSGID
                              ATTR1 = CONV #( NFE_INBOUND->NOTA-MBLNR )
                              ATTR2 = CONV #( NFE_INBOUND->NOTA-MJAHR ) )
            MSGTY  = 'E'
            MSGNO  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_MIGO-MSGNO
            MSGID  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_POSSUI_MIGO-MSGID
            MSGV1  = CONV #( NFE_INBOUND->NOTA-MBLNR )
            MSGV2  = CONV #( NFE_INBOUND->NOTA-MJAHR ).
      ENDIF.

    ENDIF.

    NFE_INBOUND->NFE_INBOUND_CANCELA_FISICO( ).
    NFE_INBOUND->NFE_INBOUND_CANCELA_ACEITE( ).
    NFE_INBOUND->FREE( ).
    CLEAR: NFE_INBOUND.
  ...
  METHOD NFE_INBOUND_CRIA_LOTES.
    ...
    LOOP AT IT_LOTES ASSIGNING FIELD-SYMBOL(<FS_LOTE>).
      ...
      " ZPP0014 Edição lotes criados a partir da ZMM0110 - BG #138699 - inicio
      IF <FS_LOTE>-LICHA IS NOT INITIAL .
        ...
        INTO @DATA(WA_MSEG)
        WHERE MATNR EQ @<FS_LOTE>-MATNR
          AND WERKS EQ @<FS_LOTE>-WERKS
          AND LGORT EQ @LC_LGORT
          AND CHARG EQ @<FS_LOTE>-CHARG.
        IF SY-SUBRC is INITIAL.
          <FS_ZPP0016>-MBLNR = WA_MSEG-MBLNR.
        ENDIF.
    ...
    IF LT_ZPPT0016 IS NOT INITIAL.
      ...
      ENDIF.
    ENDIF.
" ZPP0014 Edição lotes criados a partir da ZMM0110 - BG #138699 - fim
  ENDMETHOD.
  ...
  METHOD nfe_inbound_doc_material.


    FIELD-SYMBOLS: <gt_mard> TYPE ANY TABLE.
    DATA: i_cabecalho	        TYPE zde_migo_cabecalho,
          ...
          lc_total_mercadoria TYPE j_1bnetqty,
          cx_erro_miro        TYPE REF TO zcx_miro_exception,
          w_campo(40),
          it_lotes            TYPE TABLE OF zib_nfe_dist_lot,
          lt_zppt0016         TYPE TABLE OF zppt0016.
    ...
    "Procurar MIGO CRIADA.
    DATA(wa_migo) = me->get_migo_valida( ).

    IF wa_migo IS INITIAL.

      me->nfe_sol_miro_softexpert( i_desativar = abap_true ).

      IF me->get_ck_cfop_retorno_armazena( ) EQ abap_true.

        CHECK me->dados_retorno[] IS NOT INITIAL.

        SELECT * INTO TABLE @DATA(it_mseg)
          FROM mseg
           FOR ALL ENTRIES IN @me->dados_retorno
         WHERE mblnr EQ @me->dados_retorno-mblnr
           AND mjahr EQ @me->dados_retorno-mjahr
           AND zeile EQ @me->dados_retorno-zeile.
        ...
        TRY .
            ...
            DATA(lc_retorno) =
            zcl_factory_mat_destinacao=>zif_factory_mat_destinacao~get_instance(
              )->set_factory_objeto( EXPORTING i_tp_destinacao = zif_material_destinacao=>st_tp_destinacao_retorno
              )->get_factory_objeto(
              )->set_new(
              ).

            lc_total_mercadoria = 0.
            IF me->ck_preco_nota_fiscal EQ abap_true.
              LOOP AT me->dados_retorno INTO DATA(wa_dados_retorno).
                ADD wa_dados_retorno-menge TO lc_total_mercadoria.
              ENDLOOP.
            ENDIF.

            DATA: lc_valor TYPE zde_vlr_total.

            LOOP AT me->dados_retorno INTO wa_dados_retorno.

              READ TABLE it_mseg INTO DATA(wa_mseg)
              WITH KEY mblnr = wa_dados_retorno-mblnr
                       mjahr = wa_dados_retorno-mjahr
                       zeile = wa_dados_retorno-zeile.

              IF me->ck_preco_nota_fiscal EQ abap_true.
                lc_valor = ( wa_dados_retorno-menge * me->nota-vl_total ) / lc_total_mercadoria.
              ELSE.
                lc_valor = wa_dados_retorno-menge * ( wa_mseg-j_1bexbase / wa_mseg-menge ).
              ENDIF.

              lc_retorno->set_add_doc_material_origem(
                EXPORTING
                  i_orig_mblnr = wa_dados_retorno-mblnr
                  i_orig_mjahr = wa_dados_retorno-mjahr
                  i_orig_zeile = wa_dados_retorno-zeile
                  i_orig_nfe   = wa_dados_retorno-chave_nfe
                  i_menge      = wa_dados_retorno-menge    " Quantidade
                  i_meins      = wa_dados_retorno-meins    " Unidade de medida básica
                  i_valor      = lc_valor    " Montante básico
                  i_forne      = me->nota-p_emissor
              ).
            ...
            lc_retorno->set_enqueue(
              )->set_gravar(
              )->get_registro( IMPORTING e_zmmt0114 = DATA(e_zmmt0114)
              )->set_gerar_movimento(
                EXPORTING
                  i_gerar_via_job = abap_true  "*-CS2025000249-27.05.2025-#175255-JT
                IMPORTING
                  e_gerou         = r_gerou   " Campo de texto do comprimento 1
                  e_mblnr         = DATA(e_mblnr)   " Nº documento de material
                  e_mjahr         = DATA(e_mjahr)   " Ano do documento do material
                  e_docnum        = DATA(e_docnum)  " Nº documento
                  e_retorno       = e_retorno
              ).

            LOOP AT e_retorno INTO DATA(wa_retorno).
            ...
            IF r_gerou EQ abap_true.
              WAIT UP TO 2 SECONDS.
              me->set_nr_documento_material( i_mblnr = e_mblnr i_mjahr = e_mjahr ).
              me->set_nr_fiscal( i_docnum = e_docnum ).
            ENDIF.
          ...
          CATCH zcx_material_destinacao INTO DATA(ex_material).
            ...
            CALL METHOD me->set_add_log_nfe
              EXPORTING
                i_type         = 'E'
                i_id           = ex_material->msgid
                i_num          = ex_material->msgno
                i_message_v1   = ex_material->msgv1
                i_message_v2   = ex_material->msgv2
                i_message_v3   = ex_material->msgv3
                i_message_v4   = ex_material->msgv4
              CHANGING
                p_lc_sequencia = lc_sequencia.
            ...
            RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
              EXPORTING
                textid = VALUE #( msgid = ex_material->msgid
                                  msgno = ex_material->msgno
                                  attr1 = ex_material->msgv1
                                  attr2 = ex_material->msgv2
                                  attr3 = ex_material->msgv3
                                  attr4 = ex_material->msgv4 )
                msgty  = 'E'
                msgid  = ex_material->msgid
                msgno  = ex_material->msgno
                msgv1  = ex_material->msgv1
      ...
      ELSE.
        ...
        IF me->pedidos IS NOT INITIAL.
          SELECT * INTO TABLE @DATA(it_ekko) FROM ekko FOR ALL ENTRIES IN @me->pedidos WHERE ebeln EQ @me->pedidos-ebeln.
          SELECT * INTO TABLE @DATA(it_ekpo) FROM ekpo FOR ALL ENTRIES IN @me->pedidos WHERE ebeln EQ @me->pedidos-ebeln AND ebelp EQ @me->pedidos-ebelp.
        ELSE.
          SELECT * INTO TABLE it_ekko FROM ekko FOR ALL ENTRIES IN me->itens WHERE ebeln EQ me->itens-ebeln.
          SELECT * INTO TABLE it_ekpo FROM ekpo FOR ALL ENTRIES IN me->itens WHERE ebeln EQ me->itens-ebeln AND ebelp EQ me->itens-ebelp.
        ENDIF.
        ...
        i_cabecalho-data_documento  = me->nota-dt_emissao.
        ...
        i_cabecalho-exch_rate      = me->nota-ctr_wkurs. "BUG - 78143 - CBRAND
        ...
        CONCATENATE i_cabecalho-doc_referencia l_serie INTO i_cabecalho-doc_referencia SEPARATED BY '-'.

        IF me->pedidos IS NOT INITIAL.
          "PEDIDOS DO MOVIMENTO DE MERCADORIA
          LOOP AT me->pedidos INTO DATA(wa_pedido).

            "Pedido de Compra
            READ TABLE it_ekko INTO DATA(wa_ekko) WITH KEY ebeln = wa_pedido-ebeln BINARY SEARCH.

            "Pedido de Compra - Item
            READ TABLE it_ekpo INTO DATA(wa_ekpo) WITH KEY ebeln = wa_pedido-ebeln ebelp = wa_pedido-ebelp BINARY SEARCH.

            "Pedido de Compra - Divisões do programa de remessas
            READ TABLE it_eket INTO DATA(wa_eket) WITH KEY ebeln = wa_pedido-ebeln ebelp = wa_pedido-ebelp BINARY SEARCH.
            ...
            wa_itens-unload_pt = wa_pedido-unload_pt. "S4hana RJF
            wa_itens-gr_rcpt   = wa_pedido-gr_rcpt.   "S4hana RJF
            wa_itens-item_text = wa_pedido-item_text.  "S4hana RJF
            wa_itens-tipo_movimento  = wa_tipos_pedido_compra-tipo_movimento.
            wa_itens-material        = wa_pedido-matnr.
            wa_itens-local_expedicao = me->nota-f_tomadora.
            wa_itens-fornecedor      = wa_ekko-lifnr.
            IF wa_pedido-lgort IS NOT INITIAL.
              wa_itens-deposito      = wa_pedido-lgort.
            ELSE.
            ...
            CHECK wa_pedido-ebeln IS NOT INITIAL.
            CHECK wa_pedido-ebelp IS NOT INITIAL.
            ...
            CALL METHOD zcl_pedido_compra=>get_chave_controle_conf_item
              EXPORTING
                ...
                i_ebelp = wa_pedido-ebelp
              IMPORTING
                e_kzabs = DATA(e_kzabs)
              RECEIVING
                r_bstae = DATA(r_bstae).

            IF me->nota-p_emissor NE wa_ekko-lifnr.
              wa_itens-suppl_vend    = me->nota-p_emissor.
            ENDIF.

            READ TABLE it_mara INTO DATA(wa_mara) WITH KEY matnr = wa_pedido-matnr BINARY SEARCH.

            "Verificar se Material é Administrado por Lote mais Não tem Classe Definida """""""""""""""""""""""""""
            """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
            DATA(lc_ck_lote) = abap_false.
            IF wa_mara-xchpf EQ abap_true.
              FIND REGEX 'C' IN wa_mara-pstat.
              IF sy-subrc IS INITIAL.
                lc_ck_lote = abap_true.
              ENDIF.
            ENDIF.
            """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
            ...
            IF wa_eket-charg IS NOT INITIAL.
              ...
              wa_itens-peso     = wa_pedido-menge.
              wa_itens-unidade  = wa_pedido-meins.
              APPEND wa_itens TO i_itens.
            ELSEIF me->lotes IS NOT INITIAL AND  wa_mara-xchpf = abap_true. " CS2021000371
              LOOP AT me->lotes INTO DATA(wa_lote) WHERE ebeln EQ wa_pedido-ebeln AND ebelp EQ wa_pedido-ebelp.
                wa_itens-lote     = wa_lote-charg.
                wa_itens-peso     = wa_lote-menge.
                wa_itens-unidade  = wa_pedido-meins.
                "CS2021000371
                wa_itens-expirydate = wa_lote-vfdat.
                wa_itens-prod_date  = wa_lote-hsdat.
                APPEND wa_itens TO i_itens.
              ENDLOOP.
            ELSEIF wa_mara-xchpf EQ abap_true AND lc_ck_lote EQ abap_false AND wa_ekpo_t-knttp IS NOT INITIAL.
              wa_itens-peso       = wa_pedido-menge.
              wa_itens-unidade    = wa_pedido-meins.
              wa_itens-expirydate = wa_pedido-vfdat.
              wa_itens-prod_date  = wa_pedido-hsdat.
              APPEND wa_itens TO i_itens.
            ELSEIF wa_mara-xchpf EQ abap_true AND lc_ck_lote EQ abap_false AND wa_ekpo_t-knttp IS INITIAL.
              wa_itens-peso       = wa_pedido-menge.
              wa_itens-unidade    = wa_pedido-meins.
              wa_itens-expirydate = wa_pedido-vfdat.
              wa_itens-prod_date  = wa_pedido-hsdat.
              wa_itens-lote       = wa_pedido-charg.
              APPEND wa_itens TO i_itens.
        ...
        ELSE.
          ...
          LOOP AT me->itens INTO DATA(wa_item).
            ...
            "Pedido de Compra - Item
            READ TABLE it_ekpo INTO wa_ekpo WITH KEY ebeln = wa_item-ebeln ebelp = wa_item-ebelp BINARY SEARCH.

            "Pedido de Compra - Divisões do programa de remessas
            READ TABLE it_eket INTO wa_eket WITH KEY ebeln = wa_item-ebeln ebelp = wa_item-ebelp BINARY SEARCH.

            "Departamento - Tipo de Pedido de Compra
            READ TABLE it_tipos_pedido_compra INTO wa_tipos_pedido_compra
            WITH KEY bstyp = wa_ekko-bstyp
                     bsart = wa_ekko-bsart
            BINARY SEARCH.
            ...
            READ TABLE e_ekpo_t INTO wa_ekpo_t INDEX 1.
            ...
            CASE r_bstae.
              WHEN '0001'.
                wa_itens-deliv_numb = wa_item-deliv_numb.
                wa_itens-deliv_item = wa_item-deliv_item.
            ENDCASE.
            ...
            READ TABLE it_mara INTO wa_mara WITH KEY matnr = wa_item-matnr BINARY SEARCH.
            ...
            IF wa_eket-charg IS NOT INITIAL.
              ...
              APPEND wa_itens TO i_itens.
            ELSEIF me->lotes IS NOT INITIAL AND wa_mara-xchpf EQ abap_true. " BUG 44763 - IR039436  - ZMM0116 - Notas com itens lotes obrigatorio e sem lotes
        ...
        IF me->pedidos IS INITIAL.
          ...
          IF wa_ekko-bsart EQ 'ZFTE' OR wa_ekko-bsart EQ 'ZSEM'.
            DATA(ck_forcar_aviso) = abap_true.
          ELSE.
            ck_forcar_aviso = abap_false.
          ENDIF.
        ELSE.
          ck_forcar_aviso = abap_false.
        ENDIF.

        IF r_bstae EQ '0004'. " OR ck_forcar_aviso EQ abap_true.

          TRY .
              TRY .
                  DATA(lc_gerou_aviso) = me->nfe_inbound_remessa( ).
                  IF lc_gerou_aviso EQ abap_false.
                    me->gera_erro_geral( i_texto = 'Aviso de Recebimento não foi gerado!' ).
                  ENDIF.
                CATCH zcx_delivery INTO DATA(ex_delivery).
                  me->nfe_sol_miro_softexpert( i_estornar = 'E' ).
                  me->gera_erro_geral( i_texto = ex_delivery->get_text( ) ).
                CATCH zcx_cadastro INTO DATA(ex_cadastro).
                  me->nfe_sol_miro_softexpert( i_estornar = 'E' ).
                  me->gera_erro_geral( i_texto = ex_cadastro->get_text( ) ).
              ENDTRY.

              "Gerar Movimento de Mercadoria Pelo Aviso
              DATA: lc_aviso TYPE REF TO zcl_aviso_recebimento.

              CREATE OBJECT lc_aviso.
              DATA(r_gerou_entrada) =
              lc_aviso->set_data_vencimento( i_vfdat = me->nota-dt_vencimento
               )->set_nr_remessa( i_remessa = me->nota-vbeln
               )->piking(
               ).
              DATA(r_retorno_aviso) = lc_aviso->get_retorno( ).

              CLEAR: lc_aviso.

            CATCH zcx_delivery INTO ex_delivery.

              me->nfe_sol_miro_softexpert( i_estornar = 'E' ).

              CALL METHOD me->set_add_log_nfe
                EXPORTING
                  i_type         = ex_delivery->msgty
                  i_id           = ex_delivery->msgid
                  i_num          = ex_delivery->msgno
                  i_message_v1   = ex_delivery->msgv1
                  i_message_v2   = ex_delivery->msgv2
                  i_message_v3   = ex_delivery->msgv3
                  i_message_v4   = ex_delivery->msgv4
                CHANGING
                  p_lc_sequencia = lc_sequencia.

          ENDTRY.

          IF r_gerou_entrada EQ abap_true AND me->nota-vbeln IS NOT INITIAL.
            r_gerou = abap_true.
            WAIT UP TO 2 SECONDS.
            SELECT SINGLE * INTO @DATA(wa_mkpf)
              FROM mkpf AS m
             WHERE le_vbeln EQ @me->nota-vbeln
               AND tcode2   EQ 'VL32N'
               AND EXISTS ( SELECT * FROM mseg AS e
                   WHERE e~mblnr EQ m~mblnr AND e~mjahr EQ m~mjahr
*                   AND E~LIFNR EQ @ME->NOTA-P_EMISSOR
                   AND e~smbln EQ @space )
               AND NOT EXISTS ( SELECT * FROM mseg AS e WHERE e~smbln EQ m~mblnr AND e~sjahr EQ m~mjahr ).

            me->set_nr_documento_material( i_mblnr = wa_mkpf-mblnr i_mjahr = wa_mkpf-mjahr ).
            MESSAGE s001(zmigo) WITH wa_mkpf-mblnr wa_mkpf-mjahr.
          ELSE.
            r_gerou = abap_false.
          ENDIF.
        ...
        ELSE.
*        IF R_BSTAE EQ '0003' AND ME->NOTA-VBELN IS NOT INITIAL.
*          TRY .
*              CREATE OBJECT ME->REPOSITORY.
*              R_GEROU_ENTRADA =
*              ME->REPOSITORY->DELIVERY_AVISO(
*               )->SET_DATA_VENCIMENTO( I_VFDAT = ME->NOTA-DT_VENCIMENTO
*               )->SET_NR_REMESSA( I_REMESSA = ME->NOTA-VBELN
*               )->PIKING(
*               ).
*              ME->REPOSITORY->FREE( ).
...
*-CS2020000214 - BUG 46905 - JAime TAssoni - 05.11.2020 - inicio
          IF r_bstae EQ '0003' AND ck_forcar_aviso EQ abap_true. "Gera aviso desvinculado
            TRY.
              ...
              CATCH zcx_delivery INTO DATA(cx_erro_aviso).
            ...
            ENDTRY.
          ENDIF.
*-CS2020000214 - BUG 46905 - JAime TAssoni - 05.11.2020 - fim

*-CS2025000249-19.05.2025-#175013-JT-inicio
*-----------------------------------------------------
*-------- vinculacao PEdido x MIGO
*-------- Lancamento MIGO com categoria Fiscal
*-----------------------------------------------------
          IF me->get_config_tipo_pedido( )-ck_nao_vinc_miro_migo_ped = abap_true OR
             me->get_config_tipo_movimento( )-j_1bnfrel = abap_true.

            LOOP AT i_itens            INTO DATA(_itens).
              DATA(lv_tabix)              = sy-tabix.

              IF me->get_config_tipo_pedido( )-ck_nao_vinc_miro_migo_ped = abap_true.
                CLEAR: _itens-po_number, _itens-po_item.
                i_cabecalho-goodsmvt_code = '06'.
                _itens-tipo_movimento     = me->get_config_tipo_pedido( )-tipo_movimento.
              ENDIF.

              IF me->get_config_tipo_movimento( )-j_1bnfrel = abap_true.
                TRY.
                    DATA(lc_leis_fisc) = me->get_leis_fiscais( _itens-material ).
                    _itens-tax_code       = lc_leis_fisc-mwskz.
                    _itens-ext_base_amont = me->nota-vl_total.

                  CATCH zcx_nfe_inbound_exception INTO DATA(zcx_nfe_inbound).
                    zcx_nfe_inbound->published_erro( i_msgty = 'S' i_msgty_display = 'E' ).
                    sy-msgty = 'E'.
                    me->set_add_log_nfe( EXPORTING i_type         = zcx_nfe_inbound->msgty
                                                   i_id           = zcx_nfe_inbound->msgid
                                                   i_num          = zcx_nfe_inbound->msgno
                                                   i_message_v1   = zcx_nfe_inbound->msgv1
                                                   i_message_v2   = zcx_nfe_inbound->msgv2
                                                   i_message_v3   = zcx_nfe_inbound->msgv3
                                                   i_message_v4   = zcx_nfe_inbound->msgv4
                                          CHANGING p_lc_sequencia = lc_sequencia ).
                    me->nfe_inbound_gravar_log( ).
                    COMMIT WORK.
                    RETURN.
                ENDTRY.
              ENDIF.
              MODIFY i_itens           FROM _itens INDEX lv_tabix.
            ENDLOOP.
          ENDIF.
*-CS2025000249-19.05.2025-#175013-JT-fim
          ...
          IF r_gerou_migo EQ abap_true.
            WAIT UP TO 2 SECONDS.
            me->set_nr_documento_material( i_mblnr = mat_doc i_mjahr = doc_year ).
...
*ZPP0014 Edição lotes criados a partir da ZMM0110 - BG #138699 - INICIO
            ...
            LOOP AT it_lotes ASSIGNING FIELD-SYMBOL(<fs_lote>).
              IF <fs_lote>-licha IS NOT INITIAL .
                ...
                <fs_zpp0016>-matnr  = <fs_lote>-matnr.
                <fs_zpp0016>-werks  = <fs_lote>-werks.
                <fs_zpp0016>-lgort  =  wa_ekpo-lgort.
                <fs_zpp0016>-chargd = <fs_lote>-charg.
                <fs_zpp0016>-charg  = <fs_lote>-charg.
                <fs_zpp0016>-zlicha = <fs_lote>-licha.
                <fs_zpp0016>-clabs  = <fs_lote>-menge.
...
*ZPP0014 Edição lotes criados a partir da ZMM0110 - BG #138699 - FIM
            ...
            IF e_j_1bnfdoc IS NOT INITIAL.
              ...
              IF sy-subrc IS INITIAL.
                wa_ib_nota-nu_documento_sap = e_j_1bnfdoc-docnum.
                wa_ib_nota-xmlvers          = '2.00'.
                wa_ib_nota-tp_authcod       = '1'.
                wa_ib_nota-regiao           = me->nota-chave_nfe(2).
                wa_ib_nota-authcod          = me->nota-nr_protocolo.
                wa_ib_nota-dt_authcod       = me->nota-dt_protocolo.
                wa_ib_nota-vlr_nota         = me->nota-vl_total.
                wa_ib_nota-code             = '100'.
                wa_ib_nota-docnum9          = me->nota-chave_nfe+34(9).
                wa_ib_nota-docstat          = '1'.
                wa_ib_nota-cdv              = me->nota-chave_nfe+43(1).

                CALL FUNCTION 'Z_1B_NF_ALTERA_STATUS'
                  EXPORTING
                    it_notas      = wa_ib_nota
                    ls_acttab_new = wa_acttab
                    ls_doc_new    = e_j_1bnfdoc.
          ...
          ELSE.
            ...
            "DATA(R_RETORNO) = ME->REPOSITORY->AT_MIGO->GET_RETORNO( ).
            LOOP AT e_retorno INTO wa_retorno.
              CALL METHOD me->set_add_log_nfe
                EXPORTING
                  i_type         = wa_retorno-type
                  i_id           = wa_retorno-id
...
*          me->set_nfe_revisada( i_usuario_revisor = sy-uname ).
          TRY.
              ...
              IF r_gerou_miro = abap_true.
                me->nfe_sol_miro_softexpert( ).
                me->set_nfe_revisada( i_usuario_revisor = sy-uname ).
              ELSE.
                me->nfe_sol_miro_softexpert( i_estornar = 'E' ).
********* ALRS***************************************************************
                w_campo = '(SAPLMG26)GT_MARD_AGG'.
                ASSIGN (w_campo) TO <gt_mard>.
                IF <gt_mard> IS ASSIGNED.
                  REFRESH <gt_mard>.
                ENDIF.
                me->nfe_inbound_cancela_aceite( ).
                me->nfe_inbound_cancela_fisico(
                   IMPORTING
                     e_mblnr = DATA(e_mblnr2)
                     e_mjahr = DATA(e_mjahr2) ).
...
********** ALRS***************************************************************
            ...
            CATCH zcx_miro_exception INTO cx_erro_miro.
              ...
              me->nfe_inbound_cancela_fisico(
                 IMPORTING
                   e_mblnr = DATA(e_mblnr3)
                   e_mjahr = DATA(e_mjahr3) ).
              r_gerou = abap_false.
              CALL METHOD me->set_add_log_nfe
                EXPORTING
                  i_type         = sy-msgty
...
*-CS2021000662 - 19.11.2021 - JT - inicio
    ELSEIF me->ck_retorno_sem_ajuste = abap_true AND ( me->nota-ck_revisao = abap_true OR me->nota-se_status = 'SUCCESS_CRIA' ).
...
*-CS2021000662 - 19.11.2021 - JT - fim
  ...
  method nfe_inbound_fatura.
    data: wa_cabecalho        type zde_miro_cabecalho,
          ...
          e_wkurs	            type wkurs,
          e_valor_total	      type bapi_rmwwr,
          v_data              type sy-datlo,
          v_ktokk             type lfa1-ktokk, "Ajuste Taxa MIRO parceiro Intercompany - BG #165365
          v_gdatu             type tcurr-gdatu, "Ajuste Taxa MIRO parceiro Intercompany - BG #165365
          v_ukurs             type tcurr-ukurs, "Ajuste Taxa MIRO parceiro Intercompany - BG #165365
          e_valor_desconto    type bapi_wskto.

    r_gerou = abap_false.

*-CS2025000249-19.05.2025-#175013-JT-inicio
    if me->get_ck_migo_cat_fiscal( ) = abap_true.
      r_gerou = abap_true.
      return.
    endif.
*-CS2025000249-19.05.2025-#175013-JT-fim
    ...
    if wa_miro is initial.
      ...
      select single ktokk from lfa1 into v_ktokk where lifnr = me->nota-p_emissor.

      if me->nota-ctr_waers eq 'USD' and v_ktokk eq 'ZFIC'.  "MOEDA DOLAR E FORNCEDOR INTERCOMPANY
        data: wlin type j_1bnflin,
              wbrk type vbrk.
        select single *
          from j_1bnfdoc
          ...
          into  corresponding fields of @wlin
          where j_1bnfdoc~nfenum eq @me->nota-numero
*          and   j_1bnfdoc~series eq @me->nota-serie
          and   j_1bnfdoc~docdat eq @me->nota-dt_emissao
          and   j_1bnfdoc~direct eq '2'
          and   j_1bnfdoc~parvw  eq 'RE'
          and   j_1bnfdoc~branch eq @me->nota-p_emissor+6(4)
        ...
        if sy-subrc = 0.
          select single *
            from vbrk
            into wbrk
           where vbeln = wlin-refkey+0(10).
        endif.
        if  wbrk-cpkur = 'X' and wbrk-kurrf gt 0.
          v_ukurs = wbrk-kurrf.
          wa_cabecalho-exch_rate = v_ukurs.
          me->nota-ctr_wkurs = v_ukurs.
          me->nota-ctr_valor_total = me->nota-vl_total / me->nota-ctr_wkurs.
        else.
          concatenate me->nota-dt_emissao+6(2) me->nota-dt_emissao+4(2) me->nota-dt_emissao(4) into v_data.
        ...
        loop at me->pedidos into wa_pedido.
          ...
          call method zcl_miro=>get_taxas_iva
            exporting
              ...
              i_lifnr                 = me->nota-p_emissor "SD - Faturamento Saida Insumos - Sementes US 169508 - WPP --->>
            importing
...
*------------Inicio CS2024000243 / aoenning*
      if me->nota-ck_fpol is not initial.
        lc_miro->set_fora_politica( exporting i_ck_fpol = me->nota-ck_fpol i_obs_financeira = me->nota-obs_financeira ).
      endif.

*------------Fim CS2024000243 / aoenning*
...
*      LC_AVISO->SET_FORNECEDOR( I_LIFNR = ME->NOTA-P_EMISSOR ).
      ...
      select single lifnr
        ...
        into @data(w_lifnr)
        where ebeln =  @me->nota-ebeln.
      lc_aviso->set_fornecedor( i_lifnr = w_lifnr ).
                                                            "US152305
...
*    ME->SET_ARM_ENVIAR_ACEITE_OPERACAO( ).
  ...
  METHOD NFE_SOL_ANEXA_MIRO_SOFTEXPERT.
    ...
    TRY .
        ...
        WA_ANEXOS-ACTIVITYID = 'atvlancarmiro'.
        WA_ANEXOS-FILENAME   = 'Documento' && ME->NOTA-BELNR && '_'  && ME->NOTA-GJAHR && '_'  && ME->NOTA-DOCNUM_NFE && '.pdf'.

        TRY .
            DATA(E_OTF01) =
            ZCL_ARQUIVO=>GET_SMARTFORM_PROGRAM(
                I_INSTANCE_MEMORY_AREA = 'PDF_MIRO' && ME->NOTA-BELNR && ME->NOTA-GJAHR
                I_PROGRAM              = 'ZMMR139' " Nome do programa ABAP
                I_PARAMETROS           = VALUE #( ( SELNAME = 'PBELNR'   KIND = 'P' LOW  = ME->NOTA-BELNR )
                                                  ( SELNAME = 'PGJAHR'   KIND = 'P' LOW  = ME->NOTA-GJAHR )
                                                  ( SELNAME = 'PXSTRING' KIND = 'P' LOW  = ABAP_TRUE ) ) ).

            DATA(E_OTF02) =
            ZCL_ARQUIVO=>GET_SMARTFORM_PROGRAM(
              EXPORTING
                I_INSTANCE_MEMORY_AREA = 'PDF_DocFiscal' && ME->NOTA-DOCNUM_NFE
                I_PROGRAM              = 'ZMMR138' " Nome do programa ABAP
                I_PARAMETROS           = VALUE #( ( SELNAME = 'PDOCNUM'  KIND = 'P' LOW  = ME->NOTA-DOCNUM_NFE )
                                                  ( SELNAME = 'PXSTRING' KIND = 'P' LOW  = ABAP_TRUE ) ) ).
          ...
          CATCH ZCX_ARQUIVO INTO DATA(EX_ARQUIVO).    "
            ...
            ZCL_NFE_INBOUND=>GERA_ERRO_GERAL( I_TEXTO = MTEXT ).
        ENDTRY.
        ...
        IF SY-SUBRC IS NOT INITIAL.
          MESSAGE ID SY-MSGID TYPE SY-MSGTY NUMBER SY-MSGNO WITH SY-MSGV1 SY-MSGV2 SY-MSGV3 SY-MSGV4 INTO MTEXT.
          ZCL_NFE_INBOUND=>GERA_ERRO_GERAL( I_TEXTO = MTEXT ).
        ENDIF.
        ...
        I_NEW_WORKFLOW-PROCESSID = OBJETO->ZIF_SOFT_EXPERT_WS_INJECT~I_ID_PROCESSID.

        DATA: I_USUARIO	TYPE SY-UNAME.

        IF SY-UNAME NE 'WSSE_SE'.
          I_USUARIO = SY-UNAME.
        ELSE.
          IF ME->NOTA-MBLNR IS NOT INITIAL.
            SELECT SINGLE USNAM INTO I_USUARIO
              FROM MKPF
             WHERE MBLNR = ME->NOTA-MBLNR
               AND MJAHR = ME->NOTA-MJAHR.
          ELSE.
        ...
        ZCL_SOFT_EXPERT_WORKFLOW=>ZIF_SOFT_EXPERT_WORKFLOW~GET_INSTANCE(
          ...
          )->GET_USERID( EXPORTING I_USUARIO = I_USUARIO IMPORTING E_USERID = I_NEW_WORKFLOW-USERID
          )->NEW_ATTACHMENTS( EXPORTING I_NEW_WORKFLOW = I_NEW_WORKFLOW I_WORKFLOWID = CONV #( ME->NOTA-SE_RECORDID )
          ).
  ...
  method nfe_sol_miro_softexpert.
    ...
    case i_estornar.
      when abap_false.
        try .
            ...
            if me->pedidos is initial.
              loop at me->itens into data(wa_item).
                if wa_values-value is initial.
                  wa_values-value = wa_item-ebeln.
                else.
                  concatenate wa_values-value ',' into wa_values-value.
                  concatenate wa_values-value wa_item-ebeln into wa_values-value separated by space.
                endif.
              endloop.
            else.
              read table me->pedidos into data(wa_pedidos) index 1.
              if sy-subrc is initial.
                wa_values-value = wa_pedidos-ebeln.
              endif.
            endif.

            check wa_values-value is not initial. "Checa se foi atribuido numero pedido.

            wa_values-key         = me->nota-chave_nfe.
            ...
            wa_values-value       = me->nota-chave_nfe.
            objeto->add_entity_value( i_entity_value = wa_values ).

            wa_values-tabname     = 'NOTA'.
            wa_values-attributeid = 'DTVENC'.
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_data.
            wa_values-value       = me->nota-dt_vencimento.
            objeto->add_entity_value( i_entity_value = wa_values ).

            wa_values-tabname     = 'NOTA'.
            wa_values-attributeid = 'TEMBOLETO'.
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
            wa_values-value       = cond string( when me->nota-pymt_meth ne zcl_miro=>st_forma_pagamento_boleto then '0' else '1' ).
            objeto->add_entity_value( i_entity_value = wa_values ).

            wa_values-tabname     = 'NOTA'.
            wa_values-attributeid = 'DTDOCUMENTO'.
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_data.
            wa_values-value       = me->nota-dt_emissao.
            objeto->add_entity_value( i_entity_value = wa_values ).

            wa_values-tabname     = 'NOTA'.
            wa_values-attributeid = 'FILIALCOD'.
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
            wa_values-value       = me->nota-f_tomadora.
            objeto->add_entity_value( i_entity_value = wa_values ).

            wa_values-tabname     = 'NOTA'.
            wa_values-attributeid = 'FORNECEDORCNPJ'.
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
            if me->nota-forne_cnpj is not initial.
              wa_values-value       = me->nota-forne_cnpj.
            else.
              wa_values-value       = me->nota-forne_cpf.
            endif.
            objeto->add_entity_value( i_entity_value = wa_values ).
            ...
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
            wa_values-value       = me->nota-forne_razao.
            objeto->add_entity_value( i_entity_value = wa_values ).

            wa_values-tabname     = 'NOTA'.
            wa_values-attributeid = 'CDFORNECEDOR'.
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
            wa_values-value       = me->nota-p_emissor.
            objeto->add_entity_value( i_entity_value = wa_values ).

            wa_values-tabname     = 'NOTA'.
            wa_values-attributeid = 'REFNF'.
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
            concatenate me->nota-numero '-' me->nota-serie into wa_values-value.
            objeto->add_entity_value( i_entity_value = wa_values ).

            wa_values-tabname     = 'NOTA'.
            wa_values-attributeid = 'VALOR'.
            wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_moeda.
            lc_vl_total = me->nota-vl_total.
            ...
            if me->nota-mblnr is not initial.
              ...
              wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
              concatenate me->nota-mblnr '/' me->nota-mjahr into wa_values-value.
              objeto->add_entity_value( i_entity_value = wa_values ).
            endif.

            if me->nota-vbeln is not initial.
              wa_values-tabname     = 'NOTA'.
              wa_values-attributeid = 'REMESSA'.
              wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
              wa_values-value       = me->nota-vbeln.
              objeto->add_entity_value( i_entity_value = wa_values ).
            endif.

*-CS2022001142-07.02.2023-#99559-JT-inicio
            read table me->pedidos into data(w_ped1) index 1.

            select knttp
              into @data(_knttp)
              from ekpo
                up to 1 rows
             where ebeln = @w_ped1-ebeln
               and knttp = 'A'.
            endselect.

            wa_values-attributeid = 'IMOBILIZADO'.
            wa_values-value       = cond #( when sy-subrc = 0 then '1'
                                                              else '0' ).
            objeto->add_entity_value( i_entity_value = wa_values ).
*-CS2022001142-07.02.2023-#99559-JT-fim
            ...
            if me->nota-zlspr is not initial.
              wa_values-attributeid = 'LANCBLOQUEADO'. "lacnbloqueado BUG 56662 IR058236
              wa_values-value       = '1'.
              objeto->add_entity_value( i_entity_value = wa_values ).
            else.
*-CS2022001142-07.02.2023-#99559-JT-inicio
              read table me->pedidos into data(w_ped2) index 1.

              select vgabe
                into @data(_vgabe)
                from ekbe
                  up to 1 rows
               where   ebeln = @w_ped2-ebeln
                 and ( vgabe = '4'
                  or   vgabe = 'C' ).
              endselect.
...
**         >>>>>>>>>>>>>>Inicio ajuste referente IR222478 / BUG SOLTO 166590 / AOENNING
            wa_values-attributeid = 'TIPOUTILIZACAO'.
            wa_values-value       = 'Mercadoria'.
            objeto->add_entity_value( i_entity_value = wa_values ).
**         >>>>>>>>>>>>>>Fim ajuste referente ir222478 / bug solto 166590 / aoenning

             "CS2023000911 ZMM0116 - Expansão/Criação - ALZ GRAOS - BG -- INICIO
             wa_values-attributeid = 'empresadopedido'.
            wa_values-value       = me->nota-bukrs.
            objeto->add_entity_value( i_entity_value = wa_values ).

*-CS2024000243-05.06.2024-#136397-JT-inicio
            wa_values-attributeid = 'chkforapolitica'.
            wa_values-value       = cond #( when me->nota-ck_fpol = abap_true then '1'
                                                                              else '0' ).
            objeto->add_entity_value( i_entity_value = wa_values ).
*-CS2024000243-05.06.2024-#136397-JT-fim

            "CS2023000911 ZMM0116 - Expansão/Criação - ALZ GRAOS - BG -- FIM
            lc_cte-p_emissor = me->nota-p_emissor.
            lc_cte-zbvtyp    = me->nota-zbvtyp.
            ...
            if sy-subrc is initial.
              ...
              wa_values-value       = lc_bnka-bankl(3).
              wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
              objeto->add_entity_value( i_entity_value = wa_values ).

              wa_values-attributeid = 'AGENCIA'.
              if not lc_lfbk-bkont is initial.
                concatenate lc_lfbk-bankl+4(11) '-' lc_lfbk-bkont into wa_values-value.
              else.
                wa_values-value = lc_lfbk-bankl+4(11).
              endif.
              wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
              objeto->add_entity_value( i_entity_value = wa_values ).

              wa_values-attributeid = 'CONTA'.
              wa_values-value       = lc_lfbk-bankn.
              wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
              objeto->add_entity_value( i_entity_value = wa_values ).
            endif.
            ...
            if lc_text1 is not initial or lc_text2 is initial.
              lc_info = lc_text1.
            elseif lc_text1 is initial or lc_text2 is not initial.
              lc_info = lc_text2.
            elseif lc_text1 is not initial or lc_text2 is not initial.
              concatenate lc_text1 lc_text2 into lc_info separated by space.
            endif.

*** Inicio - Rubenilson - 12.12.24 - US158498
            if me->nota-obs_financeira is not initial.
              concatenate lc_info me->nota-obs_financeira into lc_info separated by space.
            endif.
*** Fim - Rubenilson - 12.12.24 - US158498

            if lc_info is not initial.
              wa_values-attributeid = 'INFO'.
              wa_values-value       = lc_info.
              wa_values-type        = zif_soft_expert_workflow=>st_type_field_value_texto.
              objeto->add_entity_value( i_entity_value = wa_values ).
            endif.

            if me->nota-se_recordid is initial or me->nota-se_status = 'SUCCESS_CRIA'.
              "Add Anexo """"""""""""""""""""""""""""""""
            ...
            zcl_soft_expert_workflow=>zif_soft_expert_workflow~get_instance(
                   ...
                   exporting i_desativar = i_desativar
                             i_new_workflow = value #( status    = me->nota-se_status
                                                       code      = me->nota-se_code
                                                       detail    = me->nota-se_detail
                                                       recordkey = me->nota-se_recordkey
                                                       recordid  = me->nota-se_recordid )
                   importing e_new_workflow = data(e_new_workflow)
              ).

            if i_desativar eq abap_true and e_new_workflow-status = 'SUCCESS'.
              e_new_workflow-status = 'SUCCESS_CRIA'.
            elseif i_desativar ne abap_true and me->nota-se_status = 'SUCCESS_CRIA'.
              e_new_workflow-status = 'SUCCESS'.
            endif.

            me->nota-se_code      = e_new_workflow-code.
            me->nota-se_detail    = e_new_workflow-detail.
            me->nota-se_recordid  = e_new_workflow-recordid.
            me->nota-se_recordkey = e_new_workflow-recordkey.
            me->nota-se_status    = e_new_workflow-status.
            "
            update zib_nfe_dist_ter
               set se_code      = e_new_workflow-code
                   se_detail    = e_new_workflow-detail
                   se_recordid  = e_new_workflow-recordid
                   se_recordkey = e_new_workflow-recordkey
                   se_status    = e_new_workflow-status
             where chave_nfe eq me->nota-chave_nfe.

            message s123 with e_new_workflow-recordid.
      ...
      when 'E'.
        check me->nota-se_recordid is not initial.

        try .
*            ZCL_SOFT_EXPERT_WORKFLOW=>ZIF_SOFT_EXPERT_WORKFLOW~GET_INSTANCE(
*             )->CANCEL_WORKFLOW(
*              EXPORTING
*                I_WORKFLOWID             = CONV #( ME->NOTA-SE_RECORDID )
*                I_EXPLANATION            = 'Estornado Automático por erro de processamento'
*            ).
            ...
            zcl_soft_expert_workflow=>zif_soft_expert_workflow~get_instance(
                   ...
                   exporting i_new_workflow = value #( status    = me->nota-se_status
                                                       code      = me->nota-se_code
                                                       detail    = me->nota-se_detail
                                                       recordkey = me->nota-se_recordkey
                                                       recordid  = me->nota-se_recordid )
            ...
            data(lc_se_recordid) = me->nota-se_recordid.

            clear: me->nota-se_code,
                   me->nota-se_detail,
                   me->nota-se_recordid,
                   me->nota-se_recordkey,
                   me->nota-se_status.
            ...
            message s124 with lc_se_recordid.
  ...
  method refresh.
    ...
    data(vl_chave_nfe) = me->nota-chave_nfe.
    data: v_data  type sy-datlo,    "Diferença da taxa USD nas compras e vendas intercompany #168097
          v_ktokk type lfa1-ktokk,  "Diferença da taxa USD nas compras e vendas intercompany #168097
          v_gdatu type tcurr-gdatu, "Diferença da taxa USD nas compras e vendas intercompany #168097
          v_ukurs type tcurr-ukurs. "Diferença da taxa USD nas compras e vendas intercompany #168097

    me->limpar_registro( i_nao_limpa ). "*-CS2025000249-08.04.2025-#173180-JT-inicio

    select single * into me->nota from zib_nfe_dist_ter where chave_nfe eq vl_chave_nfe.

*-CS2025000249-08.04.2025-#173180-JT-inicio
    if me->nota-cd_departamento is initial.
      select single cd_departamento into me->nota-cd_departamento from zmmt0072.
    endif.
*-CS2025000249-08.04.2025-#173180-JT-fim

    me->st_fiscal_anterior = me->nota-st_fiscal.
* Diferença da taxa USD nas compras e vendas intercompany #168097 - BG - INICIO
    select single ktokk from lfa1 into v_ktokk where lifnr = me->nota-p_emissor.
...
* Diferença da taxa USD nas compras e vendas intercompany #168097 - BG - FIM
    "Informar conta bancária no ped. compras #138397 - RPS
    " IF me->nota-zbvtyp IS INITIAL.
    select single * into @data(it_zmmt035) from zmmt0035 where ebeln eq @me->nota-ebeln.

    if it_zmmt035-bvtyp is not initial.
      me->nota-zbvtyp = it_zmmt035-bvtyp.
    endif.
    " ENDIF.
    ...
    if me->nota-st_documento eq zcl_nfe_inbound=>st_documento_00.
      me->nota-land1 = 'BR'.
  ...
  METHOD set_aceitar_documento.
    ...
    IF sy-tcode EQ 'ZMM0110' OR sy-tcode EQ 'ZMM0116' OR sy-tcode EQ 'ZSDT0112'.
      AUTHORITY-CHECK OBJECT 'ZNFE_INB' ID 'ZANFETER'   FIELD '06'
                                        ID 'ZNFETERMEP' FIELD me->nota-e_tomadora
                                        ID 'ZNFETERFIL' FIELD me->nota-f_tomadora
                                        ID 'ZNFETERDEP' FIELD me->nota-cd_departamento.
    ...
    IF me->pedidos[] IS INITIAL AND ck_retorno EQ abap_false.
      ...
      LOOP AT me->itens ASSIGNING FIELD-SYMBOL(<fs_item>).
        IF <fs_item>-ebeln IS INITIAL OR <fs_item>-ebelp IS INITIAL OR
           ...
           <fs_item>-lgort IS INITIAL OR "*-CS2025000249-04.06.2025-#168929-JT
          ...
          IF sy-subrc <> 0.
            RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
              EXPORTING
                textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
                                  msgno = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
                                  attr1 = CONV #( 'Depósito não Encontrado!' ) )
                msgid  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
                msgno  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
                msgv1  = CONV #( 'Depósito não Encontrado!' )
                msgty  = 'E'.
          ENDIF.
*-CS2025000249-04.06.2025-#168929-JT-fim
    ...
    IF me->nota-ck_possui_frete = abap_true AND
       me->nota-f_transporte IS INITIAL     AND
       me->nota-st_fiscal NE '00' AND
       me->nota-st_fiscal NE '01' AND "SD - Faturamento Saida Insumos - Sementes US 169508 - WPP
       me->nota-st_fiscal NE '02'.    "SD - Faturamento Saida Insumos - Sementes US 169508 - WPP
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
...
*---CS2025000249-04.06.2025-#168929-JT-inicio
*--------------------------------------------------
*-- verificar se Fornecedor tem categ IRF = SF
*--------------------------------------------------
    IF me->get_lfa1( me->nota-p_emissor )-stkzn = abap_true.
      DATA(t_lfbw) = me->get_fornecedor_irf( i_bukrs = me->nota-e_tomadora
                                             i_lifnr = me->nota-p_emissor ).

      LOOP AT me->itens INTO DATA(_itens).
        IF me->get_mara( _itens-matnr )-spart = '04'.
          READ TABLE t_lfbw INTO DATA(_lfbw) WITH KEY witht = 'SF'.
          IF sy-subrc <> 0.
            RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
              EXPORTING
                textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
                                  msgno = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
                                  attr1 = CONV #( 'Aceite não pode ser feito porque ' )
                                  attr2 = CONV #( 'Fornecedor não tem Categoria IRF: SF' ) )
                msgid  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
                msgno  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
                msgv1  = CONV #( 'Aceite não pode ser feito porque ' )
                msgv2  = CONV #( 'Fornecedor não tem Categoria IRF: SF' )
                msgty  = 'E'.
          ENDIF.
        ENDIF.
      ENDLOOP.
...
*---CS2025000249-04.06.2025-#168929-JT-fim
  ...
  METHOD SET_ARM_ENVIO_ACEITE.
    ...
    IF ME->NOTA-ST_ARMAZEM EQ SPACE.
      ME->NOTA-ST_ARMAZEM = ME->ST_ARMAZENAGEM_00.
    ENDIF.

    CHECK ME->NOTA-CK_TRANS_NF_PROPRI EQ ABAP_FALSE.
    ...
    IF CK_EDI NE ABAP_TRUE.
      ...
      ME->NOTA-ST_ARMAZEM = ME->ST_ARMAZENAGEM_04.
    ENDIF.
...
*99	Finalizado Com Aceite Fiscal
    ...
    call method zcl_fiscal=>get_documento_chave
      exporting
        i_chave   = me->nota-chave_nfe
        i_propria = abap_false
      receiving
        r_docnum  = data(docnum_nfe)
      exceptions
        erro      = 1
        others    = 2.

    if docnum_nfe is initial and me->nota-mblnr is not initial.
      ...
      if sy-subrc is initial.
        docnum_nfe = wa_j_1bnflin-docnum.
      endif.
    ...
    if me->nota-ck_armazem eq abap_true.
    ...
    if docnum_nfe is not initial and me->nota-docnum_nfe is initial.
...
*      ENDIF.
      ...
      "Recuperar Fatura
      wa_rbkp = me->get_fatura_nfe_inbound( exporting i_docnum = docnum_nfe importing e_rseg = it_rseg ).
    ...
    elseif me->nota-docnum_nfe is not initial and docnum_nfe is initial.
    ...
    elseif ( docnum_nfe is not initial )
       and ( me->nota-st_fiscal eq zcl_nfe_inbound=>st_fiscal_sem_aceite_fiscal or
             me->nota-st_fiscal eq zcl_nfe_inbound=>st_fiscal_pendente or
             me->nota-st_fiscal eq zcl_nfe_inbound=>st_fiscal_departamento or
             me->nota-st_fiscal eq zcl_nfe_inbound=>st_fiscal_depart_aprovado ).
...
*99	Finalizado
    ...
    if me->nota-tp_compra_futura ne zcl_nfe_inbound=>tp_compra_futura_fatura.
      ...
      data(wa_likp) = me->get_aviso_valido( ).
      if me->nota-vbeln is initial.
        if ( me->nota-st_fiscal eq zcl_nfe_inbound=>st_fiscal_com_aceite_fiscal ) and ( wa_likp is not initial ).
          me->set_nr_remessa( i_remessa = wa_likp-vbeln ).
          me->set_st_fisico( i_st_fisico = me->st_fisico_aviso_gerado ).
        endif.
      elseif me->nota-vbeln is not initial.
        if wa_likp is initial.
          me->set_nr_remessa_clear( ).
          me->set_st_fisico( i_st_fisico = me->st_fisico_00 ).
          me->set_ck_fisico( i_check     = abap_false ).
        elseif me->nota-vbeln is not initial and ( me->nota-st_fisico eq me->st_fisico_00 or me->nota-st_fisico eq me->st_fisico_01 ).
          me->set_st_fisico( i_st_fisico = me->st_fisico_aviso_gerado ).
        elseif wa_likp is not initial and me->nota-vbeln is initial.
          me->set_nr_remessa( i_remessa = wa_likp-vbeln ).
          if me->nota-st_fisico eq me->st_fisico_00 or me->nota-st_fisico eq me->st_fisico_01.
            me->set_st_fisico( i_st_fisico = me->st_fisico_aviso_gerado ).
          endif.
        endif.
      endif.
    ...
    if me->nota-st_fisico = me->st_fisico_aviso_gerado.
    ...
    me->set_docnum_nfe( i_docnum = docnum_nfe ).

    " BUG REVISAO com Status 16/02/2022
    if me->nota-ck_revisao = 'X' and
       me->nota-st_documento = '99' and
       me->nota-ck_fiscal is initial.
      me->ck_alterou = 'X'.
      me->nota-st_documento = ''.
      me->nota-ck_fiscal = 'X'.

    endif.
    if sy-tcode = 'ZMM0110'.                                "US152305
      if me->nota-ebeln is initial.
        select single ebeln
          into me->nota-ebeln
          from zib_nfe_dist_itm
         where chave_nfe eq me->nota-chave_nfe
      ...
      if me->nota-ebeln is not initial.
        ...
        where ebeln = @me->nota-ebeln.
        if sy-subrc is initial.
          if ls_ekko-inco1 ne 'FOB'.
            me->nota-ck_possui_frete = ' '.
            me->ck_alterou = 'X'.
          endif.
        endif.
      else.
      ...
      if (  me->nota-ebeln is not initial and
            me->nota-belnr is initial and
            me->nota-mblnr is initial and
            me->nota-st_fisico ne '00' ).
        me->nota-st_fiscal    = '99'.
        me->nota-st_fisico    = '00'.
        me->nota-st_documento = ''.
        me->nota-ck_fiscal    = 'X'.
        me->nota-ck_fisico    = ''.
      ...
      if (  me->nota-ebeln is not initial and
            me->nota-belnr is initial and
            me->nota-mblnr is initial and
            me->nota-vbeln is initial and
            me->nota-st_fiscal eq '02' ).
        me->nota-st_fiscal    = '00'.
        me->ck_alterou = 'X'.
      endif.


      if ( me->nota-belnr is initial and me->nota-mblnr is not initial and me->nota-st_fisico ne '03' ). "Gerou a MIGO mas não gerou a MIRO
        me->nota-st_fiscal    = '99'.
        me->nota-st_fisico    = '03'.
        me->nota-st_documento = '01'.
        me->nota-ck_fiscal    = 'X'.
        me->nota-ck_fisico    = 'X'.
        me->ck_alterou = 'X'.
      endif.

      if ( me->nota-ebeln is initial and me->nota-belnr is initial and me->nota-mblnr is initial and me->nota-st_fiscal is not initial ). "Sem documentos
        me->nota-st_fiscal    = ''.
        me->nota-st_fisico    = ''.
        me->nota-st_documento = ''.
        me->nota-ck_fiscal    = ''.
      ...
      if ( me->nota-ebeln is not initial and me->nota-belnr is not initial and me->nota-mblnr is not initial ). "todos gerados
        me->nota-st_fiscal    = '99'.
        me->nota-st_fisico    = '99'.
        me->nota-st_documento = '99'.
        me->ck_alterou = 'X'.
      endif.
    endif.
  ...
  METHOD set_info_sap.
    ...
    "SD - Faturamento Saida Insumos - Sementes US 169508 - WPP --->>
    IF me->nota-chave_nfe IS NOT INITIAL AND me->nota-ck_fiscal IS NOT INITIAL.

      DATA(lva_processo_zsdt0112) = abap_false.
      SELECT SINGLE *
      ...
      IF sy-subrc EQ 0.
        lva_processo_zsdt0112 = abap_true.
      ELSE.
        SELECT SINGLE *
      ...
      IF lva_processo_zsdt0112 EQ abap_true AND sy-tcode NE 'ZSDT0112'.
        RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
          EXPORTING
            textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
                              msgno = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
                              attr1 = CONV #( 'Operação só permitida pela transação ZSDT0112!' ) )
            msgid  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
            msgno  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
            msgv1  = CONV #( 'Operação só permitida pela transação ZSDT0112!' )
            msgty  = 'E'.
      ENDIF.
...
*    ENDLOOP.
    ...
    IF me->st_fiscal_anterior IS INITIAL OR
      ...
      IF me->nota-st_fiscal IS INITIAL.
        me->set_st_documento( i_st_documento = me->st_documento_00 ).
        me->set_st_fiscal( i_st_fiscal = me->st_fiscal_pendente ).
        me->set_st_fisico( i_st_fisico = me->st_fisico_00 ).
        me->set_st_armazem( i_st_armazem = me->st_armazenagem_00 ).
      ...
      TRY .
          DATA(wa_j_1bbranch) = me->get_tomador( i_cnpj = me->nota-destino_cnpj i_ie = me->nota-destino_ie ).
      ...
      me->nota-e_tomadora = wa_j_1bbranch-bukrs.
      me->nota-f_tomadora = wa_j_1bbranch-branch.

      "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC"
      " Emissor """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
      IF me->nota-e_tomadora IS NOT INITIAL.

        TRY .
            DATA(wa_lifnr) = me->get_fornecedor( i_forne_cnpj         = me->nota-forne_cnpj
                                                 i_forne_cpf          = me->nota-forne_cpf
                                                 i_forne_ie           = me->nota-forne_ie
                                                 i_serie_nota         = me->nota-serie
                                                 i_bukrs              = me->nota-e_tomadora ).
            CALL METHOD me->set_add_log_nfe
              EXPORTING
                i_type         = sy-msgty
                i_id           = sy-msgid
        ...
        me->nota-p_emissor = wa_lifnr-lifnr.
      ENDIF.

      "Atribuir Prioridade de Pagamento do Fornecedor
      IF me->nota-zbvtyp IS INITIAL AND me->nota-p_emissor IS NOT INITIAL.
        TRY .
            me->nota-zbvtyp = zcl_miro=>get_prioridade_banco_forne( i_lifnr = me->nota-p_emissor ).

            zcl_miro=>get_formapag_banco_empresa(
              EXPORTING
                i_bukrs           = me->nota-bukrs        " Empresa
                i_lifnr           = me->nota-p_emissor    " Nº conta do fornecedor
                i_bvtyp           = me->nota-zbvtyp       " Tipo de banco do parceiro
              IMPORTING
                e_forma_pagamento = me->nota-pymt_meth    " Forma de pagamento
                e_banco_empresa   = me->nota-housebankid  " Chave breve de um banco da empresa
            ).
...
*      me->set_departamento_nota( ). "comentado 13/03/2024 ( alterando indevidamente o fiscal)
    ...
    CALL FUNCTION 'OIL_DATE_TO_TIMESTAMP'
      EXPORTING
        ...
        i_time   = sy-uzeit
      IMPORTING
        e_tstamp = me->nota-timestamp.

    IF me->nota-st_documento EQ me->st_documento_00.
  ...
  METHOD SET_INFO_TRANSPORTE.

    R_NFE_INBOUND = ME.

    IF I_ZIB_NFE_DIST_FRT-ID_AGENT_FRETE IS NOT INITIAL.
      TRY .

          DATA(AT_LFA1) =
          CAST ZCL_FORNECEDORES(
           ZCL_FORNECEDORES=>ZIF_PARCEIROS~GET_INSTANCE(
             )->SET_PARCEIRO( I_PARCEIRO = I_ZIB_NFE_DIST_FRT-ID_AGENT_FRETE
             )->CK_ATIVO(
             )->CK_ATIVO_EMPRESA( I_EMPRESA = ME->NOTA-E_TOMADORA
             ) )->AT_LFA1 .

        CATCH ZCX_PARCEIROS INTO DATA(EX_PARCEIRO).
          RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
            EXPORTING
              TEXTID    = VALUE #( MSGID = EX_PARCEIRO->MSGID
                                   MSGNO = EX_PARCEIRO->MSGNO
                                   ATTR1 = EX_PARCEIRO->MSGV1
                                   ATTR2 = EX_PARCEIRO->MSGV2
                                   ATTR3 = EX_PARCEIRO->MSGV3
                                   ATTR4 = EX_PARCEIRO->MSGV4 )
              MSGTY     = 'E'
              MSGID     = EX_PARCEIRO->MSGID
              MSGNO     = EX_PARCEIRO->MSGNO
              MSGV1     = EX_PARCEIRO->MSGV1
              MSGV2     = EX_PARCEIRO->MSGV2
              MSGV3     = EX_PARCEIRO->MSGV3
              MSGV4     = EX_PARCEIRO->MSGV4
              TRANSACAO = EX_PARCEIRO->TRANSACAO.
      ENDTRY.
    ENDIF.

    IF I_ZIB_NFE_DIST_FRT-ID_PROPRIETARIO IS NOT INITIAL.
      TRY .
          ZCL_FORNECEDORES=>ZIF_PARCEIROS~GET_INSTANCE(
            )->SET_PARCEIRO( I_PARCEIRO = I_ZIB_NFE_DIST_FRT-ID_PROPRIETARIO
            )->CK_ATIVO(
            )->CK_ATIVO_EMPRESA( I_EMPRESA = ME->NOTA-E_TOMADORA
            ).
    ...
    IF I_ZIB_NFE_DIST_FRT-ID_MOTORISTA IS NOT INITIAL.
      TRY .
          ZCL_FORNECEDORES=>ZIF_PARCEIROS~GET_INSTANCE(
            )->SET_PARCEIRO( I_PARCEIRO = I_ZIB_NFE_DIST_FRT-ID_MOTORISTA
            )->CK_ATIVO(
            ).
        CATCH ZCX_PARCEIROS INTO EX_PARCEIRO.
          RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
    ...
    TRY .
        IF I_ZIB_NFE_DIST_FRT-DS_PLACA_TRATOR IS NOT INITIAL.
          TRY .
              DATA(LC_TRACAO) = ZCL_VEICULOS=>ZIF_VEICULOS~GET_INSTANCE( )->SET_VEICULO( I_PLACA = I_ZIB_NFE_DIST_FRT-DS_PLACA_TRATOR ).
          ...
          CASE LC_ACHOU.
            WHEN ABAP_TRUE.
              LC_TRACAO->GET_CK_VEICULO_TRACAO( )->GET_VALIDA_PLACA( ).
              IF ME->FRETE-ID_AGENT_FRETE IS INITIAL AND ME->FRETE-ID_PROPRIETARIO IS INITIAL.
                ME->FRETE-ID_AGENT_FRETE  = LC_TRACAO->AT_VEICULO-PROPRIETARIO.
                ME->FRETE-ID_PROPRIETARIO = LC_TRACAO->AT_VEICULO-PROPRIETARIO.
              ENDIF.
              CLEAR: LC_TRACAO.
            WHEN ABAP_FALSE.
              ZCL_VEICULOS=>ZIF_VEICULOS~GET_INSTANCE( )->GET_VALIDA_PLACA( I_PLACA = CONV #( I_ZIB_NFE_DIST_FRT-DS_PLACA_TRATOR ) ).
          ENDCASE.
        ENDIF.

        IF I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_1 IS NOT INITIAL.
          TRY .
              DATA(LC_REBOQUE1) = ZCL_VEICULOS=>ZIF_VEICULOS~GET_INSTANCE( )->SET_VEICULO( I_PLACA = I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_1 ).
              LC_ACHOU  = ABAP_TRUE.
            CATCH ZCX_VEICULOS.
              LC_ACHOU  = ABAP_FALSE.
          ENDTRY.
          ...
          CASE LC_ACHOU.
            WHEN ABAP_TRUE.
              LC_REBOQUE1->GET_CK_VEICULO_REBOQUE( )->GET_VALIDA_PLACA( ).
              CLEAR: LC_REBOQUE1.
            WHEN ABAP_FALSE.
              ZCL_VEICULOS=>ZIF_VEICULOS~GET_INSTANCE( )->GET_VALIDA_PLACA( I_PLACA = CONV #( I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_1 ) ).
          ENDCASE.
        ENDIF.

        IF I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_2 IS NOT INITIAL.
          TRY .
              DATA(LC_REBOQUE2) = ZCL_VEICULOS=>ZIF_VEICULOS~GET_INSTANCE( )->SET_VEICULO( I_PLACA = I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_2 ).
              LC_ACHOU  = ABAP_TRUE.
            CATCH ZCX_VEICULOS.
              LC_ACHOU  = ABAP_FALSE.
          ENDTRY.
          ...
          CASE LC_ACHOU.
            WHEN ABAP_TRUE.
              LC_REBOQUE2->GET_CK_VEICULO_REBOQUE( )->GET_VALIDA_PLACA( ).
              CLEAR: LC_REBOQUE2.
            WHEN ABAP_FALSE.
              ZCL_VEICULOS=>ZIF_VEICULOS~GET_INSTANCE( )->GET_VALIDA_PLACA( I_PLACA = CONV #( I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_2 ) ).
          ENDCASE.
        ENDIF.

        IF I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_3 IS NOT INITIAL.
          TRY .
              DATA(LC_REBOQUE3) = ZCL_VEICULOS=>ZIF_VEICULOS~GET_INSTANCE( )->SET_VEICULO( I_PLACA = I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_3 ).
              LC_ACHOU  = ABAP_TRUE.
            CATCH ZCX_VEICULOS.
              LC_ACHOU  = ABAP_FALSE.
          ENDTRY.
          ...
          CASE LC_ACHOU.
            WHEN ABAP_TRUE.
              LC_REBOQUE3->GET_CK_VEICULO_REBOQUE( )->GET_VALIDA_PLACA( ).
              CLEAR: LC_REBOQUE3.
            WHEN ABAP_FALSE.
              ZCL_VEICULOS=>ZIF_VEICULOS~GET_INSTANCE( )->GET_VALIDA_PLACA( I_PLACA = CONV #( I_ZIB_NFE_DIST_FRT-DS_PLACA_REBOQ_3 ) ).
          ENDCASE.
        ENDIF.
      ...
      CATCH ZCX_VEICULOS INTO DATA(EX_VEICULOS).
        ...
        RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
          EXPORTING
            TEXTID    = VALUE #( MSGID = EX_VEICULOS->MSGID
                                 MSGNO = EX_VEICULOS->MSGNO
                                 ATTR1 = EX_VEICULOS->MSGV1
                                 ATTR2 = EX_VEICULOS->MSGV2
                                 ATTR3 = EX_VEICULOS->MSGV3
                                 ATTR4 = EX_VEICULOS->MSGV4 )
            MSGTY     = 'E'
            MSGID     = EX_VEICULOS->MSGID
            MSGNO     = EX_VEICULOS->MSGNO
            MSGV1     = EX_VEICULOS->MSGV1
            MSGV2     = EX_VEICULOS->MSGV2
            MSGV3     = EX_VEICULOS->MSGV3
            MSGV4     = EX_VEICULOS->MSGV4
            TRANSACAO = EX_VEICULOS->TRANSACAO.

    ENDTRY.

    IF I_ZIB_NFE_DIST_FRT-ID_AGENT_FRETE IS NOT INITIAL AND AT_LFA1 IS NOT INITIAL.
      ME->NOTA-F_TRANSPORTE       = AT_LFA1-LIFNR.
      ME->NOTA-TRANSPORTADOR_CNPJ = AT_LFA1-STCD1.
      ME->NOTA-TRANSPORTADOR_CPF  = AT_LFA1-STCD2.
      ME->NOTA-TRANSPORTADOR_IE   = AT_LFA1-STCD3.
    ENDIF.

    ME->NOTA-CK_TRANS_NF_PROPRI = I_CK_TRANS_NF_PROPRI.
    ME->FRETE = I_ZIB_NFE_DIST_FRT.
  ...
  METHOD set_lote_item.
    ...
    DATA: lv_charg TYPE charg_d.        "*-CS2025000249-07.05.2025-#174157-JT

    READ TABLE me->lotes ASSIGNING FIELD-SYMBOL(<fs_lote>) WITH KEY cd_lote_item = i_lote-cd_lote_item.

    CHECK sy-subrc = 0.                 "*-CS2025000249-08.04.2025-#173180-JT

    MOVE-CORRESPONDING i_lote TO <fs_lote>.

    "Verificar se Lote Existe
    IF i_lote-charg IS NOT INITIAL OR   "*-CS2025000249-07.05.2025-#174157-JT
       i_lote-licha IS NOT INITIAL.     "*-CS2025000249-07.05.2025-#174157-JT

      TRY.
*-CS2025000249-07.05.2025-#174157-JT-inicio
          IF me->get_ck_lote_fornecedor( i_lote-clint ) = abap_true AND i_lote-licha IS NOT INITIAL.
            CALL METHOD zcl_charg=>get_charg
              EXPORTING
                i_matnr = i_lote-matnr
                i_licha = i_lote-licha
              RECEIVING
                r_mch1  = DATA(r_mch1).

            lv_charg = r_mch1-charg.
          ELSE.
            CALL METHOD zcl_charg=>get_charg
              EXPORTING
                i_matnr = i_lote-matnr
...
*-CS2025000249-07.05.2025-#174157-JT-fim
          ...
          CALL METHOD zcl_charg=>get_charg_detalhe
            EXPORTING
              i_matnr         = i_lote-matnr
              i_charg         = lv_charg "i_lote-charg  "*-CS2025000249-07.05.2025-#174157-JT
          ...
          <fs_lote>-charg = e_ymcha-charg.              "*-CS2025000249-07.05.2025-#174157-JT
...
*-CS2025000249-07.05.2025-#174157-JT-inicio
          IF i_lote-cd_lote_item(1) = '$'.
            LOOP AT me->lotes_caracteristicas ASSIGNING FIELD-SYMBOL(<fs_lt_car>) WHERE cd_lote_item = i_lote-cd_lote_item.
              READ TABLE r_char_of_batch INTO DATA(wa_batch) WITH KEY atinn = <fs_lt_car>-atinn.
              IF sy-subrc IS INITIAL.
                <fs_lt_car>-atwrt = wa_batch-atwtb.
              ENDIF.
            ENDLOOP.

            LOOP AT i_lote_caract ASSIGNING FIELD-SYMBOL(<fs_lotecc>) WHERE cd_lote_item EQ i_lote-cd_lote_item.
              READ TABLE r_char_of_batch INTO wa_batch WITH KEY atinn = <fs_lotecc>-atinn.
              IF sy-subrc IS INITIAL.
                <fs_lotecc>-atwrt = wa_batch-atwtb.
              ENDIF.
            ENDLOOP.
          ENDIF.
*-CS2025000249-07.05.2025-#174157-JT-fim
...
*            ENDIF.
  ...
  METHOD SET_NFE_EM_REVISAO.

    DATA: WA_REVISAO TYPE ZIB_NFE_DIST_REV.

    CHECK ME->NOTA-CHAVE_NFE IS NOT INITIAL.

    CHECK ME->CK_IGNORA_DATA_SE_VENCIMENTO EQ ABAP_FALSE.

    R_INSTANCE = ME.

    WA_REVISAO-CHAVE_NFE   = ME->NOTA-CHAVE_NFE.
    ...
    UPDATE ZIB_NFE_DIST_REV
       SET CK_ULTIMO = ABAP_FALSE
     WHERE CHAVE_NFE EQ ME->NOTA-CHAVE_NFE
       AND CK_ULTIMO EQ ABAP_TRUE.

    MODIFY ZIB_NFE_DIST_REV FROM WA_REVISAO.

    UPDATE ZIB_NFE_DIST_TER
       SET CK_REVISAO   = ABAP_TRUE
           ST_DOCUMENTO = SPACE    "CS2021000918 Configurar retorno de correção/migo com reserva material - ZMM0116
     WHERE CHAVE_NFE EQ ME->NOTA-CHAVE_NFE.

    ME->NOTA-CK_REVISAO = ABAP_TRUE.
  ...
  METHOD SET_NFE_REVISADA.

    R_INSTANCE = ME.

    CHECK ME->NOTA-CHAVE_NFE IS NOT INITIAL.

    SELECT SINGLE * INTO @DATA(WA_REVISAO)
    ...
    WA_REVISAO-CK_REVISADO = ABAP_TRUE.
    WA_REVISAO-US_REVISADO = I_USUARIO_REVISOR.
    WA_REVISAO-DT_REVISADO = SY-DATUM.
    WA_REVISAO-HR_REVISADO = SY-UZEIT.
    MODIFY ZIB_NFE_DIST_REV FROM WA_REVISAO.

    UPDATE ZIB_NFE_DIST_TER
       SET CK_REVISAO = ABAP_FALSE
     WHERE CHAVE_NFE EQ ME->NOTA-CHAVE_NFE.

    ME->NOTA-CK_REVISAO = ABAP_FALSE.
        ...
        IF lc_ck_achou EQ abap_true.
          CALL METHOD me->set_item_material
            EXPORTING
              ...
              i_lgort     = <fs_item_t>-lgort   "*-CS2025000249-04.06.2025-#168929-JT
        ...
        IF lc_ck_achou IS NOT INITIAL.
          CALL METHOD me->set_item_material
            EXPORTING
              ...
              i_lgort     = <fs_item>-lgort   "*-CS2025000249-04.06.2025-#168929-JT
...
*---------------------------------
  ...
  METHOD valida_atributo_alteravel_lote.
    ...
    DATA: lc_lote_existe TYPE c LENGTH 1,
          lv_campo       TYPE string,            "*-CS2025000249-07.05.2025-#174157-JT
          wa_lotes       TYPE zib_nfe_dist_lot.  "*-CS2025000249-07.05.2025-#174157-JT
...
*-CS2025000249-07.05.2025-#174157-JT-inicio
    READ TABLE me->lotes   INTO wa_lotes WITH KEY prod_item    = i_prod_item
                                                  cd_lote_item = i_cd_lote_item.
    IF sy-subrc <> 0.
      READ TABLE me->lotes INTO wa_lotes WITH KEY prod_item    = i_prod_item.
    ENDIF.
*-CS2025000249-07.05.2025-#174157-JT-fim
...
*-CS2025000249-07.05.2025-#174157-JT-inicio
    IF i_lote  IS INITIAL AND
       i_licha IS INITIAL.
      me->get_ck_lote_fornecedor( EXPORTING i_clint = wa_lotes-clint IMPORTING e_campo = lv_campo ).
      IF i_campo EQ lv_campo.
        r_permitido = abap_true.
        EXIT.
      ELSE.
        r_permitido = abap_false.
...
*-CS2025000249-07.05.2025-#174157-JT-fim
    ELSE.
      ...
      TRY.
*-CS2025000249-07.05.2025-#174157-JT-inicio
          IF me->get_ck_lote_fornecedor( wa_lotes-clint ) = abap_false.
...
*-CS2021000662 - 19.11.2021 - JT - fim
                                                            ...
                                                            "US152305
        IF sy-tcode = 'ZMM0110' OR sy-tcode EQ 'ZSDT0112'.
          me->set_informacoes_existentes( ).
        ENDIF.
                                                            "US152305
        ...
        IF me->ck_aceite_fiscal EQ abap_true.
          ...
          me->set_st_fiscal( i_st_fiscal = me->st_fiscal_com_aceite_fiscal ).
          me->set_ck_fiscal( i_check = abap_true ).
          me->set_st_fiscal_data( i_st_fiscal_data = sy-datum ).  "*-CS2025000249-17.04.2025-#173311-JT
          ...
          MODIFY zib_nfe_dist_ter FROM me->nota.
          me->nfe_inbound_gravar_log( ).
          me->set_executa_zfis55( ).  "*-CS2025000249-02.05.2025-#174115-JT
          COMMIT WORK.
...
*-CS2025000249-08.04.2025-#173180-JT-inicio
    IF i_nao_limpa = abap_false.
      FREE: me->at_pedido_massa,
            me->at_chaves_pedmassa.
    ENDIF.
*-CS2025000249-08.04.2025-#173180-JT-fim
  ...
  METHOD zif_cadastro~set_registro.
    ...
    SELECT SINGLE * INTO wa_nota FROM zib_nfe_dist_ter WHERE chave_nfe EQ i_id_registro.

    IF sy-subrc IS INITIAL.

      CALL METHOD zcl_nfe_inbound=>set_enqueue_nfe
        EXPORTING
          i_chave                 = wa_nota-chave_nfe
      ...
      IF sy-subrc IS NOT INITIAL.
        RAISE EXCEPTION TYPE zcx_cadastro
          EXPORTING
            ...
            msgno  = zcx_cadastro=>zcx_bloqueado-msgno.
      ELSE.
        APPEND wa_nota-chave_nfe TO me->at_chaves_lock.
        APPEND wa_nota-chave_nfe TO me->at_chaves_pedmassa.  "*-CS2025000249-08.04.2025-#173180-JT-inicio
      ENDIF.

      me->nota = wa_nota.

      me->refresh( i_nao_limpa ).  "*-CS2025000249-08.04.2025-#173180-JT-inicio
...
*              l_nrosol          TYPE numc5, " RIM CS1029457 ANB 30.09.2022
              ...
              l_mensagem        TYPE string.  "*-CS2025000249-08.04.2025-#173180-JT-inicio

        DATA: v_valor_item_xml TYPE ekpo-netpr,
              v_diferenca      TYPE ekpo-netpr.
        CLEAR: sy-msgty.
        ...
        IF me->ck_aceite_fiscal IS NOT INITIAL.
          ...
          LOOP AT it_materiais INTO DATA(wa_materiais).
            ...
            ELSE.
              ...
              me->nfe_inbound_gravar_log( ).  "*-CS2025000249-17.04.2025-#173311-JT
              ck_validou = abap_false.
              EXIT.
            ENDIF.
          ENDLOOP.
          ...
          ELSE.
            ...
            LOOP AT me->itens INTO DATA(wa_itens).
              ...
              IF _ekpo-werks NE me->nota-f_tomadora.
                ...
                EXIT.
              ENDIF.
              IF _ekpo-bstae NE _ekpo2-bstae.
                MESSAGE s170 DISPLAY LIKE 'E'.
                sy-msgty = 'E'.
                CALL METHOD me->set_add_log_nfe
                  EXPORTING
                    i_type         = sy-msgty
...
*----------------------------------------------------------------
*---------- valida material x item pedido
*---------- valida material expandido para centro faturamento
*----------------------------------------------------------------
          LOOP AT me->itens INTO wa_itens.
            IF wa_itens-ebeln IS NOT INITIAL AND
               wa_itens-ebelp IS NOT INITIAL.
              SELECT SINGLE matnr
                INTO @DATA(_matnr)
                FROM ekpo
               WHERE ebeln = @wa_itens-ebeln
              ...
              IF wa_itens-matnr <> _matnr.
                MESSAGE s024(sd) WITH 'Material da NF Difere Material' 'do Item do Pedido!' DISPLAY LIKE 'E'.
                sy-msgty = 'E'.
                me->set_add_log_nfe( EXPORTING i_type         = sy-msgty
                                               i_id           = sy-msgid
                                               i_num          = sy-msgno
                                               i_message_v1   = sy-msgv1
                                               i_message_v2   = sy-msgv2
              ...
              SELECT SINGLE werks
                INTO @DATA(_werks)
                FROM marc
               WHERE matnr = @wa_itens-matnr
                 AND werks = @me->nota-f_tomadora.

              IF sy-subrc <> 0.
                MESSAGE s024(sd) WITH 'Material não Expandndo para o Centro: ' me->nota-f_tomadora '!' DISPLAY LIKE 'E'.
                sy-msgty = 'E'.
                me->set_add_log_nfe( EXPORTING i_type         = sy-msgty
                                               i_id           = sy-msgid
                                               i_num          = sy-msgno
...
*-CS2025000249-17.04.2025-#173311-JT-inicio
          ...
          CHECK ck_validou = abap_true.                     "US152305
...
*035  Pedido &1 Item &2 Sem Saldo de &3!
              ...
              IF wa_ekko-lifre NE me->nota-p_emissor.
                ...
                IF wa_lfa1-stcd1 IS NOT INITIAL.
                  ...
                  IF sy-subrc IS INITIAL.
                    ...
                    MESSAGE I038 WITH me->nota-p_emissor wa_ekko-lifre DISPLAY LIKE 'W'.
                    CALL METHOD me->set_add_log_nfe
                      EXPORTING
                        i_type         = sy-msgty
                        i_id           = sy-msgid
          ...
          IF ( me->nota-ck_possui_frete EQ abap_true ) AND ( me->nota-f_transporte IS INITIAL AND me->nota-st_fiscal NE '00' ).
...
*                      ENDIF.
              ...
              ELSE.
                LOOP AT me->itens INTO wa_itens.
                  ...
                  " ZMM0110 - Não permitir dar entrada em nota fiscal com valor diferente do pedido - 152648 #BG - INICIO
                  SELECT SINGLE *
                    FROM ekpo
                    INTO @DATA(wa_item_pedido)
                    WHERE ebeln EQ @wa_itens-ebeln AND
                          ebelp EQ @wa_itens-ebelp.

                  v_valor_item_xml = ( wa_itens-prod_vlr_total_b - wa_itens-icms_valor - wa_itens-pis_valor - wa_itens-cof_valor - wa_itens-ipi_valor ) / wa_itens-prod_qtd_comerci.

                  SELECT SINGLE *
                    FROM ekko
                    INTO @DATA(wa_pedido)
                    WHERE ebeln EQ @wa_itens-ebeln.


                  IF wa_pedido-waers EQ 'USD'.
                    v_valor_item_xml = v_valor_item_xml /  wa_itens-ctr_wkurs.
                  ENDIF.
                  wa_item_pedido-netpr  = wa_item_pedido-netpr / wa_item_pedido-peinh.
*                  IF ABS( V_Valor_ITEM_XML -  wa_ITEM_pedido-NETPR ) GT 1.
*                    RAISE EXCEPTION TYPE ZCX_NFE_INBOUND_EXCEPTION
*                      EXPORTING
*                        TEXTID = VALUE #( MSGID = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_BLOC_NF_VALOR_DIF_PEDIDO-MSGID
*                                          MSGNO = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_BLOC_NF_VALOR_DIF_PEDIDO-MSGNO
*                                          ATTR1 = CONV #( WA_ITENS-EBELP )
*                                          ATTR2 = CONV #( WA_ITENS-EBELN ) )
*                        MSGID  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_BLOC_NF_VALOR_DIF_PEDIDO-MSGID
*                        MSGNO  = ZCX_NFE_INBOUND_EXCEPTION=>ZCX_BLOC_NF_VALOR_DIF_PEDIDO-MSGNO
*                        MSGTY  = 'E'
*                        MSGV1  = CONV #( WA_ITENS-EBELP )
*                        MSGV2  = CONV #( WA_ITENS-EBELN ).
*                  ENDIF.

*                  selecionar ekpo onde ebeln = item-ebeln e ebelp = item-ebelp
*obter EKPO-NETPR
*obter PROD_VLR_UND_COM ICMS_VALOR PIS_VALOR COFINS_VALOR IPI_VALOR CTR_WAERS CTR_WKURS
*
*Valor_ITEM_XML = ( PROD VLR_TOTAL B - ICMS_VALOR - PIS_VALOR - COFINS_VALOR - IPI_VALOR ) /
*PROD_QTD_COMERCI
*
*Se CTR_WAERS = "USD"
*   Valor_ITEM_XML = Valor_ITEM_XML / CTR WKURS
*
*DIF = EKPO-NETPR - Valor_ITEM_XML.
*SE ABS(DIF) > 1
*   Erro valor unitario do pedido linha xx diferente pedido X nota


                  " ZMM0110 - Não permitir dar entrada em nota fiscal com valor diferente do pedido - 152648 #BG - FIM
                  SELECT SINGLE * INTO wa_mara
                    FROM mara
...
*-CS2025000249-08.04.2025-#173180-JT-inicio
*-----------------------------------------------------------------
*------------ validar obrigatoriedade caracteristicas
*-----------------------------------------------------------------
              TRY.
                  me->set_validar_caracteristicas( ).
...
*-CS2025000249-08.04.2025-#173180-JT-fim
        ...
        IF me->ck_aceite_faturar EQ abap_true AND me->get_ck_cfop_retorno_armazena( ) EQ abap_false.
          ...
          TRY .
              ...
              IF me->get_config_tipo_movimento( )-j_1bnfrel = abap_false. "*-CS2025000249-19.05.2025-#175013-JT-inicio
                TRY .
                ...
                ELSEIF me->nota-zbvtyp IS INITIAL.
                  RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
                    EXPORTING
                      ...
                      msgty  = 'E'.
                ENDIF.
              ENDIF. "*-CS2025000249-19.05.2025-#175013-JT-inicio
...
*        ENDIF.
        ...
        IF me->nota-chave_nfe IS NOT INITIAL.
          ...
          CASE i_campo.
            ...
            WHEN 'MATNR' OR 'MEINS' OR 'MENGE' OR 'EBELN' OR 'EBELP' OR 'LGORT'.  "*-CS2025000249-04.06.2025-#168929-JT
              IF me->nota-ck_fiscal IS NOT INITIAL OR
                 me->get_pedido_massa( )-confirma_ped_massa = abap_true.  "*-CS2025000249-08.04.2025-#173180-JT
                r_permitido = abap_false.
              ELSE.
                r_permitido = r_permitido.
              ENDIF.
            WHEN 'CK_POSSUI_FRETE'.
              IF me->nota-st_fisico NE zcl_nfe_inbound=>st_fisico_00 OR me->nota-vbeln IS NOT INITIAL.
                IF me->get_pedido_massa( )-confirma_ped_massa = abap_true.  "*-CS2025000249-08.04.2025-#173180-JT
                  r_permitido = abap_true.
                ELSE.
                  r_permitido = abap_false.
                ENDIF.
...
*-CS2025000249-02.05.2025-#174115-JT-inicio
    IF lc_filtro-all_detped = abap_true.
    ...
    ELSEIF lc_filtro-com_detped = abap_true.
      SELECT * INTO TABLE @it_zib_nfe_dist_ter
        FROM zib_nfe_dist_ter AS cap
       WHERE docnum_nfe      IN @lc_filtro-docnum_nfe
         AND numero          IN @lc_filtro-numero
         AND dt_emissao      IN @lc_filtro-dt_emissao
    ...
    ELSEIF lc_filtro-sem_detped = abap_true.
      SELECT * INTO TABLE @it_zib_nfe_dist_ter
        FROM zib_nfe_dist_ter AS cap
       WHERE docnum_nfe      IN @lc_filtro-docnum_nfe
         AND numero          IN @lc_filtro-numero
...
*                                        ID 'ZNFETERDEP' FIELD WA_TER-CD_DEPARTAMENTO.
  ...
  METHOD bloquear_objeto.
    ...
    ELSE.
      APPEND wa_nota-chave_nfe TO me->at_chaves_lock.
      APPEND wa_nota-chave_nfe TO me->at_chaves_pedmassa.  "*-CS2025000249-08.04.2025-#173180-JT
    ENDIF.
  ...
  METHOD get_chaves_lock.

    r_chaves = me->at_chaves_pedmassa[].

  ENDMETHOD.


  METHOD get_ck_lote_fornecedor.

    r_ck_lote_fornecedor = abap_false.

    SELECT SINGLE gestao_lote_fornecedor
      INTO @DATA(_gestao_lote_fornecedor)
      FROM zmmt0213
     WHERE cd_departamento = @me->nota-cd_departamento
       AND bukrs           = @me->nota-bukrs
       AND clint           = @i_clint.

    IF sy-subrc = 0 AND _gestao_lote_fornecedor = abap_true.
      r_ck_lote_fornecedor = abap_true.
      e_campo              = 'LICHA'.
    ELSE.
      e_campo              = 'CHARG'.
    ENDIF.
  ...
  METHOD get_ck_miro_automatica.

    r_ck_miro_automatica = me->ck_miro_automatica.

  ENDMETHOD.


  METHOD get_config_tipo_movimento.

    FREE: r_t156.

    DATA(lc_zmmt0075) = me->get_config_tipo_pedido( ).

    SELECT SINGLE *
      FROM t156
      INTO r_t156
     WHERE bwart = lc_zmmt0075-tipo_movimento.

  ENDMETHOD.


  METHOD get_pedido_massa.

    FREE: r_ped_massa.

    CHECK me->at_pedido_massa-confirma_ped_massa = abap_true.

    IF i_get_header = abap_true.
      me->nota-cd_departamento = me->at_pedido_massa-cd_departamento.
      me->nota-f_transporte    = me->at_pedido_massa-f_transporte.
      me->nota-f_armazem       = me->at_pedido_massa-f_armazem.
      me->nota-ck_possui_frete = me->at_pedido_massa-ck_possui_frete.
    ENDIF.

    LOOP AT me->itens       INTO DATA(_itens).
      CALL METHOD me->set_item_material
        EXPORTING
          i_prod_item = _itens-prod_item
          i_matnr     = me->at_pedido_massa-matnr
          i_ebeln     = me->at_pedido_massa-ebeln
          i_ebelp     = me->at_pedido_massa-ebelp
          i_lgort     = me->at_pedido_massa-lgort
          i_menge     = _itens-prod_qtd_comerci
          i_meins     = me->at_pedido_massa-meins
          i_netpr     = _itens-netpr
          i_netwr     = _itens-netwr.
    ENDLOOP.

    me->ck_alterou             = abap_true.
    r_ped_massa                = me->at_pedido_massa.

  ENDMETHOD.


  METHOD set_ck_miro_automatica.

    FREE: me->ck_miro_automatica.

    IF i_clear = abap_true.
      RETURN.
    ENDIF.

    READ TABLE me->itens INTO DATA(w_itens) INDEX 1.
    ...
    SELECT SINGLE gera_miro_pos_migo
      INTO @DATA(_gera_miro_pos_migo)
      FROM zmmt0210
     WHERE cd_departamento = @me->nota-cd_departamento
       AND bukrs           = @me->nota-bukrs
       AND bsart           = @_bsart.

    CHECK sy-subrc = 0 AND _gera_miro_pos_migo = abap_true.

    SELECT SINGLE cfop
      INTO @DATA(_cfop)
      FROM zmmt0211
     WHERE cd_departamento = @me->nota-cd_departamento
       AND cfop            = @w_itens-prod_cfop.

    CHECK sy-subrc <> 0.

    me->ck_miro_automatica = abap_true.

  ENDMETHOD.


  METHOD set_executa_zfis55.

    DATA: t_itens TYPE zib_nfe_dist_itm_t.

    t_itens = me->itens[].

    SORT t_itens BY chave_nfe ebeln.
    DELETE ADJACENT DUPLICATES FROM t_itens COMPARING chave_nfe ebeln.

    LOOP AT t_itens INTO DATA(w_itens).
      PERFORM f_executar_zfis55  IN PROGRAM zfir0088 USING me->nota-chave_nfe
                                                           w_itens-ebeln.
    ENDLOOP.
  ...
  METHOD set_fiscal_taxas.

    DATA: zde_nfe_dist_itm_preco_ped TYPE zde_nfe_dist_itm_preco_ped.
    ...
    LOOP AT me->itens ASSIGNING  FIELD-SYMBOL(<fs_item>).
      ...
      IF <fs_item>-brtwr IS INITIAL.
        ...
        IF sy-subrc IS INITIAL.
          ...
          IF sy-subrc IS INITIAL.
            <fs_item>-brtwr   = wa_zmmt0037-brtwr.
            <fs_item>-bicms   = wa_zmmt0037-bicms.
            <fs_item>-picms   = wa_zmmt0037-picms.
          ENDIF.
        ELSE.
          ...
          IF sy-subrc IS INITIAL.
            <fs_item>-brtwr   = wa_item_informado-brtwr.
            <fs_item>-bicms   = wa_item_informado-bicms.
            <fs_item>-picms   = wa_item_informado-picms.
            <fs_item>-bpis    = wa_item_informado-bpis.
            <fs_item>-ppis    = wa_item_informado-ppis.
            <fs_item>-bcofins = wa_item_informado-bcofins.
            <fs_item>-pcofins = wa_item_informado-pcofins.
          ENDIF.
        ENDIF.
      ENDIF.

      zde_nfe_dist_itm_preco_ped-brtwr    = <fs_item>-brtwr.
      zde_nfe_dist_itm_preco_ped-bicms    = <fs_item>-bicms.
      zde_nfe_dist_itm_preco_ped-picms    = <fs_item>-picms.
      zde_nfe_dist_itm_preco_ped-bpis     = <fs_item>-bpis.
      zde_nfe_dist_itm_preco_ped-ppis     = <fs_item>-ppis.
      zde_nfe_dist_itm_preco_ped-bcofins  = <fs_item>-bcofins.
      zde_nfe_dist_itm_preco_ped-pcofins  = <fs_item>-pcofins.
      ...
      CALL METHOD me->set_item_material_preco
        EXPORTING
      ...
      IF sy-subrc <> 0.
        RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
          EXPORTING
            textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
                              msgno = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
                              attr1 = CONV #( 'Pedidp/Item nao Encontrado!' ) )
            msgid  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
            msgno  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
            msgty  = 'E'
            msgv1  = CONV #( 'Pedidp/Item nao Encontrado!' ).
      ENDIF.

      SELECT SINGLE meins
        INTO @DATA(_meins)
        FROM mara
       WHERE matnr = @_ekpo-matnr.
      ...
      IF sy-subrc <> 0.
        RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
          EXPORTING
            textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
                              msgno = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
                              attr1 = CONV #( 'Material nao encontrado em Pedido!' ) )
            msgid  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
            msgno  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
            msgty  = 'E'
            msgv1  = CONV #( 'Material nao encontrado em Pedido!' ).
      ENDIF.
    ENDIF.

    me->at_pedido_massa-confirma_ped_massa = abap_true.

    IF i_set_header = abap_true.
      me->at_pedido_massa-cd_departamento  = me->nota-cd_departamento.
      me->at_pedido_massa-f_transporte     = me->nota-f_transporte.
      me->at_pedido_massa-f_armazem        = me->nota-f_armazem.
      me->at_pedido_massa-ck_possui_frete  = me->nota-ck_possui_frete.
    ENDIF.

    IF i_ebeln IS NOT INITIAL.
      me->at_pedido_massa-ebeln            = i_ebeln.
      me->at_pedido_massa-ebelp            = i_ebelp.
      me->at_pedido_massa-matnr            = _ekpo-matnr.
      me->at_pedido_massa-lgort            = _ekpo-lgort.
      me->at_pedido_massa-meins            = _meins.
    ENDIF.

  ENDMETHOD.


  METHOD set_reinicia_carac_lote.

    DATA: t_zib_nfe_dist_lca TYPE TABLE OF zib_nfe_dist_lca,
          w_zib_nfe_dist_lca TYPE zib_nfe_dist_lca.

    CHECK me->nota-ck_fisico = abap_false AND
          me->nota-st_fisico = zcl_nfe_inbound=>st_fisico_00.

    SELECT *
      INTO TABLE @DATA(t_zib_nfe_dist_lot)
...
*----------------------------------------
*-- construcao caracteristicas
*----------------------------------------
    LOOP AT t_zib_nfe_dist_lot INTO DATA(_zib_nfe_dist_lot).

      DELETE FROM zib_nfe_dist_lot WHERE cd_lote_item = _zib_nfe_dist_lot-cd_lote_item.
      DELETE FROM zib_nfe_dist_lca WHERE cd_lote_item = _zib_nfe_dist_lot-cd_lote_item.

      FREE: t_zib_nfe_dist_lca.

      SELECT SINGLE xchpf INTO @DATA(_xchpf) FROM mara WHERE matnr = @_zib_nfe_dist_lot-matnr.
      CHECK sy-subrc = 0 AND _xchpf = abap_true.

      SELECT SINGLE *     INTO @DATA(_klah)  FROM klah WHERE clint = @_zib_nfe_dist_lot-clint.
      CHECK sy-subrc = 0.

      TRY.
          CALL METHOD zcl_charg=>get_charg_detalhe
            EXPORTING
              i_matnr         = _zib_nfe_dist_lot-matnr
              i_charg         = _zib_nfe_dist_lot-charg
              i_werks         = _zib_nfe_dist_lot-werks
            IMPORTING
              e_ymcha         = DATA(lc_ymcha)
              e_classname     = DATA(lc_classname)
            RECEIVING
              r_char_of_batch = DATA(t_char_of_batch).
        CATCH zcx_charg_exception INTO DATA(ex_charg_exception).
          CONTINUE.
      ENDTRY.

      TRY.
          DATA(t_objectdata) = me->get_carateristicas( i_class     = _klah-class
                                                       i_classtype = _klah-klart
                                                       i_object    = CONV #( _zib_nfe_dist_lot-matnr ) ).
        CATCH zcx_charg_exception INTO ex_charg_exception.
          CONTINUE.
      ENDTRY.

      LOOP AT t_objectdata INTO DATA(_objectdata).
        CLEAR: w_zib_nfe_dist_lca.

        CALL FUNCTION 'CONVERSION_EXIT_ATINN_INPUT'
          EXPORTING
            input  = _objectdata-atnam
          IMPORTING
            output = _objectdata-atimb.

        READ TABLE t_char_of_batch INTO DATA(_char_of_batch) WITH KEY atnam = _objectdata-atnam.

        w_zib_nfe_dist_lca-cd_lote_item  = _zib_nfe_dist_lot-cd_lote_item.
        w_zib_nfe_dist_lca-atinn         = _objectdata-atimb.
        w_zib_nfe_dist_lca-smbez         = _objectdata-smbez.
        w_zib_nfe_dist_lca-atwrt         = COND #( WHEN sy-subrc = 0 THEN _char_of_batch-atwtb ELSE abap_off ).
        w_zib_nfe_dist_lca-atnam         = _objectdata-atnam.
        APPEND w_zib_nfe_dist_lca       TO t_zib_nfe_dist_lca.
      ENDLOOP.

      _zib_nfe_dist_lot-cuobj            = lc_ymcha-cuobj_bm.
      _zib_nfe_dist_lot-herkl            = lc_ymcha-herkl.
      _zib_nfe_dist_lot-hsdat            = lc_ymcha-hsdat.
      _zib_nfe_dist_lot-licha            = lc_ymcha-licha.
      _zib_nfe_dist_lot-vfdat            = lc_ymcha-vfdat.
      _zib_nfe_dist_lot-class            = lc_classname.
      _zib_nfe_dist_lot-clint            = _klah-clint.
      _zib_nfe_dist_lot-klart            = _klah-klart.

      IF t_zib_nfe_dist_lca[] IS NOT INITIAL.
        INSERT zib_nfe_dist_lca       FROM TABLE t_zib_nfe_dist_lca.
        MODIFY zib_nfe_dist_lot       FROM _zib_nfe_dist_lot.
      ENDIF.
  ...
  METHOD set_st_fiscal_data.

    IF me->nota-st_fiscal_data NE i_st_fiscal_data.
      me->ck_alterou = abap_true.
    ENDIF.

    me->nota-st_fiscal_data = i_st_fiscal_data.

  ENDMETHOD.


  METHOD set_validar_caracteristicas.

    TYPES: BEGIN OF ty_param,
             clint TYPE ksml-clint.
    TYPES: END   OF ty_param.

    DATA: t_param TYPE TABLE OF ty_param,
          w_param TYPE ty_param,
          l_mesg1 TYPE string,
          l_mesg2 TYPE string,
          l_mesg3 TYPE string.

    SELECT *
      INTO TABLE @DATA(t_par_atributos)
      FROM tvarvc
     WHERE name = 'ZMM0110_CLASS_CK_ATRIBUTOS'.

    CHECK sy-subrc = 0.

    LOOP AT t_par_atributos INTO DATA(w_par_atributos).
      w_param-clint            = w_par_atributos-low.
      APPEND w_param          TO t_param.
    ENDLOOP.

    LOOP AT me->itens INTO DATA(w_itens).

      LOOP AT me->lotes INTO DATA(w_lotes) WHERE prod_item EQ w_itens-prod_item.
        READ TABLE t_param INTO w_param WITH KEY clint = w_lotes-clint.

        CHECK sy-subrc = 0.

        SELECT *
          INTO TABLE @DATA(t_ksml)
          FROM ksml
         WHERE clint = @w_lotes-clint.
        IF sy-subrc <> 0. FREE t_ksml. ENDIF.
        ...
        IF t_ksml[] IS NOT INITIAL.
          ...
          IF sy-subrc <> 0. FREE t_cabn. ENDIF.
        ENDIF.

        LOOP AT me->lotes_caracteristicas INTO DATA(w_lotes_caracteristicas) WHERE cd_lote_item = w_lotes-cd_lote_item.
          READ TABLE t_cabn INTO DATA(w_cabn) WITH KEY atinn = w_lotes_caracteristicas-atinn.

          IF sy-subrc = 0 AND w_cabn-aterf = abap_true.
            IF w_lotes_caracteristicas-atwrt IS INITIAL.

              l_mesg1   = |Caracteristica Obrigatória| && | { w_lotes_caracteristicas-smbez } | && |no Lote|.
              l_mesg2   = | { w_lotes-charg } | && |do Item| && | { w_lotes-prod_item } |.
              l_mesg3   = |não foi Informada!|.
  ...
  METHOD get_ck_migo_cat_fiscal.

    DATA: lc_ref TYPE j_1brefkey.

    FREE: r_ck_migo_cat_fiscal.

    CHECK me->nota-mblnr IS NOT INITIAL.
    ...
    IF sy-subrc = 0.
      r_ck_migo_cat_fiscal = abap_true.
    ENDIF.
  ...
  METHOD get_deposito.
    ...
    CHECK i_ebeln IS NOT INITIAL AND i_ebelp IS NOT INITIAL.
  ...
  METHOD get_fornecedor_irf.

    DATA: t_supplier TYPE TABLE OF ibpsupplier,
    ...
    SELECT *
      ...
      FROM ibpsupplier
     WHERE supplier = i_lifnr.

    SELECT *
 APPENDING TABLE t_supplier
      FROM ibpsupplier
     WHERE businesspartner = i_lifnr.

    LOOP AT t_supplier INTO DATA(_supplier).
      CALL FUNCTION 'FI_WT_READ_LFBW'
        EXPORTING
          i_lifnr   = _supplier-supplier
          i_bukrs   = i_bukrs
        TABLES
          t_lfbw    = t_lfbw
        EXCEPTIONS
      ...
      IF sy-subrc = 0.
        APPEND LINES OF t_lfbw TO r_lfbw.
      ENDIF.

      CALL FUNCTION 'FI_WT_READ_LFBW'
        EXPORTING
          i_lifnr   = _supplier-businesspartner
          i_bukrs   = i_bukrs
        TABLES
          t_lfbw    = t_lfbw
        EXCEPTIONS
  ...
  METHOD get_leis_fiscais.
    ...
    IF lv_matnr IS INITIAL.
      READ TABLE me->itens   INTO DATA(_itens)   INDEX 1.
      lv_matnr = _itens-matnr.
    ENDIF.

    IF me->pedidos IS NOT INITIAL.
      READ TABLE me->pedidos INTO DATA(_pedidos) WITH KEY matnr = lv_matnr.
      SELECT SINGLE bsart
        INTO @DATA(_bsart)
        FROM ekko
       WHERE ebeln EQ @_pedidos-ebeln.
    ELSEIF me->itens[] IS NOT INITIAL.
      READ TABLE me->itens   INTO      _itens    WITH KEY matnr = lv_matnr.
      SELECT SINGLE bsart
        INTO @_bsart
        FROM ekko
       WHERE ebeln EQ @_itens-ebeln.
    ENDIF.

    lv_erro = COND #( WHEN sy-subrc = 0 THEN abap_off ELSE abap_true ).

    SELECT SINGLE regio
      INTO @DATA(_regio_toma)
      FROM t001w
     WHERE werks = @me->nota-f_tomadora.
    ...
    IF me->nota-f_armazem IS INITIAL.
      SELECT SINGLE regio
        ...
        FROM lfa1
       WHERE lifnr = @me->nota-p_emissor.
    ELSE.
      SELECT SINGLE regio
        INTO @_regio_armz
        FROM lfa1
       WHERE lifnr = @me->nota-f_armazem.
    ENDIF.
    ...
    IF lv_erro = abap_true.
      RAISE EXCEPTION TYPE zcx_nfe_inbound_exception
        EXPORTING
          textid = VALUE #( msgid = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
                            msgno = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
                            attr1 = CONV #( 'Leis fiscais não encontradas! (ZMM0185)' ) )
          msgid  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgid
          msgno  = zcx_nfe_inbound_exception=>zcx_erro_geral-msgno
          msgv1  = CONV #( 'Leis fiscais não encontradas! (ZMM0185)' )
          msgty  = 'E'.
    ENDIF.

    lv_bsart = _bsart.
    lv_icms  = COND #( WHEN me->nota-vl_icms_total IS NOT INITIAL THEN abap_true ELSE abap_false ).
...
*    ENDIF.
    ...
    lc_dados-uf_orig-valor = _regio_armz.
    lc_dados-uf_dest-valor = _regio_toma.
    lc_dados-matnr-valor   = lv_matnr.
    lc_dados-bukrs-valor   = me->nota-e_tomadora.
    lc_dados-icms-valor    = lv_icms.
    lc_dados-direcao-valor = '1'. "entrada

    lc_retorno = zcl_leis_fiscais=>get_impostos( i_dados = lc_dados i_todos = abap_false ).


    READ TABLE lc_retorno INTO r_zmmt0154 INDEX 1.
*-US191846-01.10.2025-#191846-JT-fim
    ...
    IF sy-subrc <> 0.
      ...
      lva_msg_error = |Não encontrado parametros com IVA na ZMM0185 para o tipo Pedido: { lv_bsart } Origem: { _regio_armz }|.
      lva_msg_error = |{ lva_msg_error } Destino: { _regio_toma } Material: { lv_matnr } Empresa: { me->nota-e_tomadora } ICMS: { lv_icms } Direção: Entrada!|.
...
*          msgty  = 'E'.
    ...
    zcl_miro=>get_taxas_icms(
      EXPORTING
        i_data      = CONV #( sy-datum )
        i_shipfrom  = CONV #( _regio_armz )
        i_shipto    = CONV #( _regio_toma )
        i_matnr     = CONV #( lv_matnr )
        i_werks     = CONV #( me->nota-f_tomadora )
        i_lifnr     = CONV #( me->nota-p_emissor )
      IMPORTING
        e_lei_fiscal_icms = DATA(lva_lei_fiscal_icms) ).

    IF lva_lei_fiscal_icms IS NOT INITIAL.
      r_zmmt0154-j_1btaxlw1 = lva_lei_fiscal_icms.
    ENDIF.
