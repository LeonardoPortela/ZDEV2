...
* Adding Tables PAT03, TVIMF, USH04, USR04, USH02, CDHDR, CDPOS,SAPWLSERV, AGR_TEXTS, TBTCO, RSAUPROF, E070, E071 , SSM_CIDT and TPALOG*
...
*  ENDIF.
  ...
  FROM TDDAT
  INTO TABLE IT_TDDAT
  WHERE ( TABNAME LIKE 'Z%' OR TABNAME LIKE 'Y%' OR TABNAME = 'T000' )
  .
  LV_FILE = 'TDDAT.ACTT'.
  LS_TABLE = 'TABNAME'.
...
*#ACTTSAP12.0 Release 12.0 Changes End*
  ...
  APPEND LS_TABLE TO LT_TABLE .
  CLEAR LS_TABLE.
  CONCATENATE 'Extract Script Version' '|^|' '12.1' INTO LS_TABLE .
  APPEND LS_TABLE TO LT_TABLE .
  CLEAR LS_TABLE.
...
USING LV_FILE TYPE STRING .
  ...
  ELSE.
    LV_DATASET = LV_FILE .
    OPEN DATASET LV_DATASET FOR OUTPUT IN TEXT MODE ENCODING UTF-8 .
...
LS_TABLE   TYPE STRING.
  ...
  DATA: LV_FIELDCHECK TYPE STRING .
