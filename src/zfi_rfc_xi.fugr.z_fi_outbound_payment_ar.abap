FUNCTION z_fi_outbound_payment_ar .
*"--------------------------------------------------------------------
*"*"Interface local:
*"  TABLES
...
*--> 20.09.2023 15:14:12 - Migração S4 – ML - Início
  DATA: cl_proxy TYPE REF TO zco_z_fi_outbound_payment_ar_p,
        v_input	 TYPE zzfi_outbound_payment_ar_inp1,
        "v_output TYPE zzfi_outbound_payment_ar_out1,
  ...
  TRY.
      ...
      CALL METHOD cl_proxy->z_fi_outbound_payment_ar
        EXPORTING
          input  = v_input.
        "IMPORTING
          "output = v_output.
  ...
  ENDTRY.
*<-- 20.09.2023 15:14:12 - Migração S4 – ML – Fim
