class ZCL_INT_IB_CONS_PROC_PED_GRAOS definition
  public
  final
  create public .
...
public section.
  ...
  data:
    ...
    begin of zde_data_response,
              PROC_PEDIDOS         TYPE TABLE OF ZMMT_PO_ZGR,
         end of zde_data_response .

  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '131' ##NO_TEXT.
...
CLASS ZCL_INT_IB_CONS_PROC_PED_GRAOS IMPLEMENTATION.
...
*
  ...
  METHOD ZIF_INTEGRACAO_INJECT~SET_INTEGRAR_INBOUND.
    ...
    DATA:
      lra_FILTRO1 TYPE RANGE OF AWKEY,
      lra_FILTRO2 TYPE RANGE OF EBELN.
    ...
    LOOP AT lwa_data_request-ebeln INTO DATA(wa_filtro2).
    ...
    IF lwa_data_request IS NOT INITIAL.
        ...
        SELECT *
        FROM ZMMT_PO_ZGR
        INTO TABLE lwa_data_response-proc_pedidos
        WHERE obj_key IN lra_filtro1 AND
              ebeln   IN lra_filtro2.
