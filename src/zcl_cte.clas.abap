  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS SET_ANULAR_CTE_SAIDA
      IMPORTING
        ...
        !I_ANULAR TYPE ZDE_ANULADO_CTE DEFAULT 'X' .

    METHODS ZIF_DOC_ELETRONICO~GET_CK_ESTORNO_MDFE_POSSIVEL
        REDEFINITION .
    ...
    METHODS ZIF_DOC_ELETRONICO~GET_VAL_REINICIALIZAR_MODAL
        REDEFINITION .
    METHODS ZIF_DOC_ELETRONICO~SET_AUTORIZA_MDFE
        REDEFINITION .
    METHODS ZIF_DOC_ELETRONICO~SET_AUTORIZA_VIAGEM_TIP_FRETE
        REDEFINITION .
...
CLASS ZCL_CTE IMPLEMENTATION.


  METHOD SET_ANULAR_CTE_SAIDA.

    "DATA: IT_ZLEST0061 TYPE TABLE OF ZLEST0061.
    DATA: IT_ZLEST0060 TYPE TABLE OF ZLEST0060.
    DATA: IT_ZLEST0060_OTHERS TYPE TABLE OF ZLEST0060.
    "DATA: IT_ZLEST0056 TYPE TABLE OF ZLEST0056.
    "DATA: IT_ZLEST0073 TYPE TABLE OF ZLEST0073.
    DATA: IT_ZSDT0001  TYPE TABLE OF ZSDT0001.
    "DATA: LC_SINAL TYPE I.


    DELETE FROM ZLEST0061 WHERE DOCNUM EQ I_DOCNUM.
...
*    ENDCASE.
    ...
    LOOP AT IT_ZLEST0060 INTO DATA(WA_60).
      ...
      SELECT SINGLE * FROM ZLEST0104 INTO @DATA(WL_ZLEST0104) WHERE EMISSOR EQ @WA_60-WERKS.
...
*      ENDIF.
    ...
    "MODIFY ZLEST0061 FROM TABLE IT_ZLEST0061.
    "MODIFY ZLEST0073 FROM TABLE IT_ZLEST0073.
    MODIFY ZSDT0001  FROM TABLE IT_ZSDT0001.
  ...
  METHOD ZIF_DOC_ELETRONICO~GET_CK_ESTORNO_MDFE_POSSIVEL.
    ...
    R_INSTANCIA = SUPER->ZIF_DOC_ELETRONICO~GET_CK_ESTORNO_MDFE_POSSIVEL(
                      )->GET_CK_VERIFICA_MODAL( I_MODAL = ME->ZIF_DOC_ELETRONICO~AT_ST_MODEL_CTE
                      ).
    ...
    SELECT *
     ...
     WHERE DOCNUM_REF NE 0
       ...
       AND DOCNUM     EQ @ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM.
    ...
    IF WA_ZSDT0102 IS NOT INITIAL.
      ...
      CALL FUNCTION 'Z_FUSO_HORARIO_FILIAL'
        EXPORTING
          I_BUKRS  = ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-BUKRS
          I_BRANCH = ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-BRANCH
        IMPORTING
          E_TIME   = E_TIME.
      ...
      IF LC_DATEDIFF IS NOT INITIAL OR LC_TIMEDIFF GE 24.
        RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
          EXPORTING
            TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_MDFE_AUTORIZADA_24HRS-MSGID
                              MSGNO = ZCX_DOC_ELETRONICO=>ZCX_MDFE_AUTORIZADA_24HRS-MSGNO )
            MSGID  = ZCX_DOC_ELETRONICO=>ZCX_MDFE_AUTORIZADA_24HRS-MSGID
            MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_MDFE_AUTORIZADA_24HRS-MSGNO
            MSGTY  = 'E'.
      ENDIF.
      """"""""""""""""""""""""""""""""""""""""""""""""""""""""""
  ...
  METHOD ZIF_DOC_ELETRONICO~GET_URLS_DOCS.
    ...
    TRY .
        ...
        IF I_ID_CCE IS NOT INITIAL.
          E_LINK_PDF = WA_DOMINIO && '/getccectepdf?' && 'sap-client=' && SY-MANDT && '&i_docnum=' && ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM && '&i_id_cce=' && I_ID_CCE.
        ELSE.
...
*        ENDIF.
  ...
  METHOD ZIF_DOC_ELETRONICO~GET_VAL_AUTORIZACAO_MODAL.
    ...
    DATA: LC_TP_FORNE   TYPE ZTP_FORNECIMENTO,
          LC_BUKRS      TYPE BUKRS,
    ...
    ZCL_REPOM_VIAGEM_VPR=>VERIFICA_CUSTO_VI(
      EXPORTING
        I_DOCNUM_CTE      = ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM
      EXCEPTIONS
        CUSTO_VI          = 1
        OTHERS            = 2
    ).
    ...
    CALL FUNCTION 'Z_SD_NFES_DA_CTE'
      EXPORTING
        MP_DOCNUM     = ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM
      TABLES
    ...
    IF LC_TP_FORNE NE 'A'.
      ...
      LOOP AT IT_NFE_ACTIVE INTO DATA(WA_NFE_ACTIVE).
        ...
        ZCL_NFE=>ZIF_DOC_ELETRONICO~GET_INSTANCE( I_DOCNUM = WA_NFE_ACTIVE-DOCNUM
    ...
    IF NOT WA_CTE_VTTK IS INITIAL.
      IF WA_CTE_VTTK-STDIS IS INITIAL.
        ...
        RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
          EXPORTING
            TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_ORGANIZACAO-MSGID MSGNO = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_ORGANIZACAO-MSGNO ATTR1 = CONV #( WA_CTE_VTTK-TKNUM ) )
            MSGID  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_ORGANIZACAO-MSGID
            MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_ORGANIZACAO-MSGNO
      ...
      ELSEIF WA_CTE_VTTK-STREG IS INITIAL.
        ...
        RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
          EXPORTING
            TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_REGISTRO-MSGID MSGNO = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_REGISTRO-MSGNO ATTR1 = CONV #( WA_CTE_VTTK-TKNUM ) )
            MSGID  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_REGISTRO-MSGID
            MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_REGISTRO-MSGNO
            MSGV1  = CONV #( WA_CTE_VTTK-TKNUM )
            MSGTY  = 'E'.
      ...
      ELSEIF WA_CTE_VTTK-STLBG IS INITIAL.
        ...
        RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
          EXPORTING
            TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_INICIO_CARREG-MSGID MSGNO = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_INICIO_CARREG-MSGNO ATTR1 = CONV #( WA_CTE_VTTK-TKNUM ) )
            MSGID  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_INICIO_CARREG-MSGID
            MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_INICIO_CARREG-MSGNO
            MSGV1  = CONV #( WA_CTE_VTTK-TKNUM )
            MSGTY  = 'E'.
      ...
      ELSEIF WA_CTE_VTTK-STLAD IS INITIAL.
        ...
        RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
          EXPORTING
            TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_FIM_CARREG-MSGID MSGNO = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_FIM_CARREG-MSGNO ATTR1 = CONV #( WA_CTE_VTTK-TKNUM ) )
            MSGID  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_FIM_CARREG-MSGID
            MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_FIM_CARREG-MSGNO
            MSGV1  = CONV #( WA_CTE_VTTK-TKNUM )
            MSGTY  = 'E'.
      ...
      ELSEIF WA_CTE_VTTK-STABF IS INITIAL.
        ...
        RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
          EXPORTING
            TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_PROCMTO-MSGID MSGNO = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_PROCMTO-MSGNO ATTR1 = CONV #( WA_CTE_VTTK-TKNUM ) )
            MSGID  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_PROCMTO-MSGID
            MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_PROCMTO-MSGNO
            MSGV1  = CONV #( WA_CTE_VTTK-TKNUM )
            MSGTY  = 'E'.
      ...
      ELSEIF WA_CTE_VTTK-STTBG IS INITIAL.
        ...
        RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
          EXPORTING
            TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_INICIO_TRANSPORTE-MSGID MSGNO = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_INICIO_TRANSPORTE-MSGNO ATTR1 = CONV #( WA_CTE_VTTK-TKNUM ) )
            MSGID  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_INICIO_TRANSPORTE-MSGID
            MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_VT_SEM_INICIO_TRANSPORTE-MSGNO
            MSGV1  = CONV #( WA_CTE_VTTK-TKNUM )
            MSGTY  = 'E'.
    ...
    CASE ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCTYP.
      WHEN '1'.
      ...
      WHEN '2'.
        ...
        SELECT SINGLE * INTO WA_ZLEST0061
          FROM ZLEST0061
         WHERE DOCNUM EQ ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCREF.
    ENDCASE.

    IF NOT ( ( WA_ZLEST0061 IS NOT INITIAL ) OR
             ( WA_ZLEST0061 IS INITIAL  AND
               ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCREF IS NOT INITIAL AND
               ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCTYP = '2'    ) ).
      ...
      IF LC_EMITE_CIOT EQ ABAP_TRUE.
        ...
        CALL FUNCTION 'Z_SD_INFO_CTE_CIOT'
          EXPORTING
            P_CTE_AVULSO = ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM
          TABLES
        ...
        IF SY-SUBRC IS NOT INITIAL.
          ...
          ME->ZIF_DOC_ELETRONICO~SET_ALTERA_STATUS( I_TP_AUTHCOD = '1'
           )->GET_ERRO_GERAL( ).
        ENDIF.
  ...
  METHOD ZIF_DOC_ELETRONICO~GET_VAL_CANCELAMENTO_MODAL.
    ...
    LC_DATE1 = ME->ZIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-ACTION_DATE.
    LC_TIME1 = ME->ZIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-ACTION_TIME.
    ...
    IF LC_DATEDIFF GE 1 OR LC_TIMEDIFF GE 1.
      RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
        EXPORTING
          TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_CTE_CANCEL_EXPIROU-MSGID
                            MSGNO = ZCX_DOC_ELETRONICO=>ZCX_CTE_CANCEL_EXPIROU-MSGNO )
          MSGID  = ZCX_DOC_ELETRONICO=>ZCX_CTE_CANCEL_EXPIROU-MSGID
          MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_CTE_CANCEL_EXPIROU-MSGNO
          MSGTY  = 'E'.
    ENDIF.
  ...
  METHOD ZIF_DOC_ELETRONICO~SET_AUTORIZA_MDFE.
    ...
    R_INSTANCIA = SUPER->ZIF_DOC_ELETRONICO~SET_AUTORIZA_MDFE( I_ACAO = I_ACAO ).

    CASE I_ACAO.
      WHEN ZIF_DOC_ELETRONICO=>AT_ACAO_MDFE_AUTORIZA.
        ...
        TRY .
            ...
            ELSE.
              ...
              ENDIF.
              ZCL_MDFE->ADD_DOCUMENTO( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ).
...
*                TRY.
*                    DATA(MDFE) = ZCL_MDFE_=>ZIF_DOC_ELETRONICO~GET_INSTANCE( I_DOCNUM = VL_DOCNUM_MDFE
...
*                ENDTRY.
            ...
            ELSE.
              IF WA_ZSDT0102-STATUS EQ '3'.
                ...
                ME->ZIF_DOC_ELETRONICO~GET_ERRO_GERAL_STRING( I_TEXTO = CONV #( WA_ZSDT0102-MSG ) ).
              ELSE.
          ...
          CATCH ZCX_MDFE INTO DATA(EX_MDFE).
            ME->ZIF_DOC_ELETRONICO~GET_ERRO_GERAL_STRING( I_TEXTO = EX_MDFE->GET_LONGTEXT( ) ).
        ENDTRY.

      WHEN ZIF_DOC_ELETRONICO=>AT_ACAO_MDFE_CANCELAR.
        ...
        WAIT UP TO 5 SECONDS.
        LC_CICLOS = ME->ZIF_DOC_ELETRONICO~AT_QTD_CICLOS.
        ...
        IF NOT (
          ...
          ELSE.
            RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
              EXPORTING
                TEXTID = VALUE #( MSGID = ZCX_DOC_ELETRONICO=>ZCX_MDFE_NAO_CANCELADA-MSGID
                                  MSGNO = ZCX_DOC_ELETRONICO=>ZCX_MDFE_NAO_CANCELADA-MSGNO
                                  ATTR1 = CONV #( WA_ZSDT0102-NMDFE ) )
                MSGID  = ZCX_DOC_ELETRONICO=>ZCX_MDFE_NAO_CANCELADA-MSGID
                MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_MDFE_NAO_CANCELADA-MSGNO
  ...
  METHOD ZIF_DOC_ELETRONICO~SET_AUTORIZA_VIAGEM_TIP_FRETE.
    ...
    DATA: P_PROTOCOLO TYPE ZPROTOCOLO.

    R_INSTANCIA = SUPER->ZIF_DOC_ELETRONICO~SET_AUTORIZA_VIAGEM_TIP_FRETE( ).
...
*AT_ACAO_VIAGEM_FRETE_CANCELAR  Constant  Type  CHAR01  Can. Viagem TipFrete  '3'
    ...
    CASE I_ACAO.
      WHEN ZIF_DOC_ELETRONICO=>AT_ACAO_VIAGEM_FRETE_CRIAR.
        ...
        IF WA_ZCTE_CIOT-ST_CIOT NE ZCL_CIOT=>C_2 AND WA_ZCTE_CIOT-ST_CIOT NE ZCL_CIOT=>C_9.
          RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
            EXPORTING
              TEXTID = VALUE #( MSGID  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_VIAGEM-MSGID
                                MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_VIAGEM-MSGNO
                                ATTR1  = CONV #( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ) )
              MSGTY  = 'E'
              MSGID  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_VIAGEM-MSGID
              MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_VIAGEM-MSGNO
              MSGV1  = CONV #( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ).
        ENDIF.

      WHEN ZIF_DOC_ELETRONICO=>AT_ACAO_VIAGEM_FRETE_AUTORIZAR.
        ...
        IF WA_ZCTE_CIOT-ST_CIOT NE ZCL_CIOT=>C_5 AND WA_ZCTE_CIOT-ST_CIOT NE ZCL_CIOT=>C_9.
          ...
          IF WA_ZCTE_CIOT-ST_CIOT NE ZCL_CIOT=>C_5.
            RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
              EXPORTING
                TEXTID = VALUE #( MSGID  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_CREDIDATO-MSGID
                                  MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_CREDIDATO-MSGNO
                                  ATTR1  = CONV #( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ) )
                MSGTY  = 'E'
                MSGID  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_CREDIDATO-MSGID
                MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_CREDIDATO-MSGNO
                MSGV1  = CONV #( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ).
          ENDIF.
      ...
      WHEN ZIF_DOC_ELETRONICO=>AT_ACAO_VIAGEM_FRETE_CANCELAR.
        ...
        IF SY-SUBRC IS NOT INITIAL.
          RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
            EXPORTING
              TEXTID = VALUE #( MSGID  = ZCX_DOC_ELETRONICO=>ZCX_SEM_MOTIVO_CANCEL-MSGID
                                MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_SEM_MOTIVO_CANCEL-MSGNO
                                ATTR1  = CONV #( I_MOTIVO_CANCEL ) )
              MSGTY  = 'E'
              MSGID  = ZCX_DOC_ELETRONICO=>ZCX_SEM_MOTIVO_CANCEL-MSGID
              MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_SEM_MOTIVO_CANCEL-MSGNO
        ...
        IF WA_ZCTE_CIOT-ST_CIOT NE ZCL_CIOT=>C_8 AND
          ...
          IF SY-SUBRC IS NOT INITIAL.
            RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
              EXPORTING
                TEXTID = VALUE #( MSGID  = ZCX_DOC_ELETRONICO=>ZCX_CTE_SEM_ZCTE_IDENTIFICA-MSGID
                                  MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_CTE_SEM_ZCTE_IDENTIFICA-MSGNO
                                  ATTR1  = CONV #( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ) )
                MSGTY  = 'E'
                MSGID  = ZCX_DOC_ELETRONICO=>ZCX_CTE_SEM_ZCTE_IDENTIFICA-MSGID
                MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_CTE_SEM_ZCTE_IDENTIFICA-MSGNO
                MSGV1  = CONV #( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ).
          ENDIF.
        ...
        IF WA_ZCTE_CIOT-ST_CIOT NE ZCL_CIOT=>C_8 AND
          ...
          RAISE EXCEPTION TYPE ZCX_DOC_ELETRONICO
            EXPORTING
              TEXTID = VALUE #( MSGID  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_CANCELADO-MSGID
                                MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_CANCELADO-MSGNO
                                ATTR1  = CONV #( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ) )
              MSGTY  = 'E'
              MSGID  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_CANCELADO-MSGID
              MSGNO  = ZCX_DOC_ELETRONICO=>ZCX_SEM_CONTRATO_CANCELADO-MSGNO
              MSGV1  = CONV #( ME->ZIF_DOC_ELETRONICO~AT_DOCUMENTO-DOCNUM ).
        ENDIF.
