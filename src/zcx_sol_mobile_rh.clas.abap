class ZCX_SOL_MOBILE_RH definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_ERRO_GERAL,
      msgid type symsgid value 'ZHCMSOLMOBI',
  ...
  constants:
    begin of ZCX_SEM_MATRICULA,
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_MATRICULA .
  constants:
    begin of ZCX_SEM_MOTIVO,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_MOTIVO .
  constants:
    begin of ZCX_SEM_SENHA,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_SENHA .
  constants:
    begin of ZCX_ERRO_LOGIN,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_ERRO_LOGIN .
  constants:
    begin of ZCX_ERRO_LOGIN_BLOQUEIO,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_ERRO_LOGIN_BLOQUEIO .
  constants:
    begin of ZCX_TOKEN_INVALIDO,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_TOKEN_INVALIDO .
  constants:
    begin of ZCX_CPF_NAO_ENCONTRADO,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_CPF_NAO_ENCONTRADO .
  constants:
    begin of ZCX_MATRICULA_NAO_ENCONTRADO,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_MATRICULA_NAO_ENCONTRADO .
  constants:
    begin of ZCX_DISPOSITIVO_NAO_AUTORIZADO,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_DISPOSITIVO_NAO_AUTORIZADO .
  constants:
    begin of ZCX_DISPOSITIVO_CPF_CADASTRADO,
      msgid type symsgid value 'ZHCMSOLMOBI',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_DISPOSITIVO_CPF_CADASTRADO .
...
CLASS ZCX_SOL_MOBILE_RH IMPLEMENTATION.
