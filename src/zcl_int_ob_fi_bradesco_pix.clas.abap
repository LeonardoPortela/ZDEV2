...
*--------------------------------------------------------------------------------------------------------*
class ZCL_INT_OB_FI_BRADESCO_PIX definition
  public
  final
  create public .
...
* Busca Fatura Energia - Faturamento/Pagamento
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '304' ##NO_TEXT.
  constants:
    LC_SERVICO       TYPE C LENGTH 20 value 'BBD_SET_PIX' ##NO_TEXT.
  constants:
  ...
  constants LC_FIELD type DDOBJNAME value 'ZDE_IN_BBD_PIX' ##NO_TEXT.
  data AT_PARAMS type ZDE_IN_BBD_PIX .
  data AT_BODY type ZDE_IN_BBD_PIX .
...
CLASS ZCL_INT_OB_FI_BRADESCO_PIX IMPLEMENTATION.
  ...
  METHOD zif_integracao_outbound~get_instance.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_fi_bradesco_pix.
    ENDIF.
