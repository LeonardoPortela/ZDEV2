...
selection-screen: begin of block b2 with frame title text-002.
  parameter: p_ZFAR  type j_1bnfdoc-cancel,
             p_ZFER  type j_1bnfdoc-cancel.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
 ...
 ( fieldname = 'KNUMV' value = WA_REMESSA-KNUMV )
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL298C6R7732) ).
  CLEAR T_KONV.
  TYPES: BEGIN OF TYL298C6R5310,
    KNUMV TYPE KONV-KNUMV,
    KWERT TYPE KONV-KWERT,
    KBETR TYPE KONV-KBETR,
    KSCHL TYPE KONV-KSCHL,
  END OF TYL298C6R5310.
  DATA: LML298C6R1218 TYPE TYL298C6R5310,
        LWL298C6R1188 LIKE LINE OF T_KONV.
  LOOP AT ETL298C6R7732 REFERENCE INTO DATA(LDRL298C6R7119).
    LML298C6R1218-KNUMV = LDRL298C6R7119->KNUMV.
    LML298C6R1218-KWERT = LDRL298C6R7119->KWERT.
    LML298C6R1218-KBETR = LDRL298C6R7119->KBETR.
    LML298C6R1218-KSCHL = LDRL298C6R7119->KSCHL.
    LWL298C6R1188 = LML298C6R1218.
    APPEND LWL298C6R1188 TO T_KONV.
  ENDLOOP.
CATCH CX_PRC_RESULT .
  SY-SUBRC = 4.
ENDTRY.
      ...
      if p_ZFAR   eq 'X' .
        delete t_konv where kschl ne 'ZFAR'.
      ELSEIF p_ZFER   eq 'X' .
        delete t_konv where kschl ne 'ZFER'.
      ENDIF.
