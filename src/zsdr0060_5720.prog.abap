  ...
  METHOD on_double_click_5720.
    ...
    LOOP AT it_sol_5720 INTO wa_sol_5720.
      ...
      IF sy-subrc IS INITIAL.
        ...
        IF wa_sol_5720-meins = 'BIG'.
           wa_sol_5720-meins = 'BAG'.
        ENDIF.
...
*-CS2019001891 - JT - 04.02.2021 - fim
  ...
  LOOP AT it_carga_5720 INTO wa_carga_5720.
    ...
    IF wa_carga_5720-status EQ 0.
      ...
      wa_carga_5720-desc_status_icone = 'Lote não Aprovado'. " User Story 153510 // MMSILVA
    ELSEIF wa_carga_5720-status EQ 1.
      wa_carga_5720-icone = '@5B@'.
      wa_carga_5720-desc_status_icone = 'Lote Aprovado'. " User Story 153510 // MMSILVA
    ELSEIF wa_carga_5720-status EQ 2.
      wa_carga_5720-icone = '@0Q@'.
      wa_carga_5720-desc_status_icone = 'Romaneio Gerado'. " User Story 153510 // MMSILVA
    ENDIF.
    ...
    SELECT SINGLE nro_nf_prod FROM zsdt0001 WHERE vbeln EQ @wa_zsdt0140-vbeln AND nro_cg EQ @wa_zsdt0140-nro_cgd INTO @DATA(wa_zsdt0001).
    ...
    IF sy-subrc IS INITIAL.
      ...
      IF sy-subrc IS INITIAL.
        IF ( wa_j_1bnfe_active EQ '1').
          ...
          wa_carga_5720-icone = '@5Y@'.
          wa_carga_5720-desc_status_icone = 'Nota Fiscal Autorizada'.
        ENDIF.
      ENDIF.
    ENDIF.
...
*-CS2019001891 - JT - 04.02.2021 - fim
          ...
          15 'DESC_STATUS_ICONE'   ''          ' '  ' '  ' '  ' '   ''    ' '   ' '   ' '   'Desc. Status Icone'. " User Story 153510 // MMSILVA
