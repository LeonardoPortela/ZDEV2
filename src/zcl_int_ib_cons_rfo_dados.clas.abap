class ZCL_INT_IB_CONS_RFO_DADOS definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '179' ##NO_TEXT.
...
CLASS ZCL_INT_IB_CONS_RFO_DADOS IMPLEMENTATION.
...
*    ENDIF.
  ...
  METHOD zif_integracao_inject~set_integrar_inbound.
    ...
    DATA: lwa_data_request  TYPE zde_rfo_par.
    ...
    "DATA(lra_pernr) = VALUE lr_pernr_type( sign = 'I' option = 'EQ' ( low = lwa_data_request-pernr ) ).
    ...
    IF  lit_return  IS NOT INITIAL.
      ...
      e_nm_code   = '200'.
      e_msg_erro  = 'Ok'.
      e_msg_outbound = /ui2/cl_json=>serialize( EXPORTING data = lit_return ).
    ELSE.
      e_sucesso   = abap_false.
      e_nm_code   = '400'.
