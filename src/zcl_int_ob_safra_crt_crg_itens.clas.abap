class ZCL_INT_OB_SAFRA_CRT_CRG_ITENS definition
  public
  final
  create public .
...
public section.
  ...
  constants:
    lc_servico TYPE c LENGTH 19 value 'CARGA_SAFRA_CONTROL_ITENS' ##NO_TEXT.
  constants:
  ...
  data AT_BODY_POST type ZSDS393 .
  data AT_BODY_DEL type ZSDS394 .
...
CLASS ZCL_INT_OB_SAFRA_CRT_CRG_ITENS IMPLEMENTATION.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~BUILD_INFO_REQUEST.
    ...
    CASE at_metodo_http.
      WHEN zif_integracao_inject=>co_request_method_post.
        MOVE-CORRESPONDING i_info_request TO at_body_post.
      WHEN zif_integracao_inject=>co_request_method_delete.
        MOVE-CORRESPONDING i_info_request TO at_body_del.
    ENDCASE.
  ...
  METHOD zif_integracao_outbound~get_data.
    ...
    DATA: lwa_body_post TYPE zsds395.
    DATA: lwa_body_del  TYPE zsds396.
    ...
    CASE at_metodo_http.
      WHEN zif_integracao_inject=>co_request_method_post.
        ...
        CLEAR: lwa_body_post.
        lwa_body_post-items = me->at_body_post-itens.
      ...
      WHEN zif_integracao_inject=>co_request_method_delete.
        ...
        CLEAR: lwa_body_del.
        lwa_body_del-order_items = me->at_body_del-order_items.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~SET_URL.
    ...
    SELECT SINGLE *
      ...
      WHERE service EQ 'CARGA_SAFRA_CONTROL_ITENS'.
    ...
    REPLACE ALL OCCURRENCES OF '{idInc}' in v_url WITH lv_externalid.
    ...
    APPEND VALUE #( name = lc_authorization value = |Bearer { lwa_webservice-token }| ) TO me->zif_integracao_inject~at_header_fields.
