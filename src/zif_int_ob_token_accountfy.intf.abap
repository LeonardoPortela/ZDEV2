interface ZIF_INT_OB_TOKEN_ACCOUNTFY
  public .


  class-data AT_IF_TOKEN_CLIENTE type ref to ZIF_INT_OB_TOKEN_ACCOUNTFY .
  ...
  class-methods GET_INSTANCE
    ...
    returning
      value(R_IF_INT_OB_TOKEN_ACCOUNTFY) type ref to ZIF_INT_OB_TOKEN_ACCOUNTFY
    raising
      ZCX_INTEGRACAO .
