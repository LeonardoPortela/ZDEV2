interface ZIF_ENVIA_EQUIP_MOBMAN
  public .


  class-data AT_ENVIA_EQUIP_MOBMAN type ref to ZCL_ENVIA_EQUIP_MOBMAN .
  ...
  class-data AT_EQUIP type ZTPM_T_EQUIP .

  class-methods GET_INSTANCE
    returning
      value(R_IF_ENVIA_EQUIP_MOBMA) type ref to ZIF_ENVIA_EQUIP_MOBMAN
    raising
      ZCX_INTEGRACAO .
  methods SET_DS_URL
    returning
  ...
  methods SET_DS_URL_PUT
    returning
      value(R_IF_INTEGRACAO_COMB) type ref to ZIF_INTEGRACAO_COMB .
  methods POST_ENVIA_EQUIP
    importing
      !I_EQUIP type ZTPM_T_EQUIP
    exporting
      !E_ID_INTEGRACAO type ZDE_ID_INTEGRACAO
      !E_INTEGRACAO type ZINTEGRACAO
      !E_DATA type STRING
  ...
  methods SET_DADOS_EQUIP
    importing
      !I_DATA type ZTPM_T_EQUIP
    returning
      value(R_IF_ENVIA_EQUIP_MOBMA) type ref to ZIF_ENVIA_EQUIP_MOBMAN .
endinterface.
