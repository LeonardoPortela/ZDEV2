...
************************************************************************
REPORT zfiy0014  NO STANDARD PAGE HEADING
                 LINE-SIZE  215
                 LINE-COUNT 65
                 MESSAGE-ID 8a.
...
INCLUDE ZFIY0014_2_TOP.
*INCLUDE zfiy0014_top.
INCLUDE ZFIY0014_2_SCR.
*INCLUDE zfiy0014_scr.
INCLUDE ZFIY0014_2_FRM.
...
**Note 1064177 Ends
  ...
  DELETE gt_item   WHERE belnr EQ ' '.
  DELETE gt_header WHERE belnr EQ ' '.
