interface ZIF_INT_OB_TOKEN_ECOMMERCE
  public .


  class-data AT_IF_TOKEN_CLIENTE type ref to ZIF_INT_OB_TOKEN_ECOMMERCE .
  ...
  class-methods GET_INSTANCE
    ...
    returning
      value(R_IF_INT_OB_TOKEN_ECOMMERCE) type ref to ZIF_INT_OB_TOKEN_ECOMMERCE
    raising
      ZCX_INTEGRACAO .
