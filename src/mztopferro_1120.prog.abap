...
FORM FILL_IT_FIELDCATALOG_1120 .
  ...
  CALL FUNCTION 'LVC_FIELDCATALOG_MERGE'
    EXPORTING
      I_STRUCTURE_NAME = 'ZDE_ZLEST0119_ALV'
    CHANGING
  ...
  LOOP AT IT_FIELDCATALOG_1120 ASSIGNING <FS_CAT_1120>.
    ...
    ENDIF.
    IF <FS_CAT_1120>-FIELDNAME EQ 'MATNR'.
      <FS_CAT_1120>-NO_OUT = ABAP_TRUE.
    ENDIF.
    IF <FS_CAT_1120>-FIELDNAME EQ 'MAKTX'.
      <FS_CAT_1120>-NO_OUT = ABAP_TRUE.
    ENDIF.
  ENDLOOP.
...
FORM HANDLE_HOTSPOT_CLICK_1120
  ...
  READ TABLE IT_ZLEST0119_ALV INDEX ROW_ID INTO WA_ZLEST0119_ALV.

  CASE FIELDNAME.
    WHEN 'NR_APOLICE'.
      "Abrir Empresas e Grupos de Mercadoria
      CLEAR: IT_ZLEST0119_SEL[].
      APPEND WA_ZLEST0119_ALV TO IT_ZLEST0119_SEL.
      PERFORM ABRIR.
  ENDCASE.
...
FORM HANDLE_DOUBLE_CLICK_1120  USING P_ROW TYPE LVC_S_ROW.
  ...
  IF P_ROW-ROWTYPE IS INITIAL.
    ...
    READ TABLE IT_ZLEST0119_ALV INDEX P_ROW-INDEX INTO WA_ZLEST0119_ALV.
...
FORM POPULA_SELECAO.
  ...
  LOOP AT IT_SELECTED_ROWS_1120 INTO WA_SELECTED_ROWS_1120.
    READ TABLE IT_ZLEST0119_ALV INTO WA_ZLEST0119_ALV INDEX WA_SELECTED_ROWS_1120-INDEX.
    MOVE-CORRESPONDING WA_ZLEST0119_ALV TO IT_ZLEST0119_SEL.
    APPEND IT_ZLEST0119_SEL.
  ENDLOOP.
