class ZCX_PEDIDO_COMPRA_EXCEPTION definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_PEDIDO_ITEM_NAO_LOC,
    ...
    end of ZCX_PEDIDO_ITEM_NAO_LOC .
  constants:
  ...
  constants:
    begin of ZCX_CENTRO_PORTO,
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_CENTRO_PORTO .
  constants:
    begin of ZCX_DEPOSITO_CENTRO,
      msgid type symsgid value 'ZMMPED',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_DEPOSITO_CENTRO .
  constants:
    begin of ZCX_PEDIDO_NAO_LIBERADO,
      msgid type symsgid value 'ZMMPED',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_PEDIDO_NAO_LIBERADO .
  constants:
...
CLASS ZCX_PEDIDO_COMPRA_EXCEPTION IMPLEMENTATION.
