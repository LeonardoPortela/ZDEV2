class ZCL_INT_OB_KONVIVA_SETORES definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '195' ##NO_TEXT.
...
CLASS ZCL_INT_OB_KONVIVA_SETORES IMPLEMENTATION.
  ...
  METHOD CONSTRUCTOR.
    ...
    me->zif_integracao_inject~at_autentica_module  = 'konviva_setores'.
...
*    ENDIF.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~GET_INSTANCE.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_konviva_setores.
    ENDIF.
  ...
  METHOD zif_integracao_outbound~set_url.
    ...
    CASE lwa_data-metodo.
      WHEN 'GET'.
        CONCATENATE lwa_webservice-url '/action/api/getSetores'     INTO lva_url.
        me->zif_integracao_inject~at_info_request_http-ds_metodo    = 'GET'.
      WHEN 'PUT'.
        CONCATENATE lwa_webservice-url '/action/api/integrarSetor'  INTO lva_url.
