...
TYPES: BEGIN OF TY_SAIDA_0100,
         ...
         ENVIAR_OPUS  TYPE C LENGTH 4,
         ST_ENVIO     TYPE C LENGTH 4.
...
DATA: IT_SAIDA_0100     TYPE TABLE OF TY_SAIDA_0100,
      ...
      WA_SAIDA_0110_AUX TYPE TY_SAIDA_0110,
      TG_MAKT           TYPE TABLE OF TY_MAKT  WITH HEADER LINE,
      TG_0086           TYPE TABLE OF ZMMT0086 WITH HEADER LINE.
