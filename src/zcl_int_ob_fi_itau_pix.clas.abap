...
*--------------------------------------------------------------------------------------------------------*
CLASS ZCL_INT_OB_FI_ITAU_PIX DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
* Busca Fatura Energia - Faturamento/Pagamento
    CONSTANTS AT_ID_INTERFACE TYPE ZDE_ID_INTERFACE VALUE '261' ##NO_TEXT.
    CONSTANTS:
      LC_SERVICO       TYPE C LENGTH 20 VALUE 'ITAU_SET_PIX' ##NO_TEXT.
    CONSTANTS:
    ...
    CONSTANTS:
          LC_FIELD         TYPE DDOBJNAME VALUE 'ZDE_IN_ITAU_PIX' ##NO_TEXT.

    DATA AT_PARAMS TYPE ZDE_IN_ITAU_PIX.
    DATA AT_BODY TYPE ZDE_IN_ITAU_PIX.
...
CLASS ZCL_INT_OB_FI_ITAU_PIX IMPLEMENTATION.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~GET_INSTANCE.
    ...
    IF ZIF_INTEGRACAO_OUTBOUND~AT_IF_INTEGRACAO_OUTBOUND IS NOT BOUND.
      CREATE OBJECT ZIF_INTEGRACAO_OUTBOUND~AT_IF_INTEGRACAO_OUTBOUND TYPE ZCL_INT_OB_FI_ITAU_PIX.
    ENDIF.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~SET_URL.
    ...
    FIELD-SYMBOLS: <FS_CAMPO>  TYPE ANY,
                   <FS_PARAMS> TYPE ZDE_IN_ITAU_PIX.
    ...
    LOOP AT T_DFIES INTO DATA(LS_FIELDS).
      ...
      IF LS_FIELDS-FIELDNAME EQ 'CORRELATIONID'.
        CONTINUE.
      ENDIF.
    ...
    ME->ZIF_INTEGRACAO_INJECT~AT_INFO_REQUEST_HTTP-DS_PROPERTYTYPE_LOGON_POPUP = IF_HTTP_CLIENT=>CO_DISABLED.
