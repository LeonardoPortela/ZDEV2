class ZCL_INT_IB_CONS_USUARIO definition
  public
  final
  create public .
...
public section.
  ...
  data:
    tb_fax TYPE TABLE OF ad_fxnmbr .
  data:
    BEGIN OF z_usuarios,
        bname      TYPE bname,
  ...
  data:
    BEGIN OF zde_data_request,
        fax_number LIKE tb_fax,
      END OF zde_data_request .
  data:
    BEGIN OF zde_data_response,
        usuarios LIKE TABLE OF z_usuarios,
      END OF zde_data_response .
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '150' ##NO_TEXT.
...
CLASS ZCL_INT_IB_CONS_USUARIO IMPLEMENTATION.
...
*-----------------------------------------------------------------------------------------------------------------------*
  ...
  METHOD zif_integracao_inject~set_integrar_inbound.
    ...
    DATA:
      lra_filtro1 TYPE RANGE OF ad_fxnmbr.
    ...
    LOOP AT lwa_data_request-fax_number INTO DATA(wa_filtro1).
    ...
    SELECT a~bname
           a~persnumber
           b~fax_number
      INTO TABLE lwa_data_response-usuarios
      FROM usr21 AS a INNER JOIN adr3 AS b ON a~persnumber = b~persnumber
      WHERE b~fax_number IN lra_filtro1.
