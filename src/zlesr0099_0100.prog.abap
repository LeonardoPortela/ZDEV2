...
*   Fill info for layout variant
    ...
    IF P_BRANCH-HIGH IS INITIAL.
      SELECT SINGLE NAME INTO SDYDO_TEXT_ELEMENT
        FROM J_1BBRANCH
       WHERE BUKRS  EQ P_BUKRS-LOW
         AND BRANCH EQ P_BRANCH-LOW.
    ELSE.
      CONCATENATE P_BRANCH-LOW 'até' P_BRANCH-HIGH INTO SDYDO_TEXT_ELEMENT SEPARATED BY SPACE.
    ENDIF.
    APPEND SDYDO_TEXT_ELEMENT TO P_TEXT_TABLE.

    IF P_DTCREA-HIGH IS INITIAL.
      CONCATENATE P_DTCREA-LOW+6(2) '.' P_DTCREA-LOW+4(2) '.' P_DTCREA-LOW(4) INTO SDYDO_TEXT_ELEMENT.
    ELSE.
      CONCATENATE P_DTCREA-LOW+6(2) '.' P_DTCREA-LOW+4(2) '.' P_DTCREA-LOW(4) INTO SDYDO_TEXT_ELEMENT.
      CONCATENATE SDYDO_TEXT_ELEMENT 'até' INTO SDYDO_TEXT_ELEMENT SEPARATED BY SPACE.
      CONCATENATE SDYDO_TEXT_ELEMENT P_DTCREA-HIGH+6(2) INTO SDYDO_TEXT_ELEMENT SEPARATED BY SPACE.
      CONCATENATE SDYDO_TEXT_ELEMENT '.' P_DTCREA-HIGH+4(2) '.' P_DTCREA-HIGH(4) INTO SDYDO_TEXT_ELEMENT.
    ENDIF.
    APPEND SDYDO_TEXT_ELEMENT TO P_TEXT_TABLE.
...
FORM FILL_IT_FIELDCATALOG .
  ...
  CALL FUNCTION 'LVC_FIELDCATALOG_MERGE'
    EXPORTING
      I_STRUCTURE_NAME = 'ZDE_FLUXO_REMESSA_ALV'
    CHANGING
  ...
  LOOP AT IT_FIELDCATALOG ASSIGNING <FS_CAT>.
    ...
    CASE <FS_CAT>-FIELDNAME.
      WHEN 'XBLNR' OR 'VBTYP' OR 'CH_REFERENCIA' OR 'FKREL' OR 'BWART' OR 'REBEL' OR 'LFBNR' OR 'XBLNR_M' OR 'VBELV' OR 'REFTYP' OR 'REFKEY' OR 'REFITM'.
