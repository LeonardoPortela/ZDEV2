CLASS zcl_int_ob_valida_ov_eudr DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS at_id_interface TYPE zde_id_interface VALUE '234' ##NO_TEXT.
    CONSTANTS:
      lc_servico       TYPE c LENGTH 20 VALUE 'EUDR_VALIDA_DADOS_OV' ##NO_TEXT.
    CONSTANTS:
    ...
    DATA at_params TYPE zstruct_post_valida_ov_eudr .
    DATA at_body TYPE zstruct_post_valida_ov_eudr .
...
CLASS ZCL_INT_OB_VALIDA_OV_EUDR IMPLEMENTATION.
  ...
  METHOD zif_integracao_outbound~get_instance.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_valida_ov_eudr.
    ENDIF.
