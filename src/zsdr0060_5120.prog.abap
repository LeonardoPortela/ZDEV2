...
TYPES: BEGIN OF ty_lote_5120,
         ...
         desc_status_icone2 TYPE icon-name,
         desc_armazem_org   TYPE lfa1-name1.
...
FORM seleciona_lote.
  ...
  IF it_lote_5120 IS NOT INITIAL.
    ...
    SELECT *
      ...
      WHERE lifnr EQ it_lote_5120-motorista OR
            lifnr EQ it_lote_5120-armazem_org." Rubenilson - 03.10.2024 #153771
...
*** Inicio - Rubenilson - 03.10.2024 #153771
          10 'ARMAZEM_ORG'    ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Armazém Origem',
          11 'DESC_ARMAZEM_ORG'    ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Desc. Armazém Origem',
*** Fim - Rubenilson - 03.10.2024 #153771
          12 'PLACA_CAR1'     ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Placa Carreta I',
          13 'PLACA_CAR2'     ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Placa Carreta II',
*-CS2019001891 - JT - 04.02.2021 - inicio
          14 'PLACA_CAR3'     ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Placa Dolly',
*-CS2019001891 - JT - 04.02.2021 - fim
          15 'MOTORISTA'      'ZSDT0129'  ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Cód. Motorista',
          16 'NAME1'          ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Motorista',
          17 'STCD2'          ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'CPF Mot.',
          18 'TELF1'          ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Fone Mot.',
          19 'NAME1_T'        ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Transportadora',
          20 'TELF1_T'        ' '         ' '  ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Fone Transp.',
          21 'DESC_STATUS_ICONE'        ''             ' '  ' '  ' '  ''   ''   ' '   ' '   ' '   'Desc. Status Lote',
          22 'DESC_STATUS_ICONE2'        ''             ' '  ' '  ' '  ''   ''   ' '   ' '   ' '   'Desc. Status Carga'.
...
*** Inicio - Rubenilson - 17.09.24 - #144012
        wa_zsdt0129                 TYPE zsdt0129,
        lv_lines                    TYPE sy-tabix.
*** Fim - Rubenilson - 17.09.24 - #144012
...
*** Inicio - Rubenilson - 17.09.24 - #144012
    SELECT *
      FROM zsdt0129
      INTO TABLE @DATA(lt_zsdt0129)
      FOR ALL ENTRIES IN @it_lote_5120_check
      WHERE nro_lote = @it_lote_5120_check-nro_lote.
    IF sy-subrc IS INITIAL.
      SORT lt_zsdt0129 BY armazem_org.
      DELETE ADJACENT DUPLICATES FROM lt_zsdt0129 COMPARING armazem_org.
      DESCRIBE TABLE lt_zsdt0129 LINES lv_lines.
      IF lv_lines > 1.
        MESSAGE 'Favor selecionar apenas lotes do mesmo Armazém de Origem' TYPE 'S' DISPLAY LIKE 'E'.
        vl_check = abap_true.
      ENDIF.
    ENDIF.
*** Fim - Rubenilson - 17.09.24 - #144012
...
*** Inicio - Rubenilson - 03.10.2024 #153771
    wa_lote_5120-armazem_org = |{ wa_lote_5120-armazem_org ALPHA = IN }|.

    READ TABLE it_lfa1_5120 INTO wa_lfa1 WITH KEY lifnr = wa_lote_5120-armazem_org.
    IF sy-subrc IS INITIAL.
      wa_lote_5120-desc_armazem_org = wa_lfa1-name1.
    ENDIF.
*** Fim - Rubenilson - 03.10.2024 #153771
...
*FF #154797 - inicio
    IF wa_zsdt0133-status EQ 1.
        wa_lote_5120-icone2 = '@9K@'.
        wa_lote_5120-desc_status_icone2 = 'Carga Criada'.
*FF #154797 - fim
    elseif wa_zsdt0133-status EQ 2.
        wa_lote_5120-icone2 = '@5D@'.
        wa_lote_5120-desc_status_icone2 = 'Carga sem Cotação'.
      ELSEIF wa_zsdt0133-status EQ 3.
        wa_lote_5120-icone2 = '@FD@'.
        wa_lote_5120-desc_status_icone2 = 'Carga Cotada'.
      ELSEIF wa_zsdt0133-status EQ 4.
        wa_lote_5120-icone2 = '@4A@'.
        wa_lote_5120-desc_status_icone2 = 'Frete Contratado'.
      ELSEIF wa_zsdt0133-status EQ 5.
        wa_lote_5120-icone2 = '@96@'.
        wa_lote_5120-desc_status_icone2 = 'Embarque Autorizado'.
      ELSEIF wa_zsdt0133-status EQ 6.
        wa_lote_5120-icone2 = '@0Q@'.
        wa_lote_5120-desc_status_icone2 = 'Romaneio Gerado'.
      ENDIF.
* User Story 153510 // MMSILVA
...
* User Story 153510 // MMSILVA
    IF wa_lote_5120-status EQ 0.
      ...
      wa_lote_5120-desc_status_icone = 'Lote não Aprovado'.
    ELSEIF wa_lote_5120-status EQ 1.
      wa_lote_5120-icone = '@5B@'.
      wa_lote_5120-desc_status_icone = 'Lote Aprovado'.
    ELSEIF wa_lote_5120-status EQ 2.
      wa_lote_5120-icone = '@7E@'.
      wa_lote_5120-desc_status_icone = 'Lote em Carga'.
    ELSEIF wa_lote_5120-status EQ 3.
      wa_lote_5120-icone = '@5D@'.
      wa_lote_5120-desc_status_icone = 'Carga sem Cotação'.
...
* User Story 153510 // MMSILVA
    ...
    SELECT SINGLE nro_nf_prod FROM zsdt0001 WHERE vbeln EQ @wa_zsdt0131-vbeln AND nro_cg EQ @wa_lote_5120-nro_cg INTO @DATA(wa_zsdt0001).
    ...
    IF sy-subrc IS INITIAL.
      ...
      IF sy-subrc IS INITIAL.
        IF ( wa_j_1bnfe_active EQ '1').
          ...
          wa_lote_5120-icone = '@5Y@'.
          wa_lote_5120-desc_status_icone = 'Nota Fiscal Autorizada'.
        ENDIF.
      ENDIF.
    ENDIF.
