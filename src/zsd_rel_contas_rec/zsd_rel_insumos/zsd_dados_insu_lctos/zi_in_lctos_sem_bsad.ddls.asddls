@AbapCatalog.sqlViewName: 'ZVLCTOSSEMBSAD'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Lctos ZSFIT0026 sem BSAD'
define view ZI_IN_LCTOS_SEM_BSAD
  as select from    ZI_NORMAL_ZFIT0026 as z26
    left outer join bsad_view          as bsad on bsad.kunnr = z26.kunnr //bsad.bukrs = z26.bukrs
