...
FIELD-SYMBOLS: <fs_it_saida>               TYPE table,
               <fs_wa_saida>               TYPE zsdt0309_out, "any,
               <fs_wa_saida_tmp>           TYPE zsdt0309_out, "any,
               <fs_table>                  TYPE STANDARD TABLE,
               <fs_wa_table>               TYPE zsdt0309, "any
               <fs_wa_registro_manter>     TYPE zsdt0309, "any,
               <fs_wa_registro_manter_tmp> TYPE zsdt0309. "any.

DATA: vg_cond      TYPE rsds_where,
      cond_line    TYPE rsdswhere,
      wa_saida_chg TYPE zsdt0309_out.
