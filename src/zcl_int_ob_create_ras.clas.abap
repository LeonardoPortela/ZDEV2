class ZCL_INT_OB_CREATE_RAS definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '243' ##NO_TEXT.
...
CLASS ZCL_INT_OB_CREATE_RAS IMPLEMENTATION.
...
*    e_referencia-id_referencia = me->at_dados_due-id_due.
  ...
  method ZIF_INTEGRACAO_OUTBOUND~GET_INSTANCE.
    ...
    if zif_integracao_outbound~at_if_integracao_outbound is not bound.
      create object zif_integracao_outbound~at_if_integracao_outbound type zcl_int_ob_create_ras.
    endif.
