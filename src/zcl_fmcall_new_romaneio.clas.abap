class ZCL_FMCALL_NEW_ROMANEIO definition
  public
  create public .
...
*"* public components of class ZCL_FMCALL_NEW_ROMANEIO
...
CLASS ZCL_FMCALL_NEW_ROMANEIO IMPLEMENTATION.
...
*          ).
*
*        WHEN ZCL_FMCALL_BASE=>AT_SERVICO_PROCESSA_COTTON.
*
*          ZCL_INTEGRACAO_COTTON_SAP=>ZIF_INTEGRACAO_COTTON_SAP~GET_INSTANCE(
*             )->SET_DS_DATA( I_INFO = I_INFO
*                             ID_REFERENCIA = ID_REFERENCIA
