...
PARAMETERS: r_cust TYPE idfiar205-fiar205acctp NO-DISPLAY,
            r_vend TYPE idfiar205-fiar205acctp   NO-DISPLAY.
...
PARAMETERS: par_magn LIKE idfiar205-fiar205radio NO-DISPLAY DEFAULT 'X' .
...
* length of hlp_epos2 must be 245
  ...
  END OF hlp_epos2,
   BEGIN OF hlp_epos02,      "print structure for line 2 items  ( ep )
    mwskz(6)         TYPE c,
    rate(8)          TYPE p DECIMALS 2,
    taxed(16)        TYPE p DECIMALS 2,
    not_taxed(16)    TYPE p DECIMALS 2,
    vat(16)          TYPE p DECIMALS 2,
    rnr_vat(16)      TYPE p DECIMALS 2,
    vat_percep(16)   TYPE p DECIMALS 2,
    other_percep(16) TYPE p DECIMALS 2,
    exemption(16)    TYPE p DECIMALS 2,
    exports(16)      TYPE p DECIMALS 2,
    percepnoc(16)    TYPE p DECIMALS 2,
    line_total(16)   TYPE p DECIMALS 2,
    exempt(16)       TYPE p DECIMALS 2, " Exempt reason for magnetic output
    earn_per(16)     TYPE p DECIMALS 2, " Note 645449
  END OF hlp_epos02,
...
DATA: BEGIN OF t_periibb OCCURS 0,
   hkont   TYPE hkont ,
   libro   TYPE zfiy_libro,
   bland   TYPE regio ,
   descrip TYPE zfiy_desc_libro_iva,
   imp     TYPE p DECIMALS 2,
   bezei   TYPE bezei20,
END OF t_periibb.
...
* borrar
      ...
      tipo_doc         TYPE text5,
* borrar
*Inicio 0000402: Subdiarios IVA
      gjahr            TYPE gjahr,
*Fin 0000402: Subdiarios IVA
...
DATA: it_bkpf_aux TYPE TABLE OF ty_bkpf_aux,
