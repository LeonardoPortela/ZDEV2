class ZCL_INT_OB_KONVIVA_CARGOS definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '194' ##NO_TEXT.
...
CLASS ZCL_INT_OB_KONVIVA_CARGOS IMPLEMENTATION.
  ...
  METHOD CONSTRUCTOR.
    ...
    me->zif_integracao_inject~at_autentica_module  = 'konviva_cargos'.
...
*    ENDIF.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~GET_INSTANCE.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_konviva_cargos.
    ENDIF.
  ...
  METHOD zif_integracao_outbound~set_url.
    ...
    CASE lwa_data-metodo.
      WHEN 'GET'.
        CONCATENATE lwa_webservice-url '/action/api/getCargos' lwa_data-cpf   INTO lva_url.
        me->zif_integracao_inject~at_info_request_http-ds_metodo             = 'GET'.
      WHEN 'PUT'.
        CONCATENATE lwa_webservice-url '/action/api/integrarCargo'       INTO lva_url.
