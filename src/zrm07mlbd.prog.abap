...
*---> 11.07.2023 09:36:26 - Migração S4 - DL
...
*     ENDLOOP.
*     IF l_ok = abap_off.
*       DELETE werks INDEX l_tabix.
*     ENDIF.
*   ENDLOOP.
  ENDIF.
*-#131516-15.01.2024-JT-fim
...
*---> 19.07.2023 12:25:54 - Migração S4 - DL
...
*---> 19.07.2023 12:19:53 - Migração S4 - DL
