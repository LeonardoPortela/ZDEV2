...
*/===========================================================================\*
*|  Desenvolvedor:                                                           |*
*|    + Luis Grotti ( luis.grotti@amaggi.com.br )         17.02.2017         |*
*|                                                                           |*
*|  Tester:                                                                  |*
*|    + Adelson Arruda ( adelson.arruda@amaggi.com.br )                      |*
*|  Changelog:                                                               |*
*|    + Welgem Barbosa ( welgem.barbosa@amaggi.com.br )   21.02.2017         |*
*|                                                                           |*
*/===========================================================================\*

*/===========================================================================\*
*| Descrição:                                                                |*
*| Alteração de Valores na Tabela ZLEST0032                                  |*
*/===========================================================================\*
...
TYPES BEGIN OF TY_0032.
        INCLUDE STRUCTURE ZLEST0032.
TYPES FIELD_STYLE   TYPE LVC_T_STYL.
TYPES END OF TY_0032.

DATA: IT_ZLEST0032 TYPE STANDARD TABLE OF ZLEST0032,
      WA_ZLEST0032 TYPE ZLEST0032,
      IT_0032      TYPE STANDARD TABLE OF TY_0032,
...
*/===========================================================================\*
*| Tela de Seleção Principal                                                 |*
*/===========================================================================\*
SELECTION-SCREEN BEGIN OF BLOCK FILTROS WITH FRAME TITLE TEXT-001.
SELECT-OPTIONS: P_TKNUM  FOR ZLEST0032-TKNUM,
                P_FKNUM  FOR ZLEST0032-FKNUM,
                P_EBELN  FOR ZLEST0032-EBELN,
                P_EBELP  FOR ZLEST0032-EBELP,
                P_LBLNI  FOR ZLEST0032-LBLNI,
                P_ADD03  FOR ZLEST0032-ADD03,
                P_BELNR  FOR ZLEST0032-BELNR,
                P_DATA   FOR ZLEST0032-DATA,
                P_HORA   FOR ZLEST0032-HORA,
                P_NOME   FOR ZLEST0032-NOME,
                P_GJAHR  FOR ZLEST0032-GJAHR,
                P_STATUS FOR ZLEST0032-STATUS1,
                P_DOCNUM FOR ZLEST0032-DOCNUM.
SELECTION-SCREEN END OF BLOCK FILTROS.

*/===========================================================================\*
*| Inicio do Processo de Seleção                                             |*
*/===========================================================================\*
START-OF-SELECTION.
...
FORM SELECIONAR_REGISTROS.
  ...
  SELECT *
    ...
    WHERE TKNUM IN P_TKNUM
      AND FKNUM   IN P_FKNUM
      AND EBELN   IN P_EBELN
      AND EBELP   IN P_EBELP
      AND LBLNI   IN P_LBLNI
      AND ADD03   IN P_ADD03
      AND BELNR   IN P_BELNR
      AND DATA    IN P_DATA
      AND HORA    IN P_HORA
      AND NOME    IN P_NOME
      AND GJAHR   IN P_GJAHR
      AND STATUS1 IN P_STATUS
      AND DOCNUM  IN P_DOCNUM.

  MOVE-CORRESPONDING IT_ZLEST0032 TO IT_0032.
...
*   Fill info for layout variant
    ...
    SET HANDLER: LCL_ALV_TOOLBAR=>ON_DATA_CHANGER FOR CTL_ALV,
                  LCL_ALV_TOOLBAR=>HANDLE_USER_COMMAND FOR CTL_ALV,
                 LCL_ALV_TOOLBAR=>ON_DATA_CHANGED_FINISHED FOR CTL_ALV,
                 LCL_ALV_TOOLBAR=>ON_DATA_CHANGER     FOR CTL_ALV.
