...
CLASS lcl_event_handler_5520 DEFINITION.
  ...
  PUBLIC SECTION.
    CLASS-METHODS:
      ...
      toolbar_5520_lote FOR EVENT toolbar OF  cl_gui_alv_grid
        IMPORTING e_object,
...
*-CS2019001896 - 12.08.2021 - JT - inicio
    IF e_column_id-fieldname EQ 'EDITAR'.
      ...
      READ TABLE it_sol_5520 INTO wa_sol_5520 INDEX e_row_id.
      IF wa_sol_5520-editar = '@0Z@'. "change
        g_editar = abap_false.
      ELSE.
        g_editar = abap_true.
      ENDIF.

      PERFORM click_em_solic_5520 USING e_row_id.
      PERFORM bloqueia_linhas_caminhao_5520.
...
*-CS2019001896 - 12.08.2021 - JT - fim
    ...
    IF e_column_id-fieldname EQ 'ICONE'.
      ...
      IF sy-subrc IS INITIAL.
        IF wa_sol_5520_det-editar = '@0Z@'. "change
...
*-CS2019001896 - 12.08.2021 - JT - inicio
  LOOP AT it_sol_5520 INTO wa_sol_5520.
    ...
    wa_sol_5520-editar = '@10@'.

    l_gname = 'IT_ZSDT0082'.
    CONCATENATE sy-mandt          wa_sol_5520-nro_sol wa_sol_5520-seq
                wa_sol_5520-vbeln wa_sol_5520-posnr
           INTO l_garg.
    ...
    IF it_enq[] IS NOT INITIAL.
      wa_sol_5520-editar = '@06@'.
    ENDIF.
    MODIFY it_sol_5520 FROM wa_sol_5520 INDEX l_tabix.
  ENDLOOP.
*-CS2019001896 - 12.08.2021 - JT - fim
...
*         User Story 153510 // MMSILVA
          16 'DESC_STATUS_ICONE'  ''              ' '  ' '  ' '  ' '   ''    ' '   ' '   ' '   'Desc. Status. Icone'.
*         User Story 153510 // MMSILVA
    ...
    PERFORM fill_it_fieldcatalog TABLES it_fieldcatalog_caminhao_5520 USING:
          ...
          21 'UM'                   ' '         ' '     ' '  ' '  ' '   'X'   ' '   ' '   ' '   'U.M.',
          22 'NIFORN'               ' '         ' '     'X'  ' '  ' '   'X'   ' '   ' '   ' '   'Nr. Intern. fornecedor',
          23 'NFENUM'               ' '         ' '     'X'  ' '  ' '   'X'   ' '   ' '   ' '   'NF Fornc.',
          24 'SERIES'               ' '         ' '     'X'  ' '  ' '   'X'   ' '   ' '   ' '   'Série',
          25 'NETWR'                'ZSDT0001'  ' '     'X'  ' '  ' '   'X'   ' '   ' '   ' '   'Valor NF',
          26 'DOCDAT_NF'            'ZSDT0138'  ' '     'X'  ' '  ' '   'X'   ' '   ' '   ' '   'Data Emissão NF',
          27 'NR_ROMANEIO'          ' '         ' '     ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Nr. Romaneio',
*         User Story 153510 // MMSILVA
          28 'DESC_STATUS_ICONE'    ' '         ' '     ' '  ' '  ' '   ''    ' '   ' '   ' '   'Desc. Status Icone'.
*         User Story 153510 // MMSILVA
...
*-----CS2019001891 - 08.03.2021 - JT - fim
      lcl_event_handler_5520=>toolbar_5520_lote FOR ctl_alv1_5520,
      lcl_event_handler_5520=>user_command_5520 FOR ctl_alv1_5520.
...
*       User Story 153510 // MMSILVA
        IF wa_caminhao_5520-status EQ 1.
          ...
          wa_caminhao_5520-desc_status_icone = 'Lote Aprovado'.
        ELSEIF wa_caminhao_5520-status EQ 2.
          wa_caminhao_5520-icone = '@0Q@'.
          wa_caminhao_5520-desc_status_icone = 'Romaneio Gerado'.
        ENDIF.
*       User Story 153510 // MMSILVA
...
*         User Story 153510 // MMSILVA
          IF wa_zsdt0001-st_proc EQ '99'.
            ...
            wa_caminhao_5520-desc_status_icone = 'Romaneio Finalizado'.
          ENDIF.
*         User Story 153510 // MMSILVA
        ENDIF.
...
FORM salva_romaneios_5520 CHANGING vl_check_rom.
  ...
  IF vl_check_rom IS INITIAL.
    ...
    LOOP AT it_caminhao_aux_5520 INTO wa_caminhao_5520.
      ...
      wa_zsdt0001-peso_subtotal = wa_caminhao_5520-qtd_embarq. "IR096917 - 01.06.2012 - RMNI
      ...
      ELSE.
        ...
        SELECT SINGLE *
          ...
          WHERE seq_cam EQ wa_caminhao_5520-seq_cam
            ...
            AND seq     EQ wa_caminhao_5520-seq
*-CS2019001891 - 28.06.2021 - JT - inicio
            AND filial_resp EQ wa_caminhao_5520-filial_resp.
*           AND filial_resp EQ g_filial_resp.
*           AND filial_resp EQ 'TPGA'.
*-CS2019001891 - 28.06.2021 - JT - fim
