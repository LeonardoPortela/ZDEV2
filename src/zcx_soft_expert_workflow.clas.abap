class ZCX_SOFT_EXPERT_WORKFLOW definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_ERRO_GERAL,
      msgid type symsgid value 'ZSEWORKFLOW',
  ...
  constants:
    begin of ZCX_WORKFLOW_NAO_ENCONTRADO,
      msgid type symsgid value 'ZSEWORKFLOW',
    ...
    end of ZCX_WORKFLOW_NAO_ENCONTRADO .
  constants:
  ...
  constants:
    begin of ZCX_EMPTY_RETURN_WEBSERVICE,
      msgid type symsgid value 'ZSEWORKFLOW',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_EMPTY_RETURN_WEBSERVICE .
  constants:
    begin of ZCX_NO_LOCATE_TAG_WEBSERVICE,
      msgid type symsgid value 'ZSEWORKFLOW',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_NO_LOCATE_TAG_WEBSERVICE .
  constants:
    begin of ZCX_NO_PROCESS_SAPSE,
      msgid type symsgid value 'ZSEWORKFLOW',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_NO_PROCESS_SAPSE .
  constants:
    begin of ZCX_NO_SERVICO_WEBSERVICE,
      msgid type symsgid value 'ZSEWORKFLOW',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_NO_SERVICO_WEBSERVICE .
  constants:
    begin of ZCX_NO_TIP_SERVICO_WEBSERVICE,
      msgid type symsgid value 'ZSEWORKFLOW',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_NO_TIP_SERVICO_WEBSERVICE .
...
CLASS ZCX_SOFT_EXPERT_WORKFLOW IMPLEMENTATION.
