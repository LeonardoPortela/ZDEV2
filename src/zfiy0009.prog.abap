...
************************************************************************
REPORT ZFIY0009 NO STANDARD PAGE HEADING
                LINE-SIZE  215
                LINE-COUNT 65
                MESSAGE-ID 8a.
...
* Eliminado en 02.09.2010 por Diego
...
GET bset.
*Note 1064177 Begin
*  CHECK: KTOSL_SEL   NE SPACE,
*         BSET-KTOSL  IN S_KTOSL.
...
*[I]-INSERT-------------------------------Javier Mona 22/09/2010

  SORT t_item BY  bukrs
                  belnr
                  gjahr
                  buzei
                  witht.
  ...
  LOOP AT detail where PERCEPTION ne 'X'.
    v_tabix = sy-tabix.
    CLEAR detail-hwste.
...
*[F]-INSERT-------------------------------Javier Mona 22/09/2010
