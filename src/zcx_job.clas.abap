...
public section.
  ...
  constants:
    begin of ZCX_JOB_NAO_EXECUTANDO,
      msgid type symsgid value 'ZJOB',
    ...
    end of ZCX_JOB_NAO_EXECUTANDO .
  constants:
    begin of ZCX_SEM_USER_DEFAULT,
      msgid type symsgid value 'ZJOB',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_USER_DEFAULT .
  constants:
    begin of ZCX_JOB_NAO_ESCALONADO,
      msgid type symsgid value 'ZJOB',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_JOB_NAO_ESCALONADO .
  constants:
    begin of ZCX_PROGRAM_NOT_EXECUTING,
      msgid type symsgid value 'ZJOB',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_PROGRAM_NOT_EXECUTING .
