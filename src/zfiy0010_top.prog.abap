...
*----------------------------------------------------------------------
TYPES:
        tyt_bajada_ret TYPE STANDARD TABLE OF ty_bajada_ret,
        tyt_bajada_rec TYPE STANDARD TABLE OF ty_bajada_rec,
        tyt_bajada_per TYPE STANDARD TABLE OF ty_bajada_per.

DATA :
       t_bkpf        TYPE STANDARD TABLE OF bkpf,
       t_bseg        TYPE STANDARD TABLE OF bseg,
       tl_bajada_rec TYPE STANDARD TABLE OF ty_bajada_rec,
       t_lfa1        TYPE STANDARD TABLE OF lfa1,
       t_kna1        TYPE STANDARD TABLE OF kna1,
       t_ctaregion   TYPE STANDARD TABLE OF zfiyt_ctaregion,
       t_bset        TYPE STANDARD TABLE OF bset,
       t_item        TYPE STANDARD TABLE OF with_item,
* Incluído 30.08.2011 - Diego
       l_item        LIKE with_item,
* Fin 30.08.2011 ...........
       st_kna1       TYPE kna1,
       t_t005s       TYPE STANDARD TABLE OF t005s,
       t_bajada      TYPE STANDARD TABLE OF ty_out_aux,
       t_banco       TYPE STANDARD TABLE OF ty_banco,
       t_percep      TYPE STANDARD TABLE OF ty_percep,
       st_ctaregion  TYPE zfiyt_ctaregion,
       st_t005s      TYPE t005s,
...
DATA t_t059p  TYPE STANDARD TABLE OF t059p.
...
* Estructura para documentos de retenciones
TYPES: BEGIN OF tp_s_bseg,
         ...
         BUZEI type BUZEI     ,
       END OF tp_s_bseg,
       tp_t_bseg TYPE STANDARD TABLE OF tp_s_bseg.
