...
public section.
  ...
  constants:
    begin of ZCX_INFORMAR_PERNR_CPF,
      msgid type symsgid value 'ZHCM',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_INFORMAR_PERNR_CPF .
  constants:
    begin of ZCX_SEM_ESPELHO_PONTO,
      msgid type symsgid value 'ZHCM',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_ESPELHO_PONTO .
  constants:
    begin of ZCX_SEM_FOLHA_PAGAMENTO,
      msgid type symsgid value 'ZHCM',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_FOLHA_PAGAMENTO .
  constants:
    begin of ZCX_SEM_INF_RENDIMENTO,
      msgid type symsgid value 'ZHCM',
