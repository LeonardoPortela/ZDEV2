...
*-------------------------------------
  ...
  "US 145143 - 25-06-24 - Integração XML Tributum - WPP - Ini

  l_xml_doc = zcl_string=>xstring_to_string( i_xstring = CONV #( l_xstring_out ) ).
  ...
  "US 145143 - 25-06-24 - Integração XML Tributum - WPP - Fim
...
* Exibir tela
*------------------------------------------
  CALL SCREEN 5000 STARTING AT 16  01
                     ENDING AT 176 24.
