class ZCL_MEMORY_FT_ENTRADA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_MEMORY_FT_ENTRADA' ##NO_TEXT.
  data ROOT type ref to ZCL_MEMORY_FT_ENTRADA_HANDLE read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_MEMORY_FT_ENTRADA
    raising
      CX_SHM_INCONSISTENT
...
CLASS ZCL_MEMORY_FT_ENTRADA IMPLEMENTATION.
