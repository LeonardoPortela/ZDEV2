...
MODULE STATUS_0110 OUTPUT.
  ...
  CLEAR: ZSDT0167, ZSDT0168.
  IF ZSDT0169-CODIGO_URF IS NOT INITIAL.
    SELECT SINGLE *
      FROM ZSDT0167 INTO ZSDT0167
     WHERE CODIGO_URF = ZSDT0169-CODIGO_URF.
  ENDIF.

  IF ZSDT0169-CODIGO_RA IS NOT INITIAL.
    SELECT SINGLE *
      FROM ZSDT0168 INTO ZSDT0168
