class ZCX_FERROVIARIO_SAIDA definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_NOTA_NAO_ENCONTRADA,
    ...
    end of ZCX_NOTA_NAO_ENCONTRADA .
  constants:
    begin of ZCX_FORNE_NAO_ENCONTRADO,
      msgid type symsgid value 'ZLES',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_FORNE_NAO_ENCONTRADO .
  constants:
    begin of ZCX_DADOS_DCL_VAGAO,
      msgid type symsgid value 'ZLES',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_DADOS_DCL_VAGAO .
  constants:
    begin of ZCX_DOC_NAO_ENCONTRADO,
      msgid type symsgid value 'ZLES',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_DOC_NAO_ENCONTRADO .
  constants:
    begin of ZCX_ESTA_NO_PROCESSO,
      msgid type symsgid value 'ZLES',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_ESTA_NO_PROCESSO .
  constants:
    begin of ZCX_ERRO_TRANSBORDO,
      msgid type symsgid value 'ZLES',
...
CLASS ZCX_FERROVIARIO_SAIDA IMPLEMENTATION.
