...
selection-screen: begin of block B1 with frame title text-001.
  select-options:  P_BLDAT  for BKPF-BLDAT,
                   P_BUDAT  for BKPF-BUDAT obligatory,
...
*          and   BSCHL in ( '01', '02', '11', '12', '21', '22', '31', '32' ).
          ...
          LV_GJAHR = conv #( WA_ZIB_CONTABIL_AUX-STJAH ).
          LV_BUKRS = WA_ZIB_CONTABIL_AUX-BUKRS.
...
*      and   BSCHL in ( '01', '02', '11', '12', '21', '22', '31', '32' ).
      ...
      LV_BELNR = WA_BSAS-BELNR.
      LV_GJAHR = WA_BSAS-GJAHR.
      LV_BUKRS = WA_BSAS-BUKRS.
...
*          and   BSCHL in ( '01', '02', '11', '12', '21', '22', '31', '32' ).
          ...
          LV_BELNR = CONV #( WA_BSAS-STBLG ).
          LV_GJAHR  = CONV #( WA_BSAS-STJAH ).
...
form F_ALV_FIELDCAT .
  ...
  if R_TOT = 'X'.
    ...
    WA_AFIELD-SCRTEXT_S = 'VAT Basis CHF'.
    WA_AFIELD-SCRTEXT_L = 'VAT Basis CHF'.
    WA_AFIELD-SCRTEXT_M = 'VAT Basis CHF'.
    WA_AFIELD-EDIT          = ''.
    WA_AFIELD-KEY           = ''.
    WA_AFIELD-OUTPUTLEN     = 20.
    append WA_AFIELD to IT_FIELDCAT.
