class ZCL_INT_OB_KONVIVA_USUARIOS definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '193' ##NO_TEXT.
...
CLASS ZCL_INT_OB_KONVIVA_USUARIOS IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    me->zif_integracao_inject~at_autentica_module  = 'konviva_usuarios'.
...
*    ENDIF.
  ...
  METHOD zif_integracao_outbound~get_instance.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_konviva_usuarios.
    ENDIF.
  ...
  METHOD zif_integracao_outbound~set_url.
    ...
    CASE lwa_data-metodo.
      WHEN 'GET'.
        CONCATENATE lwa_webservice-url '/action/api/getUsuarioByCPF/' lwa_data-cpf   INTO lva_url.
        me->zif_integracao_inject~at_info_request_http-ds_metodo             = 'GET'.
      WHEN 'PUT'.
        CONCATENATE lwa_webservice-url '/action/api/integrarUsuario'       INTO lva_url.
        me->zif_integracao_inject~at_info_request_http-ds_metodo             = 'PUT'.
      WHEN 'POST'.
        CONCATENATE lwa_webservice-url '/action/api/integrarUsuarios'        INTO lva_url.
