interface ZIF_ENVIA_LOCAL_INSTAL_MOBMAN
  public .


  class-data AT_ENVIA_LOCAL_MOBMAN type ref to ZIF_ENVIA_LOCAL_INSTAL_MOBMAN .
  ...
  class-data AT_LOCAL type ZTPM_T_LOCAL_MOBILE .

  class-methods GET_INSTANCE
    returning
      value(R_IF_ENVIA_LOCAL_MOBMA) type ref to ZIF_ENVIA_LOCAL_INSTAL_MOBMAN
    raising
      ZCX_INTEGRACAO .
  methods SET_DS_URL
    returning
  ...
  methods SET_DS_URL_PUT
    returning
      value(R_IF_INTEGRACAO_COMB) type ref to ZIF_INTEGRACAO_COMB .
  methods POST_ENVIA_LOCAL_INSTAL
    importing
      !I_LOCAL type ZTPM_T_LOCAL_MOBILE
    exporting
      !E_ID_INTEGRACAO type ZDE_ID_INTEGRACAO
      !E_INTEGRACAO type ZINTEGRACAO
      !E_DATA type STRING
  ...
  methods SET_DADOS_LOCAL_INSTAL
    importing
      !I_DATA type ZTPM_T_LOCAL_MOBILE
    returning
      value(R_IF_ENVIA_LOCAL_MOBMA) type ref to ZIF_ENVIA_LOCAL_INSTAL_MOBMAN .
endinterface.
