...
*"     REFERENCE(I_CHAVE) TYPE  ZDE_CHAVE_NFE OPTIONAL
      ...
      CASE wa_doc-model.
        WHEN '55'.
          ...
          ELSE.
            ...
            PERFORM entry2 IN PROGRAM zbrnfe_danfe_nast USING gv_par gv_screen lc_nast CHANGING it_otf.
          ENDIF.
        WHEN '57'.
          lc_nast-kappl = 'NF'.
...
* INICIO - 2000049672 - RRIBEIRO - 01.08.2025 - STEFANINI
      CATCH zcx_doc_eletronico INTO DATA(lx_doc).
