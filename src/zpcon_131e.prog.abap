...
*& Report  ZPCON_131E
*&---------------------------------------------------------------------*
*& This report looks at logistics orders with operation confirmations  *
...
*& Version 2.2 - 17.01.2023 (AK) (added maintenance orders)            *
*&---------------------------------------------------------------------*
    ...
    LOOP AT lt_afru INTO ls_afru.
      ...
      IF ls_afvc-rmzhl IS INITIAL OR
         ( ls_afvc-rmzhl = '00000001' AND
           ( ls_afru-satza(1) = 'L' OR       "Time Ticket
             ls_afru-satza(1) = 'I' ) AND    "Maintenance Order
