...
MODULE f4_bvtyp.
  ...
  DATA: l_kunnr TYPE knbk-kunnr,
        l_lifnr TYPE lfbk-lifnr,
        l_xshow TYPE rfcu4-flagx,
        l_bvtyp TYPE lfbk-bvtyp.

  FREE: l_kunnr, l_lifnr, l_xshow, l_bvtyp.

  IF     wa_saida_0100-koart = 'K'.
    l_lifnr = wa_saida_0100-parid.
  ELSEIF wa_saida_0100-koart = 'D'.
    l_kunnr = wa_saida_0100-parid.
  ENDIF.
  ...
  IF l_bvtyp IS NOT INITIAL.
    wa_bseg-bvtyp = l_bvtyp.
  ENDIF.
