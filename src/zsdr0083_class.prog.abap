...
*   Create ALV toolbar manager instance
  ...
  METHOD ON_TOOLBAR.
    ...
    TY_TOOLBAR-TEXT      = 'Modificar Campo'.
    TY_TOOLBAR-BUTN_TYPE = 0.
    APPEND TY_TOOLBAR TO E_OBJECT->MT_TOOLBAR.
    CLEAR TY_TOOLBAR.
    ...
    TY_TOOLBAR-TEXT      = 'Deletar Campo'.
    TY_TOOLBAR-BUTN_TYPE = 0.
    APPEND TY_TOOLBAR TO E_OBJECT->MT_TOOLBAR.
    CLEAR TY_TOOLBAR.

    TY_TOOLBAR-ICON      = ICON_CREATE.
    TY_TOOLBAR-FUNCTION  = C_NOVO_GRP.
    TY_TOOLBAR-TEXT      = 'Novo Grupo'.
    TY_TOOLBAR-BUTN_TYPE = 0.
    APPEND TY_TOOLBAR TO E_OBJECT->MT_TOOLBAR.
    CLEAR TY_TOOLBAR.

    TY_TOOLBAR-ICON      = ICON_DELETE_ROW.
    TY_TOOLBAR-FUNCTION  = C_DEL_GRP.
    TY_TOOLBAR-TEXT      = 'Deletar Grupo'.
    TY_TOOLBAR-BUTN_TYPE = 0.
    APPEND TY_TOOLBAR TO E_OBJECT->MT_TOOLBAR.
    CLEAR TY_TOOLBAR.
  ...
  METHOD HANDLE_USER_COMMAND.
    ...
    CASE E_UCOMM.
       WHEN C_DEL.
        ...
        DELETE FROM ZSDT0080 WHERE GRUPO = WA_SAIDA_0100-GRUPO
                               AND CAMPO = WA_SAIDA_0100-CAMPO.
      ...
      WHEN C_CHANGE.
        ...
        MOVE-CORRESPONDING WA_SAIDA_0100 TO ZSDT0080.
      ...
      WHEN C_NOVO_GRP.
        ...
        CALL SCREEN 0120 STARTING AT 10 05 ENDING AT 85 07 .
      ...
      WHEN C_DEL_GRP.
        ...
        CALL SCREEN 0121 STARTING AT 10 05 ENDING AT 40 07 .
