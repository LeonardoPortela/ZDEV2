...
TYPES: BEGIN OF ty_saida,
         finalidade       TYPE zsdt0364-finalidade,
         desc_final       TYPE dd07t-ddtext,
         data_criacao     TYPE zsdt0364-data_criacao,
         hora_criacao     TYPE zsdt0364-hora_criacao,
         usuario_criacao  TYPE zsdt0364-usuario_criacao,
         excluido         TYPE zsdt0364-excluido,
         data_exclusao    TYPE zsdt0364-data_exclusao,
         hora_exclusao    TYPE zsdt0364-hora_exclusao,
         usuario_exclusao TYPE zsdt0364-usuario_exclusao,
...
DATA: it_saida        TYPE TABLE OF ty_saida,
      ...
      it_ZSDT0364     TYPE TABLE OF zsdt0364,
      wa_ZSDT0364     TYPE zsdt0364,
      wa_ZSDT0364_aux TYPE zsdt0364.
...
CLASS lcl_alv_toolbar IMPLEMENTATION.
  ...
  METHOD handle_data_changed.
    ...
    IF et_good_cells IS NOT INITIAL.
      ...
      DELETE lt_saida WHERE desc_final IS INITIAL.
      SORT lt_saida BY finalidade.

      DATA(lt_saida2) = it_saida.
      DELETE lt_saida2 WHERE desc_final IS NOT INITIAL.
      ...
      IF lt_good IS NOT INITIAL.
        ...
        WHERE domname    EQ 'ZFIN_EXPORT_D'
          ...
          AND domvalue_l EQ @lt_good-value(10).
        ...
        IF sy-subrc IS INITIAL.
            ...
            IF sy-subrc IS INITIAL.
              ...
              ELSE.
                ...
                IF sy-subrc IS INITIAL.
                  ...
                  <fs_saida>-desc_final = <fs_dd07t>-ddtext.
          ...
          IF lt_cell IS NOT INITIAL.
            ...
            MESSAGE 'Já existe um cadastro para esta Finalidade de Exportação' TYPE 'S' DISPLAY LIKE 'E'.
