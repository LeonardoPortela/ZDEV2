...
DATA: t_log1       TYPE TABLE OF zpps_ximfbf_log,
      ...
      l_charg      TYPE  zpps_ximfbf_log-charg,
      l_charg_ant  TYPE  zpps_ximfbf_log-charg,
...
SORT t_log1 BY data hora obj_key.

l_charg_ant = '0000000000'.

LOOP AT t_log1 INTO w_log1.
  l_charg = w_log1-charg.
  IF l_charg < l_charg_ant.
    APPEND w_log1  TO t_det.
  ENDIF.
  l_charg_ant = l_charg.
ENDLOOP.
