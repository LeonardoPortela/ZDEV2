*&-------------------------------------------------------------------------------------------------------*
*& Report         : ZCL_INT_OB_FINANFOR_MOV_UPDATE                                                        *
...
*&-------------------------------------------------------------------------------------------------------*
*&-------------------------------------------------------------------------------------------------------*
*& 14/07/2025  |DEVK9A2OOH  |NSEGATIN       |Integração Finanfor - Atualiza Movimento. Desenvol. inicial.*
*&                                          |Chamado: 184694.                                            *
*--------------------------------------------------------------------------------------------------------*
class ZCL_INT_OB_FINANFOR_MOV_UPDATE definition
  public
  create public .
...
public section.
  ...
  data AT_PARAM_MOV_UPDATE type ZFIE_FINANFOR_MOV_UPDATE .
...
CLASS ZCL_INT_OB_FINANFOR_MOV_UPDATE IMPLEMENTATION.
  ...
  METHOD zif_integracao_outbound~build_info_request.
    ...
    MOVE-CORRESPONDING i_info_request TO at_param_mov_update.
  ...
  METHOD zif_integracao_outbound~get_instance.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_finanfor_mov_update.
    ENDIF.
