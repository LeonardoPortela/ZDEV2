...
*         User Story 153510 - MMSILVA
          19 'DESC_STATUS_ICONE'    ''             ' '  ' '  ' '  ' '   ''    ' '   ' '   ' '   'Desc. Status Icone'.
*         User Story 153510 - MMSILVA
    ...
    CREATE OBJECT ctl_alv2_5230
      EXPORTING
        i_parent = dg_parent_2_5230.           "ALV Oderm
...
*   User Story 153510 - MMSILVA
    IF wa_carga_5230-status EQ '1'.
      wa_carga_5230-icone = '@9K@'.
      wa_carga_5230-desc_status_icone = 'Carga Criada'.
    ELSEIF wa_carga_5230-status EQ '2'.
      wa_carga_5230-icone = '@5D@'.
      wa_carga_5230-desc_status_icone = 'Carga sem Cotação'.
    ELSEIF wa_carga_5230-status EQ '3'.
      wa_carga_5230-icone =  '@FD@'.
      wa_carga_5230-desc_status_icone = 'Carga Cotada'.
    ELSEIF wa_carga_5230-status EQ '4'.
      wa_carga_5230-icone =  '@4A@'.
      wa_carga_5230-desc_status_icone = 'Frete Contratado'.
    ELSEIF wa_carga_5230-status EQ '5'.
      wa_carga_5230-icone = '@96@'.
      wa_carga_5230-desc_status_icone = 'Embarque Autorizado'.
    ELSEIF wa_carga_5230-status EQ '6'.
      wa_carga_5230-icone =  '@0Q@'.
      wa_carga_5230-desc_status_icone = 'Romaneio Gerado'.
    ENDIF.
*   User Story 153510 - MMSILVA
