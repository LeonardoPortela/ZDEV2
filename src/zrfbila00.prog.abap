REPORT ZRFBILA00 MESSAGE-ID FR
                 LINE-SIZE   201
...
CONSTANTS: CON_GRID(4) TYPE C        VALUE 'GRID',              " ALV
           ...
           CON_REPID   LIKE SY-REPID VALUE 'ZRFBILA00'.          " ALV
...
*---> 15/06/2023 - Migração S4 - JS
*      LT_BALANCE-L_BALANCE12 = PT_BSPL-SALDO.
*      LT_BALANCE-L_BALANCE22 = PT_BSPL-SALDO2.
      LT_BALANCE-L_BALANCE12 = CONV #( PT_BSPL-SALDO  ).
      LT_BALANCE-L_BALANCE22 = CONV #( PT_BSPL-SALDO2 ).
*<--- 15/06/2023 - Migração S4 - JS
