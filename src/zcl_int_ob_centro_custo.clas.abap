class ZCL_INT_OB_CENTRO_CUSTO definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '158' ##NO_TEXT.
  data AT_DADOS_CENTRO type ZFIT_OB_CENTRO_CUSTO .
...
CLASS ZCL_INT_OB_CENTRO_CUSTO IMPLEMENTATION.
  ...
  METHOD zif_integracao_outbound~build_info_request.
    ...
    DATA: lt_centro_cust TYPE zfit_ob_centro_custo.

    r_if_integracao_outbound = me.

    MOVE-CORRESPONDING i_info_request TO lt_centro_cust.

    me->at_dados_centro = lt_centro_cust.
...
*    e_referencia-id_referencia = me->at_dados_due-id_due.
  ...
  method ZIF_INTEGRACAO_OUTBOUND~GET_INSTANCE.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_centro_custo.
    ENDIF.
