...
*-CS2021000253-21.05.2024-#140138-JT-inicio - validado em BADI
...
*      RETURN.
*    ENDIF.
*-CS2021000253-21.05.2024-#140138-JT-fim    - validado em BADI
...
*      RETURN.
*    ENDIF.
*-CS2021000253-21.05.2024-#140138-JT-fim  o - validado em BADI
...
*-CS2021000253-21.05.2024-#140138-JT-inicio
        CALL FUNCTION 'ZLES_SET_DATA_BP'
          EXPORTING
            i_bapi_fornece = abap_true
            i_but000       = gs_but000  "*-CS2021000253-#149089-07.01.2025-JT
            i_lfa1         = gs_lfa1
            t_lfb1         = gt_lfb1
            t_lfbk         = gt_lfbk
            t_lfbw         = gt_lfbw
            t_lfm1         = gt_lfm1.
*-CS2021000253-21.05.2024-#140138-JT-fim
...
*          <fs_cemail>-contact-datax-e_mail    = 'X'.
  ...
  METHOD MT_FILL_PART_CENT_COMMON_CUST.
    ...
    CASE im_bu_type.
      WHEN '1'. "Person
        cs_bp_data-partner-central_data-common-data-bp_centraldata-title_key      = '0004'.
...
*    cs_bp_data-partner-central_data-common-datax-bp_centraldata-partnerlanguage = abap_true.
    ...
    CASE im_bu_type.
      WHEN '1'. "Person
        ...
        cs_bp_data-partner-central_data-common-data-bp_centraldata-title_key      = '0002'.
...
*  CS_BP_DATA-vendor-central_data-central-data-katr1  = IS_ADDR1_DATA-extension2.
*  CS_BP_DATA-vendor-central_data-central-datax-katr1 = abap_true.
*  CS_BP_DATA-vendor-central_data-central-data-katr6  = IS_ADDR1_DATA-extension1.
*  CS_BP_DATA-vendor-central_data-central-datax-katr6 = abap_true.
...
*    cs_bp_data-vendor-central_data-address-postal-datax-langu = abap_true.
    ...
    cs_bp_data-vendor-central_data-central-data-stenr = is_lfa1-stenr. "*-CS2021000253-06.02.2025-#165752-JT
  ...
  METHOD MT_FILL_PART_SUP_BANKDETAIL.
    ...
    LOOP AT it_lfbk ASSIGNING FIELD-SYMBOL(<fs_lfbk>).
      ...
      <fs_bankdetails>-data_key           = <fs_lfbk>-bvtyp.
