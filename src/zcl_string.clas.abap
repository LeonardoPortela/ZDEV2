...
*       SEPARATORS    = ' -.,;:'
  ...
  METHOD nvl.
    ...
    DATA(lv_data_1) = to_upper( i_data_1 ).  "*-155550-28.11.2024-JT
    DATA(lv_data_2) = to_upper( i_data_2 ).  "*-155550-28.11.2024-JT

    r_data       = COND string( WHEN i_data_1 IS NOT INITIAL THEN i_data_1 ELSE i_data_2 ).
    CHECK i_data_1 IS NOT INITIAL.
    e_diferentes = COND string( WHEN lv_data_1 EQ lv_data_2 THEN abap_false ELSE abap_true ). "*-155550-28.11.2024-JT
  ENDMETHOD.
