class ZCX_USER_PERFIL definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_ERRO_GERAL,
      msgid type symsgid value 'ZPERFIL',
  ...
  constants:
    ...
    end of ZCX_FUNCAO_ATRIBUIDA .
  constants:
    begin of ZCX_FUNCAO_NAO_ATRIBUIDA,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_FUNCAO_NAO_ATRIBUIDA .
  constants:
    begin of ZCX_SEM_USUARIO,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_USUARIO .
  constants:
    begin of ZCX_MANY_USUARIO,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_MANY_USUARIO .
  constants:
    begin of ZCX_CPF_OU_UNAME,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_CPF_OU_UNAME .
  constants:
    begin of ZCX_DH_INICIO_FIM,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_DH_INICIO_FIM .
  constants:
    begin of ZCX_USUARIO_NAO_ENCONTRADO,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_USUARIO_NAO_ENCONTRADO .
  constants:
    begin of ZCX_CCUSTO_NAO_AUTORIZADO,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_CCUSTO_NAO_AUTORIZADO .
  constants:
    begin of ZCX_SEM_MEDIADO,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_MEDIADO .
  constants:
    begin of ZCX_SEM_PERFIL_ATRIBUIR,
      msgid type symsgid value 'ZPERFIL',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_SEM_PERFIL_ATRIBUIR .
...
CLASS ZCX_USER_PERFIL IMPLEMENTATION.
