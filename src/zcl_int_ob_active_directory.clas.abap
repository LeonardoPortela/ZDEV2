class ZCL_INT_OB_ACTIVE_DIRECTORY definition
  public
  final
  create public .
...
CLASS ZCL_INT_OB_ACTIVE_DIRECTORY IMPLEMENTATION.
  ...
  METHOD zif_integracao_outbound~get_data.
    ...
    e_data = me->at_get_active_directory-json.
  ...
  METHOD zif_integracao_outbound~get_id_referencia.
    r_if_integracao_outbound = me.
*** BUG - 150010- Inicio - CBRAND
    e_referencia-tp_referencia =  me->at_get_active_directory-tipo.
*** BUG - 150010 - Fim - CBRAND
*** BUG - 152454 - Inicio - CBRAND
    e_referencia-id_referencia =  me->at_get_active_directory-pernr.
*** BUG - 152454 - Fim - CBRAND
  ENDMETHOD.
  ...
  METHOD zif_integracao_outbound~set_url.
    ...
    CASE lwa_data-tipo.
      WHEN 'GET_USUARIO'.
        ...
        DATA(lva_cpf) = lc_retorno-cpf.

        CONCATENATE lwa_webservice-url '/v1/usuario?cpf='  lva_cpf     INTO lva_url.
      ...
      WHEN 'GET_NOMES_ALE'.
        CONCATENATE lwa_webservice-url '/v1/ActiveDirectory/getNomesAleatorios' INTO lva_url.
      WHEN 'SET_ESTRUT_ORG'.
