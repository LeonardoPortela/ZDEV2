FUNCTION z_nw_estrategia_lista.
*"----------------------------------------------------------------------
*"*"Interface local:
*"  IMPORTING
...
"Ajuste ZNFW0007 trazendo documentos aprovados  #183069 - BG - INICIO
*  SELECT *
*      FROM zfiwrt0008
...
*         AND EXISTS ( SELECT operacao FROM zfiwrt0007 WHERE zfiwrt0007~operacao = zfiwrt0008~operacao ).
"Ajuste ZNFW0007 trazendo documentos aprovados  #183069 - BG - FIM
