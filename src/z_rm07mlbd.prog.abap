REPORT z_rm07mlbd NO STANDARD PAGE HEADING MESSAGE-ID m7 LINE-SIZE 95.
...
INCLUDE:  z_rm07mldd.     " reportspezifische Datendefinitionen
...
SELECTION-SCREEN BEGIN OF BLOCK war WITH FRAME TITLE TEXT-200.
  PARAMETERS: p_moeda TYPE bsis-waers.
SELECTION-SCREEN END OF BLOCK war.
...
*---> 19.07.2023 12:28:08 - Migração S4 - DL
...
*---> 19.07.2023 12:20:51 - Migração S4 - DL
    SORT g_t_bsim_lean BY bukrs bwkey matnr.
*<--- 19.07.2023 12:20:51 - Migração S4 - DL
...
*     set the FI doc number into the entry of the MM doc    "n443935
      ...
      MOVE : g_s_bsim_work-belnr                            "n443935
             ...
             g_s_bsim_work-buzei TO g_s_mseg_work-buzei,
...
*     IS-OIL specific functions without ABAP preprocessor   "n599218 A
      IF  g_flag_is_oil_active = 'X'.       "IS-OIL ?       "n599218 A
        ...
        MODIFY g_t_mseg_work                                "n599218 A
                   ...
                   INDEX  1                                 "n599218 A
                   TRANSPORTING belnr buzei gjahr dmbtr.    "n599218 A
      ELSE.                                                 "n599218 A
        MODIFY g_t_mseg_work  FROM  g_s_mseg_work           "n599218 A
                            INDEX  1                        "n599218 A
                            TRANSPORTING  belnr buzei gjahr. "n599218 A
      ENDIF.                                                "n599218 A
...
*   read the original entry and change it                   "n451923
    ...
    MOVE  : g_s_mseg_work-belnr                             "n451923
            ...
            g_s_mseg_work-buzei TO g_s_mseg_update-buzei,
