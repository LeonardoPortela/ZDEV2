...
*&---------------------------------------------------------------------*
*       Procedimento Para Est. de Aprova├º├úo de CT-e
*----------------------------------------------------------------------*
*      -->P_P_CD_CHAVE_CTE   Chave de Refer├¬ncia do CT-e
*      -->P_P_TP_APROVACAO   Tipo de Aprova├º├úo
*      <--P_P_CD_APROVACAO   C├│digo de Retorna da "Aprova├º├úo"
*      <--P_P_TP_AUTORIZADO  Qual Autoriza├º├úo foi Informada Pelo Usu├írio
*----------------------------------------------------------------------*
...
*&---------------------------------------------------------------------*
*       Grava Registro de Autoriza├º├úo
*----------------------------------------------------------------------*
...
* In├¡cio - RJF - 007.07.2022 - bloq. mult.
...
* Fim - RJF - 007.07.2022 - bloq. mult.
  ELSE.
    ...
    MOVE 'Texto Autom├ítico' TO tl_tlines-tdline.
    APPEND tl_tlines.
    ...
    WHEN ok_aprovar.
      ...
      CASE zib_cte_dist_eap-tp_aprovacao.
        ...
        WHEN OTHERS.
          ...
          "Autoriza├º├úo de Pagamento Complemento
    ...
    WHEN '01'. "Chegada de Documentos
      CASE zib_cte_dist_eap-tp_autorizado.
        ...
        WHEN '02'. "Negado
          ck_bt_tela = icon_reject.
      ENDCASE.
    WHEN '02'. "Autoriza├º├úo de Pagamento Complemento
      CASE zib_cte_dist_eap-tp_autorizado.
        WHEN '01'. "Autorizado
          ck_bt_tela = icon_allow.
        WHEN '02'. "Negado
