*&-------------------------------------------------------------------------------------------------------*
*& Report         : ZCL_INT_OB_ACEITE_RECEB_LUFT                                                             *
...
*&-------------------------------------------------------------------------------------------------------*
*&-------------------------------------------------------------------------------------------------------*
*& 29/04/2025  |DEVK9A2J5I  |NSEGATIN       |Integração LUFT - Envio. Desenv. inicial. Chamado: 174131.  *
*--------------------------------------------------------------------------------------------------------*
class ZCL_INT_OB_ACEITE_RECEB_LUFT definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '278' ##NO_TEXT.
  constants:
    at_servico      TYPE c LENGTH 100 value 'LUFT_INTEGRACAO_ACEITE' ##NO_TEXT.
  data AT_ACEITE_RECEB type ZSDE_INTEGRA_LUFT_ACEITE_RECEB .
...
CLASS ZCL_INT_OB_ACEITE_RECEB_LUFT IMPLEMENTATION.
  ...
  METHOD zif_integracao_outbound~build_info_request.
    ...
    MOVE-CORRESPONDING i_info_request TO at_aceite_receb.
  ...
  METHOD zif_integracao_outbound~get_instance.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_aceite_receb_luft.
    ENDIF.
  ...
  METHOD zif_integracao_outbound~set_url.
    ...
    me->zif_integracao_inject~at_info_request_http-ds_url                = CONV #( lwa_webservice-url && lwa_webservice-add01 ).
