CLASS zcl_int_ob_get_material_eudr DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS: at_id_interface TYPE zde_id_interface VALUE '233' ##NO_TEXT.
    CONSTANTS:
      lc_servico       TYPE c LENGTH 19 VALUE 'EUDR_CHECK_MATERIAL' ##NO_TEXT.
    CONSTANTS:
    ...
    DATA at_params TYPE zstruct_get_material_eudr .
    DATA at_body TYPE znfwe0001 . "// Estrutura para JSON caso exista
...
CLASS ZCL_INT_OB_GET_MATERIAL_EUDR IMPLEMENTATION.
...
*        r_json = e_data.
  ...
  METHOD zif_integracao_outbound~get_instance.
    ...
    IF zif_integracao_outbound~at_if_integracao_outbound IS NOT BOUND.
      CREATE OBJECT zif_integracao_outbound~at_if_integracao_outbound TYPE zcl_int_ob_get_material_eudr.
    ENDIF.
  ...
  METHOD zif_integracao_outbound~set_url.
    ...
    REPLACE '[CODMATERIALSAP]' IN v_url WITH at_params-matnr.
