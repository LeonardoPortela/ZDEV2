...
TYPES: BEGIN OF ty_saida,
         status           TYPE icon-id,
         material         TYPE bapi_pi_order_create-material,
         plant            TYPE bapi_pi_order_create-plant,
         order_type       TYPE bapi_pi_order_create-order_type,
         basic_start_date TYPE bapi_pi_order_create-basic_start_date,
         recipe_counter   TYPE bapi_pi_order_create-recipe_counter,
         basic_start_time TYPE bapi_pi_order_create-basic_start_time,
         quantity         TYPE bapi_pi_order_create-quantity,
         quantity_uom     TYPE bapi_pi_order_create-quantity_uom,
         sales_order      TYPE bapi_pi_order_create-sales_order,
         sales_order_item TYPE bapi_pi_order_create-sales_order_item,
         ordemcarreg      TYPE aufk-ordemcarreg,
...
FORM tratar_arquivo.
  ...
  LOOP AT gt_planilha INTO wl_planilha.
    ...
    CASE wl_planilha-col.
      WHEN 1.
        wa_saida-material = wl_planilha-value.
        wa_saida-material = |{ wa_saida-material  ALPHA = IN }|.
      WHEN 2.
        wa_saida-plant = wl_planilha-value.
        wa_saida-plant = |{ wa_saida-plant  ALPHA = IN }|.
      WHEN 3.
        wa_saida-basic_start_date = wl_planilha-value.
      WHEN 4.
        wa_saida-quantity = wl_planilha-value.
      WHEN 5.
        wa_saida-quantity_uom = wl_planilha-value.
      WHEN 6.
        wa_saida-sales_order = wl_planilha-value.
        wa_saida-sales_order = |{ wa_saida-sales_order  ALPHA = IN }|.
      WHEN 7.
        wa_saida-sales_order_item = wl_planilha-value.
        wa_saida-sales_order_item = |{ wa_saida-sales_order_item  ALPHA = IN }|.
      WHEN 8.
        wa_saida-ordemcarreg = wl_planilha-value.
      WHEN 9.
        wa_saida-placa = wl_planilha-value.
    ENDCASE.
  ...
  LOOP AT gt_saida ASSIGNING FIELD-SYMBOL(<ws_saida>).
    ...
    DATA(_orderdata) =
         VALUE bapi_pi_order_create(
               material         = <ws_saida>-material
               plant            = <ws_saida>-plant
               order_type       = 'PI01'
               basic_start_date = <ws_saida>-basic_start_date
               recipe_counter   = '01'
               basic_start_time = sy-uzeit
               quantity         = <ws_saida>-quantity
               quantity_uom     = <ws_saida>-quantity_uom
               sales_order      = <ws_saida>-sales_order
               sales_order_item = <ws_saida>-sales_order_item ).
    ...
    IF order_number IS NOT INITIAL.
      UPDATE aufk SET ordemcarreg = <ws_saida>-ordemcarreg
                      placa       = <ws_saida>-placa
