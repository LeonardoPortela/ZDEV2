...
form zf_atribuir_nfe_dist_ter using p_status
  ...
  data: lt_zintg_pag type zintg_pag,
        ls_zintg_pag type zdetpag.

  data: ls_zintg_t_dup type zintg_dup.

* Atualiza Tabela ZIB_NFE_DIST_TER
...
form zf_atribuir_nfe_dist_itm .
  ...
  field-symbols: <zintg_det> type zdet_nitem.

  data: lva_vlr_unit_com  type p,
        lva_vlr_unit_trib type p.

  data: gt_zintg_det type zintg_det.
...
* Atualiza Tabela ZIB_NFE_DIST_ITM
  loop at gt_zintg_det assigning <zintg_det>.

    clear: gs_zib_nfe_dist_itm.

    lva_vlr_unit_com  = <zintg_det>-prod-vuncom.
    lva_vlr_unit_trib = <zintg_det>-prod-vuntrib.

    gs_zib_nfe_dist_itm-chave_nfe = gs_xml_sefaz-nfeproc-protnfe-infprot-chnfe.
    gs_zib_nfe_dist_itm-prod_item = <zintg_det>-a_nitem.
    gs_zib_nfe_dist_itm-prod_codigo = <zintg_det>-prod-cprod.
    gs_zib_nfe_dist_itm-prod_cfop = <zintg_det>-prod-cfop.
    gs_zib_nfe_dist_itm-prod_descricao = <zintg_det>-prod-xprod.
    gs_zib_nfe_dist_itm-prod_ean = <zintg_det>-prod-cean.
    gs_zib_nfe_dist_itm-prod_ncm = <zintg_det>-prod-ncm.
    gs_zib_nfe_dist_itm-prod_extipi = <zintg_det>-prod-extipi.
*  gs_zib_nfe_dist_itm-PROD_NCM_GENERO
    gs_zib_nfe_dist_itm-prod_und_comerci = <zintg_det>-prod-ucom.
    gs_zib_nfe_dist_itm-prod_qtd_comerci = <zintg_det>-prod-qcom.

    if lva_vlr_unit_com <= 9999999999.
      gs_zib_nfe_dist_itm-prod_vlr_und_com = <zintg_det>-prod-vuncom.
    endif.

    gs_zib_nfe_dist_itm-prod_vlr_total_b = <zintg_det>-prod-vprod.
    gs_zib_nfe_dist_itm-prod_ean_trib = <zintg_det>-prod-ceantrib .
    gs_zib_nfe_dist_itm-prod_und_trib = <zintg_det>-prod-utrib.
    gs_zib_nfe_dist_itm-prod_qtd_trib = <zintg_det>-prod-qtrib.

    if lva_vlr_unit_trib <= 9999999999.
      gs_zib_nfe_dist_itm-prod_vlr_und_tri = <zintg_det>-prod-vuntrib.
    endif.

    gs_zib_nfe_dist_itm-prod_vl_frete = <zintg_det>-prod-vfrete.
    gs_zib_nfe_dist_itm-prod_vl_seguro = <zintg_det>-prod-vseg.
    gs_zib_nfe_dist_itm-prod_vl_desconto = <zintg_det>-prod-vdesc.
    gs_zib_nfe_dist_itm-prod_vl_outro = <zintg_det>-prod-voutro.
    gs_zib_nfe_dist_itm-prod_ind_total = <zintg_det>-prod-indtot.
    gs_zib_nfe_dist_itm-prod_pedido_comp = <zintg_det>-prod-xped.
*  gs_zib_nfe_dist_itm-PROD_NR_PED_COMP


    "GS_ZIB_NFE_DIST_ITM-ICMS_CST = <ZINTG_DET>-IMPOSTO-ICMS-CST.

    if <zintg_det>-imposto-icms-icms00-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms00-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms00-orig.
    elseif <zintg_det>-imposto-icms-icms10-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms10-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms10-orig.
    elseif <zintg_det>-imposto-icms-icms20-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms20-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms20-orig.
    elseif <zintg_det>-imposto-icms-icms30-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms30-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms30-orig.
    elseif <zintg_det>-imposto-icms-icms40-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms40-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms40-orig.
    elseif <zintg_det>-imposto-icms-icms51-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms51-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms51-orig.
    elseif <zintg_det>-imposto-icms-icms60-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms60-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms60-orig.
    elseif <zintg_det>-imposto-icms-icms70-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms70-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms70-orig.
    elseif <zintg_det>-imposto-icms-icms90-cst is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icms90-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icms90-orig.
*** US #181947 - MMSILVA - 18.06.2025 - Ini ***
    elseif <zintg_det>-imposto-icms-icmssn202 is not initial.
      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icmssn202-csosn+1(2).
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icmssn202-orig.
...
*ICMS ST - NOTAS FISCAIS DE VEÍCULO - BG #155190 - INICIO
    if <zintg_det>-imposto-icms-icmspart-cst is not initial.

      gs_zib_nfe_dist_itm-icms_cst        = <zintg_det>-imposto-icms-icmspart-cst.
      gs_zib_nfe_dist_itm-icms_origem_mec = <zintg_det>-imposto-icms-icmspart-orig.
      gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icmspart-modbc.
      gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icmspart-vbc.
      gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icmspart-picms.
      gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icmspart-predbc.
      gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icmspart-vicms.
      gs_zib_nfe_dist_itm-icms_st_md_base = <zintg_det>-imposto-icms-icmspart-modbcst.
      gs_zib_nfe_dist_itm-icms_st_base    = <zintg_det>-imposto-icms-icmspart-vbcst.
      gs_zib_nfe_dist_itm-icms_st_aqt     = <zintg_det>-imposto-icms-icmspart-picmsst.
      gs_zib_nfe_dist_itm-icms_st_valor   = <zintg_det>-imposto-icms-icmspart-vicmsst.
      gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icmspart-motdesicms.
      gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icmspart-vicmsdeson.
      gs_zib_nfe_dist_itm-icms_pbcop = <zintg_det>-imposto-icms-icmspart-pbcop.
      gs_zib_nfe_dist_itm-ICMS_ufst = <zintg_det>-imposto-icms-icmspart-ufst.

    else.

      case gs_zib_nfe_dist_itm-icms_cst.
        when '00'.
          gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms00-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms00-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms00-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms00-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms00-vicms.

          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms00-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms00-vicmsdeson.

        when '10'.
          gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms10-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms10-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms10-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms10-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms10-vicms.

          "Campos ST - WPP
          gs_zib_nfe_dist_itm-icms_st_md_base = <zintg_det>-imposto-icms-icms10-modbcst.

          gs_zib_nfe_dist_itm-icms_st_base    = <zintg_det>-imposto-icms-icms10-vbcst.
          gs_zib_nfe_dist_itm-icms_st_aqt     = <zintg_det>-imposto-icms-icms10-picmsst.
          gs_zib_nfe_dist_itm-icms_st_valor   = <zintg_det>-imposto-icms-icms10-vicmsst.
          "Campos ST - WPP


          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms10-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms10-vicmsdeson.

        when '20'.
          gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms20-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms20-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms20-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms20-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms20-vicms.

          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms20-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms20-vicmsdeson.

        when '30'.
          gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms30-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms30-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms30-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms30-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms30-vicms.


          "Campos ST - WPP
          gs_zib_nfe_dist_itm-icms_st_md_base = <zintg_det>-imposto-icms-icms30-modbcst.

          gs_zib_nfe_dist_itm-icms_st_base    = <zintg_det>-imposto-icms-icms30-vbcst.
          gs_zib_nfe_dist_itm-icms_st_aqt     = <zintg_det>-imposto-icms-icms30-picmsst.
          gs_zib_nfe_dist_itm-icms_st_valor   = <zintg_det>-imposto-icms-icms30-vicmsst.
          "Campos ST - WPP


          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms30-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms30-vicmsdeson.


        when '40' or '41' or '50'.
          gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms40-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms40-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms40-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms40-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms40-vicms.
...
*  gs_zib_nfe_dist_itm-ICMS_ST_VALOR
          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms40-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms40-vicmsdeson.

        when '51'.
          gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms51-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms51-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms51-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms51-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms51-vicms.
*  gs_zib_nfe_dist_itm-ICMS_ST_MD_BASE
*  gs_zib_nfe_dist_itm-ICMS_ST_MARGEM
*  gs_zib_nfe_dist_itm-ICMS_ST_RED_BASE
*  gs_zib_nfe_dist_itm-ICMS_ST_AQT
*  gs_zib_nfe_dist_itm-ICMS_ST_BASE
*  gs_zib_nfe_dist_itm-ICMS_ST_VALOR
          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms51-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms51-vicmsdeson.

        when '60'.
*        gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms160-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms60-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms60-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms60-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms60-vicms.
*  gs_zib_nfe_dist_itm-ICMS_ST_MD_BASE
*  gs_zib_nfe_dist_itm-ICMS_ST_MARGEM
*  gs_zib_nfe_dist_itm-ICMS_ST_RED_BASE
*  gs_zib_nfe_dist_itm-ICMS_ST_AQT
*  gs_zib_nfe_dist_itm-ICMS_ST_BASE
*  gs_zib_nfe_dist_itm-ICMS_ST_VALOR
          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms60-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms60-vicmsdeson.

        when '70'.
*        gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms170-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms70-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms70-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms70-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms70-vicms.

          "Campos ST - WPP
          gs_zib_nfe_dist_itm-icms_st_md_base = <zintg_det>-imposto-icms-icms70-modbcst.

          gs_zib_nfe_dist_itm-icms_st_base    = <zintg_det>-imposto-icms-icms70-vbcst.
          gs_zib_nfe_dist_itm-icms_st_aqt     = <zintg_det>-imposto-icms-icms70-picmsst.
          gs_zib_nfe_dist_itm-icms_st_valor   = <zintg_det>-imposto-icms-icms70-vicmsst.
          "Campos ST - WPP


          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms70-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms70-vicmsdeson.

        when '90'.
          gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icms90-modbc.
          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icms90-vbc.
          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icms90-picms.
          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icms90-predbc.
          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icms90-vicms.

          "Campos ST - WPP
          gs_zib_nfe_dist_itm-icms_st_md_base = <zintg_det>-imposto-icms-icms90-modbcst.

          gs_zib_nfe_dist_itm-icms_st_base    = <zintg_det>-imposto-icms-icms90-vbcst.
          gs_zib_nfe_dist_itm-icms_st_aqt     = <zintg_det>-imposto-icms-icms90-picmsst.
          gs_zib_nfe_dist_itm-icms_st_valor   = <zintg_det>-imposto-icms-icms90-vicmsst.
          "Campos ST - WPP


          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icms90-motdesicms.
          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icms90-vicmsdeson.

*** US #181947 - MMSILVA - 18.06.2025 - Ini ***
        when '02'.
*         gs_zib_nfe_dist_itm-icms_md_base = <zintg_det>-imposto-icms-icmssn202-modbc.
*          gs_zib_nfe_dist_itm-icms_base = <zintg_det>-imposto-icms-icmssn202--vbc.
*          gs_zib_nfe_dist_itm-icms_aqt = <zintg_det>-imposto-icms-icmssn202-picms.
*          gs_zib_nfe_dist_itm-icms_red_base = <zintg_det>-imposto-icms-icmssn202-predbc.
*          gs_zib_nfe_dist_itm-icms_valor = <zintg_det>-imposto-icms-icmssn202-vicms.

          "Campos ST - WPP
          gs_zib_nfe_dist_itm-icms_st_md_base = <zintg_det>-imposto-icms-icmssn202-modbcst.

          gs_zib_nfe_dist_itm-icms_st_base    = <zintg_det>-imposto-icms-icmssn202-vbcst.
          gs_zib_nfe_dist_itm-icms_st_aqt     = <zintg_det>-imposto-icms-icmssn202-picmsst.
          gs_zib_nfe_dist_itm-icms_st_valor   = <zintg_det>-imposto-icms-icmssn202-vicmsst.
          "Campos ST - WPP


*          gs_zib_nfe_dist_itm-icms_mt_desonera = <zintg_det>-imposto-icms-icmssn202-motdesicms.
*          gs_zib_nfe_dist_itm-icms_vl_desonerado = <zintg_det>-imposto-icms-icmssn202-vicmsdeson.
*** US #181947 - MMSILVA - 18.06.2025 - Fim ***
...
*   DETERMINAÇÃO IPI
    gs_zib_nfe_dist_itm-ipi_cod_enquadra = <zintg_det>-imposto-ipi-cenq.
    gs_zib_nfe_dist_itm-ipi_cla_enquadra = <zintg_det>-imposto-ipi-clenq.
    gs_zib_nfe_dist_itm-ipi_cnpj_prod = <zintg_det>-imposto-ipi-cnpjprod.
    gs_zib_nfe_dist_itm-ipi_cod_selo_con = <zintg_det>-imposto-ipi-cselo.
    gs_zib_nfe_dist_itm-ipi_qtd_selo_con = <zintg_det>-imposto-ipi-qselo.


    if <zintg_det>-imposto-ipi-ipint is not initial.
      gs_zib_nfe_dist_itm-ipi_cst = <zintg_det>-imposto-ipi-ipint-cst.
    else.
      gs_zib_nfe_dist_itm-ipi_cst = <zintg_det>-imposto-ipi-ipitrib-cst.
    endif.

    case gs_zib_nfe_dist_itm-ipi_cst .
      when '00' or '49' or '50' or '99'.
        gs_zib_nfe_dist_itm-ipi_cst = <zintg_det>-imposto-ipi-ipitrib-cst.
        gs_zib_nfe_dist_itm-ipi_base = <zintg_det>-imposto-ipi-ipitrib-vbc.
        gs_zib_nfe_dist_itm-ipi_aqt = <zintg_det>-imposto-ipi-ipitrib-pipi.
        gs_zib_nfe_dist_itm-ipi_valor = <zintg_det>-imposto-ipi-ipitrib-vipi.
      when '01' or '02' or '03' or '04' or '51' or '52' or '53' or '54' or '55'.
        gs_zib_nfe_dist_itm-ipi_cst = <zintg_det>-imposto-ipi-ipint-cst.
    endcase.

*   DETERMINAÇÃO PIS
    gs_zib_nfe_dist_itm-pis_cst = <zintg_det>-imposto-pis-cst.

    if <zintg_det>-imposto-pis-pisaliq is not initial.
      gs_zib_nfe_dist_itm-pis_base = <zintg_det>-imposto-pis-pisaliq-vbc.
      gs_zib_nfe_dist_itm-pis_aqt = <zintg_det>-imposto-pis-pisaliq-ppis.
      gs_zib_nfe_dist_itm-pis_valor = <zintg_det>-imposto-pis-pisaliq-vpis.

      if gs_zib_nfe_dist_itm-pis_cst is initial.
        gs_zib_nfe_dist_itm-pis_cst = <zintg_det>-imposto-pis-pisaliq-cst.
      endif.

    elseif <zintg_det>-imposto-pis-pisqtde is not initial.
      gs_zib_nfe_dist_itm-pis_base = <zintg_det>-imposto-pis-pisqtde-vbc.
      gs_zib_nfe_dist_itm-pis_aqt = <zintg_det>-imposto-pis-pisqtde-ppis.
      gs_zib_nfe_dist_itm-pis_valor = <zintg_det>-imposto-pis-pisqtde-vpis.

      if gs_zib_nfe_dist_itm-pis_cst is initial.
        gs_zib_nfe_dist_itm-pis_cst = <zintg_det>-imposto-pis-pisqtde-cst.
      endif.

    elseif <zintg_det>-imposto-pis-pisnt is not initial.

      if gs_zib_nfe_dist_itm-pis_cst is initial.
        gs_zib_nfe_dist_itm-pis_cst = <zintg_det>-imposto-pis-pisnt-cst.
      endif.

    elseif <zintg_det>-imposto-pis-pisoutr is not initial.
      gs_zib_nfe_dist_itm-pis_base = <zintg_det>-imposto-pis-pisoutr-vbc.
      gs_zib_nfe_dist_itm-pis_aqt = <zintg_det>-imposto-pis-pisoutr-ppis.
      gs_zib_nfe_dist_itm-pis_valor = <zintg_det>-imposto-pis-pisoutr-vpis.

      if gs_zib_nfe_dist_itm-pis_cst is initial.
        gs_zib_nfe_dist_itm-pis_cst = <zintg_det>-imposto-pis-pisoutr-cst.
      endif.

    elseif <zintg_det>-imposto-pis-pisst is not initial.
      gs_zib_nfe_dist_itm-pis_base = <zintg_det>-imposto-pis-pisst-vbc.
      gs_zib_nfe_dist_itm-pis_aqt = <zintg_det>-imposto-pis-pisst-ppis.
      gs_zib_nfe_dist_itm-pis_valor = <zintg_det>-imposto-pis-pisst-vpis.

      if gs_zib_nfe_dist_itm-pis_cst is initial.
        gs_zib_nfe_dist_itm-pis_cst = <zintg_det>-imposto-pis-pisst-cst.
      endif.
...
*   DETERMINAÇÃO COFINS
    gs_zib_nfe_dist_itm-cof_cst = <zintg_det>-imposto-cofins-cst.

    if <zintg_det>-imposto-cofins-cofinsaliq is not initial.
      gs_zib_nfe_dist_itm-cof_base = <zintg_det>-imposto-cofins-cofinsaliq-vbc.
      gs_zib_nfe_dist_itm-cof_aqt = <zintg_det>-imposto-cofins-cofinsaliq-pcofins.
      gs_zib_nfe_dist_itm-cof_valor = <zintg_det>-imposto-cofins-cofinsaliq-vcofins.
    elseif <zintg_det>-imposto-cofins-cofinsqtde is not initial.
      gs_zib_nfe_dist_itm-cof_base = <zintg_det>-imposto-cofins-cofinsqtde-vbc.
      gs_zib_nfe_dist_itm-cof_aqt = <zintg_det>-imposto-cofins-cofinsqtde-pcofins.
      gs_zib_nfe_dist_itm-cof_valor = <zintg_det>-imposto-cofins-cofinsqtde-vcofins.
    elseif <zintg_det>-imposto-cofins-cofinsoutr is not initial.
      gs_zib_nfe_dist_itm-cof_base = <zintg_det>-imposto-cofins-cofinsoutr-vbc.
      gs_zib_nfe_dist_itm-cof_aqt = <zintg_det>-imposto-cofins-cofinsoutr-pcofins.
      gs_zib_nfe_dist_itm-cof_valor = <zintg_det>-imposto-cofins-cofinsoutr-vcofins.
    elseif <zintg_det>-imposto-cofins-cofinsst is not initial.
      gs_zib_nfe_dist_itm-cof_base = <zintg_det>-imposto-cofins-cofinsst-vbc.
      gs_zib_nfe_dist_itm-cof_aqt = <zintg_det>-imposto-cofins-cofinsst-pcofins.
      gs_zib_nfe_dist_itm-cof_valor = <zintg_det>-imposto-cofins-cofinsst-vcofins.
    endif.
...
* Atualiza Tabela ZIB_CTE_DIST_TER
...
*  GS_ZIB_CTE_DIST_TER-ZVLR_FRETE
...
*  GS_ZIB_CTE_DIST_TER-ZDT_MOV
*  GS_ZIB_CTE_DIST_TER-ZDT_VENCTO
*  GS_ZIB_CTE_DIST_TER-ZPESO_DIFERENCA
*  GS_ZIB_CTE_DIST_TER-ZQUEBRA
*  GS_ZIB_CTE_DIST_TER-ZPERDA
*  GS_ZIB_CTE_DIST_TER-ZVLR_QUEBRA
*  GS_ZIB_CTE_DIST_TER-ZVLR_PERDA
*  GS_ZIB_CTE_DIST_TER-ZVLR_LIQ_PAGAR
...
*  GS_ZIB_CTE_DIST_TER-DOCNUM_CTE_P
  modify zib_cte_dist_ter from gs_zib_cte_dist_ter.
...
* Atualiza Tabela ZIB_CTE_DIST_C57
  ...
  modify zib_cte_dist_c57 from gs_zib_cte_dist_c57.
...
* Atualiza Tabela ZIB_CTE_DIST_C57
  ...
  loop at gs_xml_sefaz_cte-cteproc-cte-infcte-vprest-comp into data(wl_comp).
    ...
    modify zib_cte_dist_cvl from gs_zib_cte_dist_cvl.
  endloop.
...
*  Atualiza Tabela ZIB_CTE_DIST_D55
  ...
  loop at lt_zde_inf_cte_norm into ls_zde_inf_cte_norm.
    ...
    modify zib_cte_dist_d55 from gs_zib_cte_dist_d55.
  endloop.
...
*  Atualiza Tabela ZIB_CTE_DIST_MOT
  ...
  modify zib_cte_dist_mot from gs_zib_cte_dist_mot  .
...
*  Atualiza Tabela ZIB_CTE_DIST_N01
  ...
  loop at lt_zde_inf_cte_norm_inf into ls_zde_inf_cte_norm_inf.
    ...
    modify zib_cte_dist_n01 from gs_zib_cte_dist_n01.
  endloop.
...
*  Atualiza Tabela ZIB_CTE_DIST_N55
  ...
  loop at lt_zde_inf_cte_norm_inf into ls_zde_inf_cte_norm_inf.
    ...
    modify zib_cte_dist_n55 from gs_zib_cte_dist_n55.
  endloop.
...
*  GS_ZIB_CTE_DIST_D55-ZVLR_FRETE
*  GS_ZIB_CTE_DIST_D55-ZVLR_MERCADORIA
*  GS_ZIB_CTE_DIST_D55-ZVLR_QUEBRA
*  GS_ZIB_CTE_DIST_D55-ZVLR_PERDA
*  GS_ZIB_CTE_DIST_D55-ZVLR_LIQ_PAGAR
...
*  GS_ZIB_CTE_DIST_D55-ZPESO_DIFERENCA
*  GS_ZIB_CTE_DIST_D55-ZQUEBRA
*  GS_ZIB_CTE_DIST_D55-ZPERDA
...
*  Atualiza Tabela ZIB_CTE_DIST_VEI
...
*    GS_ZIB_CTE_DIST_VEI-PROP_TIPO_PROP          = ls_ZDE_INF_MODAL_RODO-PLACA.
    modify zib_cte_dist_vei from gs_zib_cte_dist_vei.
  endloop.
...
*  Atualiza Tabela ZIB_CTE_DIST_VGA
...
*  GS_ZIB_CTE_DIST_VGA-INFO_CAPACIDADE
  ...
  modify zib_cte_dist_vga from gs_zib_cte_dist_vga.
...
*  Atualiza Tabela ZIB_CTE_DIST_D55
  ...
  loop at lt_zde_inf_compl into ls_zde_inf_compl.
    ...
    modify zib_cte_dist_cpl from gs_zib_cte_dist_cpl.
  endloop.
...
form zf_atribuir_cte_dist_001.
  ...
  loop at gs_xml_sefaz_cte-cteproc-cte-infcte-compl-obscont into data(wl_inf_compl).
    ...
    try.
        ...
        modify zib_cte_dist_001 from gs_zib_cte_dist_001.
...
*  Atualiza Tabela ZIB_CTE_DIST_D01
  ...
  loop at lt_zde_inf_cte_norm into ls_zde_inf_cte_norm.
    ...
    modify zib_cte_dist_d01 from gs_zib_cte_dist_d01.
  endloop.
...
form zf_atrib_st_sefaz_zib_cte using p_status
                                     p_cod_sefaz
                            changing c_zib_cte_dist_ter type zib_cte_dist_ter.
...
form zf_atrib_st_sefaz_zib_nfe using p_status
                                     p_cod_sefaz
                            changing c_zib_nfe_dist_ter type zib_nfe_dist_ter.
...
form zf_atribuir_nfe_dist_avb.
  data: ls_infevento    type zintg_evento,
