interface ZIF_INT_TOKEN_TRACE_ACTS
  public .


  class-data AT_IF_TOKEN_TRACE_ACTS type ref to ZIF_INT_TOKEN_TRACE_ACTS .
  ...
  class-methods GET_INSTANCE
    ...
    returning
      value(R_IF_INT_TOKEN_TRACE_ACTS) type ref to ZIF_INT_TOKEN_TRACE_ACTS
    raising
      ZCX_INTEGRACAO .
