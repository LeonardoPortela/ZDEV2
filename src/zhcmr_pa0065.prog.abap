************************************************************************
* PROGRAMA           : ZHCMR_PA0065                                    *
* TRANSACAO          : xxxxxxxx                                        *
* DESCRICAO          : Cockpit de Formulário                           *
* xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx *
* AUTOR              : Ítalo de Souza                                  *
* Solicitante        : Carolini Santos                                 *
* DATA               : 23/07/2024                                      *
*----------------------------------------------------------------------*
REPORT zhcmr_pa0065.
...
*======================================================================*
  ...
  DATA: v_formname TYPE tdsfname VALUE 'ZHCMS_PA0062',
...
FORM z_seleciona_dados.
  ...
  wa_saida-desc_emp    = lv_butxt .
  wa_saida-cidade      = it_addr-city1.
  wa_saida-uf          = it_addr-po_box_reg.
  wa_saida-ano         = sy-datum+0(4).
  wa_saida-end_ext     = |{ it_addr-street }, { it_addr-house_num1 } - { it_addr-city2 }, { it_addr-post_code1 }, { it_addr-city1 } |.
  IF it_addr-house_num2 IS NOT INITIAL.
    wa_saida-end_ext = |{ wa_saida-end_ext }, { it_addr-house_num2 }|.
  ENDIF.
  ...
  wa_saida-pernr = wa_0002-pernr.


  SELECT SINGLE *
    FROM pa0465 INTO @DATA(wa_0465)
  WHERE pernr EQ @pernr-pernr
    AND subty  = '0001'
    AND endda >= @sy-datum.
...
*  ENDLOOP.
  ...
  TRANSLATE wa_saida-desc_emp    TO UPPER CASE.
  TRANSLATE wa_saida-end_ext     TO UPPER CASE.
  TRANSLATE wa_saida-desc_filial TO UPPER CASE.
  TRANSLATE wa_saida-cname       TO UPPER CASE.
...
*---DADOS EMPRESA
  ...
  CASE abap_true.
    WHEN p_pa_te.
      "Nome do smartform que vai ser gerado.
      vl_formname = 'ZHCMS_PA0001'.
    WHEN p_pa_td.
      vl_formname = ''.
  ENDCASE.
