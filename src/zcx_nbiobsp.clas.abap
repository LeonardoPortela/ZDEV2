...
public section.
  ...
  constants:
    begin of ZCX_ERRO_GERAL,
      msgid type symsgid value 'ZNBIOBSP',
  ...
  constants:
    begin of ZCX_REF_OBJ_OLE_DEVICE,
      msgid type symsgid value 'ZNBIOBSP',
    ...
    end of ZCX_REF_OBJ_OLE_DEVICE .
  constants:
    begin of ZCX_REF_OBJ_OLE_EXTRACTION,
      msgid type symsgid value 'ZNBIOBSP',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_REF_OBJ_OLE_EXTRACTION .
  constants:
    begin of ZCX_REF_OBJ_OLE_INDEXSEARCH,
      msgid type symsgid value 'ZNBIOBSP',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_REF_OBJ_OLE_INDEXSEARCH .
  constants:
    begin of ZCX_REF_OBJ_OLE_NSEARCH,
      msgid type symsgid value 'ZNBIOBSP',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_REF_OBJ_OLE_NSEARCH .
  constants:
    begin of ZCX_REF_OBJ_OLE_FPIMAGE,
      msgid type symsgid value 'ZNBIOBSP',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_REF_OBJ_OLE_FPIMAGE .
  constants:
    begin of ZCX_REF_OBJ_OLE_FPDATA,
      msgid type symsgid value 'ZNBIOBSP',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_REF_OBJ_OLE_FPDATA .
  constants:
    begin of ZCX_REF_OBJ_OLE_MATCHING,
      msgid type symsgid value 'ZNBIOBSP',
      ...
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_REF_OBJ_OLE_MATCHING .
  constants:
    begin of ZCX_ERRO_METODO,
      msgid type symsgid value 'ZNBIOBSP',
      ...
      attr3 type scx_attrname value 'MSGV3',
      attr4 type scx_attrname value '',
    end of ZCX_ERRO_METODO .
  constants:
    begin of ZCX_ERRO_VERIF_DIGITAL,
      msgid type symsgid value 'ZNBIOBSP',
...
CLASS ZCX_NBIOBSP IMPLEMENTATION.
