...
*  BREAK-POINT.
  ...
  DATA WA_ZGLT043B TYPE ZGLT043B.
  ...
  LOOP AT TOTAL.
    ...
    IF <VIM_TOTAL_STRUC> IS ASSIGNED.
      MOVE-CORRESPONDING <VIM_TOTAL_STRUC> TO WA_ZGLT043B.
    ENDIF.
    IF <ACTION> IS NOT INITIAL AND <ACTION> NE 'X'.

      READ TABLE IT_T001 WITH KEY BUKRS = WA_ZGLT043B-BUKRS TRANSPORTING NO FIELDS.
      IF SY-SUBRC IS NOT INITIAL.
        MESSAGE S091(8B) WITH WA_ZGLT043B-BUKRS DISPLAY LIKE 'E'.
        VIM_ABORT_SAVING = 'X'.
      ENDIF.

*      AUTHORITY-CHECK OBJECT 'ZFI_BUKRS'
*      ID 'BUKRS' FIELD WA_ZGLT043B-BUKRS.
*      IF SY-SUBRC <> 0.
*        MESSAGE S091(8B) WITH WA_ZGLT043B-BUKRS DISPLAY LIKE 'E'.
*        VIM_ABORT_SAVING = 'X'.
*      ENDIF.
