class ZCL_INT_OB_ATIVA_ORDEM_SUPERV definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '211' ##NO_TEXT.
...
CLASS ZCL_INT_OB_ATIVA_ORDEM_SUPERV IMPLEMENTATION.
...
*    ENDLOOP.
  ...
  METHOD zif_integracao_inject~set_processa_retorno.
    ...
    UPDATE zppt0038 SET status = 'SINCRONIZADO' WHERE ordem = me->at_ordem.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~SET_URL.
    ...
    SELECT SINGLE *
     ...
     WHERE service = 'ATIVA_ORDENS_SUPERVISORIO'.
