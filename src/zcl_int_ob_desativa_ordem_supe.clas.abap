class ZCL_INT_OB_DESATIVA_ORDEM_SUPE definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '210' ##NO_TEXT.
  data AT_ORDEM type ZPPE_DESAT_ORDEM .
...
CLASS ZCL_INT_OB_DESATIVA_ORDEM_SUPE IMPLEMENTATION.
...
*    ENDLOOP.
  ...
  METHOD zif_integracao_inject~set_processa_retorno.
    ...
    UPDATE zppt0038 SET ativo = '0' WHERE ordem = me->at_ordem.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~BUILD_INFO_REQUEST.
    ...
    me->at_ordem-ordem_id = i_info_request.
  ...
  METHOD zif_integracao_outbound~get_data.
    ...
    DATA: ls_ordem TYPE zppe_desat_ordem.

    r_if_integracao_outbound = me.

    CLEAR: e_data.

    ls_ordem-ordem_id = me->at_ordem-ordem_id.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~SET_URL.
    ...
    SELECT SINGLE *
     ...
     WHERE service = 'DESATIVA_ORDENS_SUPERVISORIO'.
