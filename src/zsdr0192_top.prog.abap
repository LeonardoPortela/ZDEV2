...
TYPES: BEGIN OF ty_saida,
         cfop             TYPE ZSDT0362-cfop,
         desc_cfop        TYPE j_1bagnt-cfotxt,
         data_criacao     TYPE ZSDT0362-data_criacao,
         hora_CRIACAO     TYPE ZSDT0362-hora_criacao,
         usuario_criacao  TYPE ZSDT0362-usuario_criacao,
         excluido         TYPE ZSDT0362-excluido,
         data_exclusao    TYPE ZSDT0362-data_exclusao,
         hora_EXCLUSAO    TYPE ZSDT0362-hora_exclusao,
         usuario_EXCLUSAO TYPE ZSDT0362-usuario_exclusao,
...
DATA: it_saida        TYPE TABLE OF ty_saida,
      ...
      it_ZSDT0362     TYPE TABLE OF ZSDT0362,
      wa_ZSDT0362     TYPE ZSDT0362,
      wa_ZSDT0362_aux TYPE ZSDT0362.
