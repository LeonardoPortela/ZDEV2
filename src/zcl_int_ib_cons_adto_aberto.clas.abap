class ZCL_INT_IB_CONS_ADTO_ABERTO definition
  public
  final
  create public .
...
*    tb_matnr TYPE TABLE OF matnr .
  ...
  data:
      BEGIN OF zde_data_response,
        dados LIKE TABLE OF z_dados,

      END OF zde_data_response .
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '223' ##NO_TEXT.
...
CLASS ZCL_INT_IB_CONS_ADTO_ABERTO IMPLEMENTATION.
...
*      IF lwa_data_request-burks is INITIAL.
*        r_msg_erro = 'Informe o código da empresa'.
*        RETURN.
*      ENDIF.
*
*      IF lwa_data_request-lifnr is INITIAL.
*        r_msg_erro = 'Informe o código do fornecedor'.
*        RETURN.
*      ENDIF.
  ...
  METHOD ZIF_INTEGRACAO_INJECT~SET_INTEGRAR_INBOUND.
    ...
    DATA: lwa_data_request  LIKE zde_data_request,
          ...
          tg_partidas_abert TYPE ZFIE0206_T.
    ...
    CALL FUNCTION 'ZFI_CONSULT_ADIANT_ABERTO'
      EXPORTING
        I_LIFNR           = lwa_data_request-LIFNR
        I_BURKS           = lwa_data_request-BUKRS
     IMPORTING
       TG_ZFIE0206        = tg_partidas_abert.

     LOOP AT tg_partidas_abert ASSIGNING FIELD-SYMBOL(<WS_partidas>).

     APPEND INITIAL LINE TO lwa_data_response-dados ASSIGNING FIELD-SYMBOL(<fs_response>).

      <fs_response>-BUKRS = <WS_partidas>-BUKRS.
      <fs_response>-LIFNR = <WS_partidas>-LIFNR.
      <fs_response>-NAME1 = <WS_partidas>-NAME1.
      <fs_response>-BELNR = <WS_partidas>-BELNR.
      <fs_response>-GJAHR = <WS_partidas>-GJAHR.
      <fs_response>-BLART = <WS_partidas>-BLART.
      <fs_response>-DMBTR = <WS_partidas>-DMBTR.
     ENDLOOP.
