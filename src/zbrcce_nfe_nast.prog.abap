...
REPORT  ZBRCCE_NFE_NAST MESSAGE-ID 8B.
...
DATA: GWA_DADOS_CCE      TYPE ZBRCCE_NFE.
...
*------------------------------------------------------------------------------------------*
  ...
  CONCATENATE 'A Carta de Correcao e disciplinada pelo paragrafo 1o-A do art. 7o do'
...
FORM FM_GET_DADOS_CCE.
  ...
  CLEAR: GWA_CCE, GWA_DESTINATARIO, GWA_EMITENTE, GWA_J_1BNFDOC, GWA_DADOS_CCE, LVA_PARID.
