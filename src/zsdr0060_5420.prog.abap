...
DATA: tb_textos TYPE TABLE OF tdline.
TYPES:
  BEGIN OF ty_textos_5420,
    chave  TYPE tdobname,
    linhas LIKE tb_textos,
  END OF ty_textos_5420.
...
DATA: it_sol_5420          TYPE STANDARD TABLE OF ty_sol_5420,
      ...
      gt_textos_5420       TYPE TABLE OF ty_textos_5420. "Rubenilson - 05.09.24 - #140377
...
*** Inicio - Rubenilson - 05.09.24 - #140377
  METHOD on_but_clk.
    ...
    READ TABLE it_caminhao_5420 ASSIGNING FIELD-SYMBOL(<fs_caminhao>) INDEX es_row_no-row_id.
    IF sy-subrc IS INITIAL.

      lv_name = <fs_caminhao>-seq_cam && <fs_caminhao>-nro_sol && <fs_caminhao>-seq && <fs_caminhao>-filial_resp.

      READ TABLE gt_textos_5420 ASSIGNING FIELD-SYMBOL(<fs_textos_5420>)
      ...
      ELSE.
        ...
        LOOP AT <fs_textos_5420>-linhas ASSIGNING FIELD-SYMBOL(<fs_linhas>).
      ...
      IF lt_texto2 IS NOT INITIAL.
        ...
        READ TABLE gt_textos_5420 ASSIGNING <fs_textos_5420>
        WITH KEY chave = lv_name
        BINARY SEARCH.
        IF sy-subrc IS NOT INITIAL.

          APPEND INITIAL LINE TO gt_textos_5420 ASSIGNING <fs_textos_5420>.
          <fs_textos_5420>-chave = lv_name.

        ELSE.

          CLEAR <fs_textos_5420>-linhas.
        ...
        <fs_textos_5420>-linhas = lt_lines.
...
*-CS2019001896 - 12.08.2021 - JT - fim
  ...
  METHOD user_command_5420.
    ...
    DATA: it_selected_rows TYPE lvc_t_row,
          ...
          lw_header        TYPE thead, " Rubenilson - 10.09.24 - 140377
          lt_lines         TYPE TABLE OF tline, " Rubenilson - 10.09.24 - 140377
          lv_chave         TYPE ty_textos_5420-chave. " Rubenilson - 10.09.24 - 140377
...
*-CS2019001891 - 28.06.2021 - JT - fim
        ...
        MOVE icon_display_more TO wa_caminhao_5420-dados_adicionais." Rubenilson - 05.09.24 - #140377
    ...
    ELSEIF e_ucomm = 'ROMANEIO_CAM'.
      ...
      ELSE.
        ...
        SORT gt_textos_5420 BY chave." Rubenilson - 10.09.24 - 140377
...
*** Inicio - Rubenilson - 10.09.24 - 140377
                lv_chave = wa_caminhao_5420-seq_cam && wa_caminhao_5420-nro_sol && wa_caminhao_5420-seq && wa_caminhao_5420-filial_resp.

                READ TABLE gt_textos_5420 ASSIGNING FIELD-SYMBOL(<fs_textos>)
                ...
                IF sy-subrc IS INITIAL.
                  ...
                  IF sy-subrc IS INITIAL.
                    ...
                    DELETE gt_textos_5420 WHERE chave = lv_chave.
                    FREE: lt_lines.
                    CLEAR: lw_header,
                           lv_chave.
...
*-CS2019001896 - 12.08.2021 - JT - fim
    ...
    PERFORM fill_it_fieldcatalog TABLES it_fieldcatalog_frete_5420 USING:
           ...
           06 'ICONE'                     ' '          ' '  ' '  ' '  'X'   'X'   ' '   ' '   ' '   'P.Imp.',
*          User Story 153510 - MMSILVA
           07 'DESC_STATUS_ICONE'         ' '          ' '  ' '  ' '  ''    ''    ' '   ' '   ' '   'Desc. Status Icone'.
*          User Story 153510 - MMSILVA
    ...
    PERFORM fill_it_fieldcatalog TABLES it_fieldcatalog_caminhao_5420 USING:
          ...
          20 'DADOS_ADICIONAIS'     ' '         ' '     ' '  ' '  ' '   'X'   ' '   ' '   ' '   'Observação',"Rubenilson - 05.09.24 - #140377
*         User Story 153510 - MMSILVA
          21 'DESC_STATUS_ICONE'         ' '          ' '  ' '  ' '  ''    ''    ' '   ' '   ' '   'Desc. Status Icone'.
*         User Story 153510 - MMSILVA
...
*-----CS2019001891 - 08.03.2021 - JT - fim
    ...
    SET HANDLER:
      ...
      lcl_event_handler_5420=>on_but_clk FOR ctl_alv3_5420." Rubenilson - 10.09.24 - 140377
...
*** Inicio - Rubenilson - 05.09.24 - #140377
        LOOP AT it_caminhao_5420 ASSIGNING FIELD-SYMBOL(<fs_5420>).
          <fs_5420>-dados_adicionais = icon_display_more.
        ENDLOOP.
*** Fim - Rubenilson - 05.09.24 - #140377
        ...
        IF sy-subrc IS INITIAL.
          ...
          IF sy-subrc IS INITIAL.
            IF ( wa_j_1bnfe_active EQ '1').
              ...
              wa_caminhao_5420-icone = '@5Y@'.
              wa_caminhao_5420-desc_status_icone = 'Nota Fiscal Autorizada'.
            ENDIF.
          ENDIF.
...
FORM salva_frete_cam_5420.
  ...
  DATA: wa_caminhao_5420  TYPE ty_caminhao_5420,
        ...
        lt_lines          TYPE TABLE OF tline, " Rubenilson - 10.09.24 - 140377
        lv_chave          TYPE ty_textos_5420-chave, " Rubenilson - 10.09.24 - 140377
        lv_chave2         TYPE ty_textos_5420-chave. " Rubenilson - 10.09.24 - 140377
...
*** Inicio - Rubenilson - 10.09.24 - 140377
        ...
        IF sy-subrc IS NOT INITIAL.
          ...
          READ TABLE gt_textos_5420 ASSIGNING <fs_textos>
