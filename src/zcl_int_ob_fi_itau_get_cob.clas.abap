*&-------------------------------------------------------------------------------------------------------*
*& Classe         : ZCL_INT_OB_FI_ITAU_GET_COB                                                         *
...
*--------------------------------------------------------------------------------------------------------*
CLASS ZCL_INT_OB_FI_ITAU_GET_COB DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
* Busca Fatura Energia - Faturamento/Pagamento
    CONSTANTS AT_ID_INTERFACE TYPE ZDE_ID_INTERFACE VALUE '266' ##NO_TEXT.
    CONSTANTS:
      LC_SERVICO       TYPE C LENGTH 20 VALUE 'ITAU_GET_COB' ##NO_TEXT.
    CONSTANTS:
    ...
    DATA AT_PARAMS TYPE ZDE_IN_ITAU_COB.
    DATA AT_BODY TYPE ZDE_IN_ITAU_COB.
...
CLASS ZCL_INT_OB_FI_ITAU_GET_COB IMPLEMENTATION.
...
*    MOVE-CORRESPONDING AT_PARAMS TO ME->AT_BODY.
  ...
  METHOD ZIF_INTEGRACAO_OUTBOUND~GET_INSTANCE.
    ...
    IF ZIF_INTEGRACAO_OUTBOUND~AT_IF_INTEGRACAO_OUTBOUND IS NOT BOUND.
      CREATE OBJECT ZIF_INTEGRACAO_OUTBOUND~AT_IF_INTEGRACAO_OUTBOUND TYPE ZCL_INT_OB_FI_ITAU_GET_COB.
    ENDIF.
...
**** Informação do header
    ...
    APPEND VALUE #( NAME = 'txid' VALUE = |{ AT_PARAMS-TXID }| ) TO ME->ZIF_INTEGRACAO_INJECT~AT_HEADER_FIELDS.
