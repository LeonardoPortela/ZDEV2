interface ZIF_ATUALIZA_STATUS_MOBILE
  public .


  class-data AT_IF_ATUALIZA_STATUS_MOBILE type ref to ZIF_ATUALIZA_STATUS_MOBILE .
  ...
  class-data AT_STATUS_NOTA type ZTPM_STATUS_NOTA .

  class-methods GET_INSTANCE
    returning
      value(R_IF_ATUALIZA_STATUS_MOBILE) type ref to ZIF_ATUALIZA_STATUS_MOBILE
    raising
      ZCX_INTEGRACAO .
  methods SET_DS_URL
    returning
  ...
  methods SET_DS_URL_PUT
    returning
      value(R_IF_INTEGRACAO_COMB) type ref to ZIF_INTEGRACAO_COMB .
  methods POST_ATUALIZA_STATUS_MOBILE
    importing
      !I_STATUS_NOTA type ZTPM_STATUS_NOTA
    exporting
      !E_ID_INTEGRACAO type ZDE_ID_INTEGRACAO
      !E_INTEGRACAO type ZINTEGRACAO
      !E_DATA type STRING
  ...
  methods SET_DADOS_USUARIO
    importing
      !I_DATA type ZTPM_D_M_USUARIO
    returning
      value(R_IF_ATUALIZA_STATUS_MOBILE) type ref to ZIF_ATUALIZA_STATUS_MOBILE .
endinterface.
