...
*...Get all the Columns
        ...
        TRY.
            ...
            lo_column ?= lo_cols->get_column( 'SAKNR' ).
            lo_column->set_short_text( 'Ct.Razão' ).
            lo_column->set_medium_text( 'Conta Razão' ).
            lo_column->set_long_text( 'Conta Razão' ).

            lo_column ?= lo_cols->get_column( 'D_C' ).
            lo_column->set_short_text( 'D\C' ).
            lo_column->set_medium_text( 'D\C' ).
            lo_column->set_long_text( 'D\C' ).

            lo_column ?= lo_cols->get_column( 'DT_ENTRADA' ).
            lo_column->set_short_text( 'Data' ).
            lo_column->set_medium_text( 'Data' ).
            lo_column->set_long_text( 'Data' ).

            lo_column ?= lo_cols->get_column( 'HR_ENTRADA' ).
            lo_column->set_short_text( 'Hora' ).
            lo_column->set_medium_text( 'Hora' ).
            lo_column->set_long_text( 'Hora' ).

            lo_column ?= lo_cols->get_column( 'USNAM' ).
            lo_column->set_short_text( 'ID User' ).
            lo_column->set_medium_text( 'ID User' ).
            lo_column->set_long_text( 'ID User' ).

            lo_column ?= lo_cols->get_column( 'NAME_TEXT' ).
          ...
          WHEN 'DELETAR'.
            IF qtd_rows > 0.
              ...
              LOOP AT lt_rows ASSIGNING FIELD-SYMBOL(<_index>).
                ...
                CLEAR: wa_ZFIT0219.
                MOVE-CORRESPONDING <_del> TO wa_ZFIT0219.
                DELETE zfit0219 FROM wa_ZFIT0219.
              ENDLOOP.
