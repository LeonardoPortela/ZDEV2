  ...
  LOOP AT SCREEN.
    IF wa_header_lote-inco1 NE 'FOB'.
      IF wa_header_lote-inco1 EQ 'CIF' OR wa_header_lote-inco1 EQ 'CPT'.
        IF screen-name NE 'F8' AND screen-name NE 'WA_HEADER_LOTE-DT_ENTREGA' AND
           screen-name NE 'WA_HEADER_LOTE-ARMAZEM_ORG'. " Rubenilson - 30.09.24 - #144012.
          screen-input = 0.
        ENDIF.
      ELSE.
...
*-CS2019001891 - JT - 04.02.2021 - fim
  ...
  wa_zsdt0129-armazem_org   = wa_header_lote-armazem_org. " Rubenilson - 30.09.24 - #144012
