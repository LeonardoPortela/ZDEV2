class ZCL_INT_IB_OV_SIGAM definition
  public
  final
  create public .
...
public section.
  ...
  constants AT_ID_INTERFACE type ZDE_ID_INTERFACE value '185' ##NO_TEXT.
...
CLASS ZCL_INT_IB_OV_SIGAM IMPLEMENTATION.
...
*-----------------------------------------------------------------------------------------------------------------------*
    IF lwa_data_request IS INITIAL.
      ...
      ELSE.
        ...
        INTO @DATA(v_vbelm) WHERE
        vbeln = @lwa_data_request-ORDEM_venda.

      IF sy-subrc IS NOT INITIAL.
        r_msg_erro = 'N° da OV não localizado!'.
        e_status_code  = '404'.
        RETURN.
      ENDIF.
    ENDIF.
  ...
  METHOD zif_integracao_inject~set_integrar_inbound.
    ...
    IF lwa_data_request IS NOT INITIAL.
      ...
      IF sy-subrc IS INITIAL.
        lwa_data_response-mensagem = 'N° da OV localizado!'.
      ENDIF.
