...
DATA: SPLITTER_9010         TYPE REF TO CL_GUI_SPLITTER_CONTAINER,
      CTL_CCCONTAINER_HTML3 TYPE REF TO CL_GUI_CONTAINER,
      HTML_CONTROL_HTML3    TYPE REF TO CL_GUI_HTML_VIEWER.
...
MODULE VALIDA_SUBTOTAL2 INPUT.
  ...
  TRY .
      ...
      ZCL_FACTORY_CARGA=>ZIF_FACTORY_CARGA~GET_INSTANCE(
        ...
        )->GET_CALCULAR_SUBTOTAL(
             EXPORTING I_PESO_BRUTO = ZDE_ZSDT0001CG_VALIDA-NM_PESO_BRUTO I_PESO_TARA  = ZDE_ZSDT0001CG_VALIDA-NM_PESO_TARA
             IMPORTING E_PESO_SUBTOTAL = DATA(E_PESO_SUBTOTAL2)
        ).
...
*  CLEAR: CTL_PICTURE_9010.
  ...
  HTML_CONTROL_HTML3->FREE( ).
  CLEAR: HTML_CONTROL_HTML3.
  CTL_CCCONTAINER_HTML3->FREE( ).
  CLEAR: CTL_CCCONTAINER_HTML3.
  ...
  IF SPLITTER_9010 IS INITIAL.
    ...
    CALL METHOD SPLITTER_9010->GET_CONTAINER
      EXPORTING
        ...
        COLUMN    = 1
      RECEIVING
        CONTAINER = CTL_CCCONTAINER_HTML3. "CTL_PICTURE_9010.

    CREATE OBJECT HTML_CONTROL_HTML3
      EXPORTING
        PARENT = CTL_CCCONTAINER_HTML3. "CTL_PICTURE_9010
    "EXCEPTIONS
    "  ERROR  = 1.
...
*        ERROR        = 1.
    ...
    DATA: DATA_TABLE3 TYPE STANDARD TABLE OF TEXT255,
    ...
    CALL FUNCTION 'CONVERT_STRING_TO_TABLE'
      ...
      TABLES
        ET_TABLE         = DATA_TABLE3.

    "PERFORM LOAD_PIC_FROM_DB USING PICTURE_9010.

    HTML_CONTROL_HTML3->LOAD_DATA(
      IMPORTING
        ASSIGNED_URL           = I_URL
      CHANGING
