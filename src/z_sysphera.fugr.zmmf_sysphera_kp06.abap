FUNCTION ZMMF_SYSPHERA_KP06.
*"----------------------------------------------------------------------
*"*"Interface local:
*"  EXPORTING
*"     REFERENCE(IS_VALID) TYPE  CHAR50
*"  TABLES
*"      T_DESPESAS STRUCTURE  ZMM_SYSPHERA_KP06
*"----------------------------------------------------------------------
  ...
  DATA: IT_DESPESAS TYPE TABLE OF ZMM_SYSPHERA_KP06.

  TYPES: BEGIN OF ESTRUCT_DESPESAS,
           D LIKE IT_DESPESAS,
         END OF ESTRUCT_DESPESAS.

  DATA WA_RETORNO TYPE ESTRUCT_DESPESAS.
