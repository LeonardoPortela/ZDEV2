interface ZIF_ENVIA_CENTRO_MOBMAN
  public .


  class-data AT_ENVIA_CENTRO_MOBMAN type ref to ZCL_ENVIA_CENTRO_MOBMAN .
  ...
  class-data AT_CENTRO_TRAB type ZTPM_PAR_TB_CTRAB .

  class-methods GET_INSTANCE
    returning
      value(R_IF_ENVIA_CENTRO_MOBMA) type ref to ZIF_ENVIA_CENTRO_MOBMAN
    raising
      ZCX_INTEGRACAO .
  methods SET_DS_URL
    returning
  ...
  methods SET_DS_URL_PUT
    returning
      value(R_IF_INTEGRACAO_COMB) type ref to ZIF_INTEGRACAO_COMB .
  methods POST_ENVIA_CENTRO
    importing
      !I_CENTRO type ZTPM_PAR_TB_CTRAB
    exporting
      !E_ID_INTEGRACAO type ZDE_ID_INTEGRACAO
      !E_INTEGRACAO type ZINTEGRACAO
      !E_DATA type STRING
  ...
  methods SET_DADOS_CENTRO
    importing
      !I_DATA type ZTPM_PAR_TB_CTRAB
    returning
      value(R_IF_ENVIA_CENTRO_MOBMA) type ref to ZIF_ENVIA_CENTRO_MOBMAN .
endinterface.
