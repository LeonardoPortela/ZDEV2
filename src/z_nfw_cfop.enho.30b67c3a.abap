...
*  DATA: VG_SEQ_LCTO TYPE ZFIWRT0008-SEQ_LCTO,
*        VG_CFOP     type j_1bnflin-cfop.
*  IF sy-cprog = 'ZWRJ0001'.
*     IMPORT  VG_SEQ_LCTO  FROM MEMORY ID 'VMSEQ_LCTO'.
...
*         and ZFIWRT0001~LM_INDEA = 'S'
*         into VG_CFOP
*         where ZFIWRT0009~seq_lcto eq VG_SEQ_LCTO
*         and   ZFIWRT0009~cfop     ne ' '.
*       IF sy-subrc = 0.
*          cfop = VG_CFOP.
*       ENDIF.
