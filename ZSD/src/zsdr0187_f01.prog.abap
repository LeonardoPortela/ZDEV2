...
FORM criar_field_catalog.
  ...
  PERFORM estrutura_alv USING:
      ...
      0  'ZSDT0357'  'FKART'            'IT_SAIDA' 'FKART'                 'Tipo Fatura'      '10'  'X'    '' ' ' ' ' ' ' 'X' ' ' ' ',
      1  ''          'DESC_FKART'       'IT_SAIDA' 'DESC_FKART'            'Descrição'        '40'  ''     '' ' ' ' ' ' ' '' ' ' ' ',
      2  'ZSDT0357'  'DATA_CRIACAO'     'IT_SAIDA' 'DATA_CRIACAO'          'Data Criação'     '10'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      3  'ZSDT0357'  'HORA_CRIACAO'     'IT_SAIDA' 'HORA_CRIACAO'          'Hora Criação'     '10'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      4  'ZSDT0357'  'USUARIO_CRIACAO'  'IT_SAIDA' 'USUARIO_CRIACAO'       '  '               '30'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      5  'ZSDT0357'  'EXCLUIDO'         'IT_SAIDA' 'EXCLUIDO'              '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      6  'ZSDT0357'  'DATA_EXCLUSAO'    'IT_SAIDA' 'DATA_EXCLUSAO'         '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      7  'ZSDT0357'  'HORA_EXCLUSAO'    'IT_SAIDA' 'HORA_EXCLUSAO'         '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      8  'ZSDT0357'  'USUARIO_EXCLUSAO' 'IT_SAIDA' 'USUARIO_EXCLUSAO'      '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X'.
...
FORM selecionar_dados .
  ...
  SELECT *
    INTO TABLE it_zsdt0357
    FROM zsdt0357
    WHERE excluido EQ space.
  IF sy-subrc IS INITIAL.
    DATA(lt_zsdt0357) = it_zsdt0357.
    SORT lt_zsdt0357 BY fkart.
    DELETE ADJACENT DUPLICATES FROM lt_zsdt0357 COMPARING fkart.

    SELECT *
      FROM TVFKT
      INTO TABLE @DATA(lt_TVFKT)
      FOR ALL ENTRIES IN @lt_zsdt0357
      WHERE fkart = @lt_zsdt0357-fkart
        AND spras = @sy-langu.
    IF sy-subrc IS INITIAL.
  ...
  LOOP AT it_zsdt0357 INTO wa_zsdt0357.
    CLEAR: wa_saida.
    MOVE-CORRESPONDING wa_zsdt0357 TO wa_saida.
...
FORM deletar_reg.
  ...
  MOVE-CORRESPONDING wa_saida TO wa_zsdt0357.
  UPDATE zsdt0357 SET excluido          = abap_true
                      data_exclusao     = sy-datum
                      hora_exclusao     = sy-uzeit
                      usuario_exclusao  = sy-uname
                  WHERE fkart            = wa_zsdt0357-fkart
                    AND data_criacao    = wa_zsdt0357-data_criacao
                    AND hora_criacao    = wa_zsdt0357-hora_criacao
                    AND usuario_criacao = wa_zsdt0357-usuario_criacao.

  DELETE it_saida WHERE fkart            = wa_zsdt0357-fkart
                         AND data_criacao    = wa_zsdt0357-data_criacao
                         AND hora_criacao    = wa_zsdt0357-hora_criacao
                         AND usuario_criacao = wa_zsdt0357-usuario_criacao
                         AND excluido        = wa_zsdt0357-excluido.
  ...
  IF gv_modif IS NOT INITIAL AND gv_erro IS INITIAL.
    ...
    IF it_saida IS NOT INITIAL.
      ...
      LOOP AT it_saida ASSIGNING <l_saida>.
        ...
        MOVE-CORRESPONDING <l_saida> TO wa_zsdt0357.

        IF wa_zsdt0357-fkart IS INITIAL.
          ROLLBACK WORK.
        ...
        MODIFY zsdt0357 FROM wa_zsdt0357.
      ENDLOOP.
