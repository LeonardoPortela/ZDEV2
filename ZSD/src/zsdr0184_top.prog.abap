...
TYPES: BEGIN OF ty_saida,
         cfop             TYPE ZSDT0354-cfop,
         desc_cfop        TYPE j_1bagnt-cfotxt,
         data_criacao     TYPE ZSDT0354-data_criacao,
         hora_CRIACAO     TYPE ZSDT0354-hora_criacao,
         usuario_criacao  TYPE ZSDT0354-usuario_criacao,
         excluido         TYPE ZSDT0354-excluido,
         data_exclusao    TYPE ZSDT0354-data_exclusao,
         hora_EXCLUSAO    TYPE ZSDT0354-hora_exclusao,
         usuario_EXCLUSAO TYPE ZSDT0354-usuario_exclusao,
...
DATA: it_saida        TYPE TABLE OF ty_saida,
      ...
      it_ZSDT0354     TYPE TABLE OF ZSDT0354,
      wa_ZSDT0354     TYPE ZSDT0354,
      wa_ZSDT0354_aux TYPE ZSDT0354.
