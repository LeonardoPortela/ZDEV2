...
TYPES: BEGIN OF ty_saida,
         cfop             TYPE zsdt0352-cfop,
         desc_cfop        TYPE j_1bagnt-cfotxt,
         data_criacao     TYPE zsdt0352-data_criacao,
         hora_CRIACAO     TYPE zsdt0352-hora_criacao,
         usuario_criacao  TYPE zsdt0352-usuario_criacao,
         excluido         TYPE zsdt0352-excluido,
         data_exclusao    TYPE zsdt0352-data_exclusao,
         hora_EXCLUSAO    TYPE zsdt0352-hora_exclusao,
         usuario_EXCLUSAO TYPE zsdt0352-usuario_exclusao,
...
DATA: it_saida        TYPE TABLE OF ty_saida,
      ...
      it_ZSDT0352     TYPE TABLE OF zsdt0352,
      wa_ZSDT0352     TYPE zsdt0352,
      wa_ZSDT0352_aux TYPE zsdt0352.
