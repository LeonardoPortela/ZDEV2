...
TYPES: BEGIN OF ty_saida,
         fkart            TYPE zsdt0358-fkart,
         desc_fkart       TYPE tvfkt-vtext,
         data_criacao     TYPE zsdt0358-data_criacao,
         hora_CRIACAO     TYPE zsdt0358-hora_criacao,
         usuario_criacao  TYPE zsdt0358-usuario_criacao,
         excluido         TYPE zsdt0358-excluido,
         data_exclusao    TYPE zsdt0358-data_exclusao,
         hora_EXCLUSAO    TYPE zsdt0358-hora_exclusao,
         usuario_EXCLUSAO TYPE zsdt0358-usuario_exclusao,
...
DATA: it_saida        TYPE TABLE OF ty_saida,
      ...
      it_zsdt0358     TYPE TABLE OF zsdt0358,
      wa_zsdt0358     TYPE zsdt0358,
      wa_zsdt0358_aux TYPE zsdt0358.
