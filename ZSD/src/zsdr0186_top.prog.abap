...
TYPES: BEGIN OF ty_saida,
         matkl            TYPE zsdt0356-matkl,
         desc_matkl       TYPE t023t-wgbez,
         data_criacao     TYPE zsdt0356-data_criacao,
         hora_CRIACAO     TYPE zsdt0356-hora_criacao,
         usuario_criacao  TYPE zsdt0356-usuario_criacao,
         excluido         TYPE zsdt0356-excluido,
         data_exclusao    TYPE zsdt0356-data_exclusao,
         hora_EXCLUSAO    TYPE zsdt0356-hora_exclusao,
         usuario_EXCLUSAO TYPE zsdt0356-usuario_exclusao,
...
DATA: it_saida        TYPE TABLE OF ty_saida,
      ...
      it_ZSDT0356     TYPE TABLE OF zsdt0356,
      wa_ZSDT0356     TYPE zsdt0356,
      wa_ZSDT0356_aux TYPE zsdt0356.
...
CLASS lcl_alv_toolbar IMPLEMENTATION.
  ...
  METHOD handle_data_changed.
    ...
    IF et_good_cells IS NOT INITIAL.
      ...
      DELETE lt_saida WHERE desc_matkl IS INITIAL.
      SORT lt_saida BY matkl.

      DATA(lt_saida2) = it_saida.
      DELETE lt_saida2 WHERE desc_matkl IS NOT INITIAL.
      SORT lt_saida2 BY matkl.
      ...
      IF lt_good IS NOT INITIAL.
        ...
        IF sy-subrc IS INITIAL.
          ...
          LOOP AT lt_good ASSIGNING FIELD-SYMBOL(<fs_changed>).
            ...
            WITH KEY matkl = <fs_changed>-value
            BINARY SEARCH.
            IF sy-subrc IS INITIAL.
              ...
              ELSE.
                ...
                IF sy-subrc IS INITIAL.
                  ...
                  <fs_saida>-desc_matkl = <fs_T023T>-wgbez.
          ...
          IF lt_cell IS NOT INITIAL.
            ...
            MESSAGE 'Já existe um cadastro para este Grp. Mercadorias' TYPE 'S' DISPLAY LIKE 'E'.
