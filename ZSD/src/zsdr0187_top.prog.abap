...
TYPES: BEGIN OF ty_saida,
         fkart            TYPE zsdt0357-fkart,
         desc_fkart       TYPE tvfkt-vtext,
         data_criacao     TYPE zsdt0357-data_criacao,
         hora_CRIACAO     TYPE zsdt0357-hora_criacao,
         usuario_criacao  TYPE zsdt0357-usuario_criacao,
         excluido         TYPE zsdt0357-excluido,
         data_exclusao    TYPE zsdt0357-data_exclusao,
         hora_EXCLUSAO    TYPE zsdt0357-hora_exclusao,
         usuario_EXCLUSAO TYPE zsdt0357-usuario_exclusao,
...
DATA: it_saida        TYPE TABLE OF ty_saida,
      ...
      it_zsdt0357     TYPE TABLE OF zsdt0357,
      wa_zsdt0357     TYPE zsdt0357,
      wa_zsdt0357_aux TYPE zsdt0357.
...
CLASS lcl_alv_toolbar IMPLEMENTATION.
  ...
  METHOD handle_data_changed.
    ...
    IF et_good_cells IS NOT INITIAL.
      ...
      DELETE lt_saida WHERE desc_fkart IS INITIAL.
      SORT lt_saida BY fkart.

      DATA(lt_saida2) = it_saida.
      DELETE lt_saida2 WHERE desc_fkart IS NOT INITIAL.
      SORT lt_saida2 BY fkart.
      ...
      IF lt_good IS NOT INITIAL.
        ...
        IF sy-subrc IS INITIAL.
          ...
          LOOP AT lt_good ASSIGNING FIELD-SYMBOL(<fs_changed>).
            ...
            WITH KEY fkart = <fs_changed>-value
            BINARY SEARCH.
            IF sy-subrc IS INITIAL.
              ...
              ELSE.
                ...
                IF sy-subrc IS INITIAL.
                  ...
                  <fs_saida>-desc_fkart = <fs_TVFKT>-vtext.
          ...
          IF lt_cell IS NOT INITIAL.
            ...
            MESSAGE 'Já existe um cadastro para este Tipo Fatura' TYPE 'S' DISPLAY LIKE 'E'.
