...
FORM criar_field_catalog.
  ...
  PERFORM estrutura_alv USING:
      ...
      0  'ZSDT0359'  'FINALIDADE'       'IT_SAIDA' 'FINALIDADE'            'Finalidade'       '10'  'X'    '' ' ' ' ' ' ' 'X' ' ' ' ',
      1  ''          'DESC_FINALIDADE'  'IT_SAIDA' 'DESC_FINALIDADE'       'Descrição'        '40'  ''     '' ' ' ' ' ' ' '' ' ' ' ',
      2  'ZSDT0359'  'DATA_CRIACAO'     'IT_SAIDA' 'DATA_CRIACAO'          'Data Criação'     '10'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      3  'ZSDT0359'  'HORA_CRIACAO'     'IT_SAIDA' 'HORA_CRIACAO'          'Hora Criação'     '10'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      4  'ZSDT0359'  'USUARIO_CRIACAO'  'IT_SAIDA' 'USUARIO_CRIACAO'       '  '               '30'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      5  'ZSDT0359'  'EXCLUIDO'         'IT_SAIDA' 'EXCLUIDO'              '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      6  'ZSDT0359'  'DATA_EXCLUSAO'    'IT_SAIDA' 'DATA_EXCLUSAO'         '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      7  'ZSDT0359'  'HORA_EXCLUSAO'    'IT_SAIDA' 'HORA_EXCLUSAO'         '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      8  'ZSDT0359'  'USUARIO_EXCLUSAO' 'IT_SAIDA' 'USUARIO_EXCLUSAO'      '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X'.
...
FORM selecionar_dados .
  ...
  SELECT *
    INTO TABLE it_zsdt0359
    FROM zsdt0359
    WHERE excluido EQ space.
  IF sy-subrc IS INITIAL.
    DATA(lt_zsdt0359) = it_zsdt0359.
    SORT lt_zsdt0359 BY finalidade.
    DELETE ADJACENT DUPLICATES FROM lt_zsdt0359 COMPARING finalidade.
  ...
  LOOP AT it_zsdt0359 INTO wa_zsdt0359.
    CLEAR: wa_saida.
    MOVE-CORRESPONDING wa_zsdt0359 TO wa_saida.

    READ TABLE lt_values ASSIGNING FIELD-SYMBOL(<fs_values>)
    WITH KEY domvalue_l = wa_saida-finalidade
    BINARY SEARCH.
    IF sy-subrc IS INITIAL.
      wa_saida-desc_finalidade = <fs_values>-ddtext.
    ENDIF.
...
FORM deletar_reg.
  ...
  MOVE-CORRESPONDING wa_saida TO wa_zsdt0359.
  UPDATE zsdt0359 SET excluido          = abap_true
                      data_exclusao     = sy-datum
                      hora_exclusao     = sy-uzeit
                      usuario_exclusao  = sy-uname
                  WHERE finalidade      = wa_zsdt0359-finalidade
                    AND data_criacao    = wa_zsdt0359-data_criacao
                    AND hora_criacao    = wa_zsdt0359-hora_criacao
                    AND usuario_criacao = wa_zsdt0359-usuario_criacao.

  DELETE it_saida WHERE finalidade      = wa_zsdt0359-finalidade
                    AND data_criacao    = wa_zsdt0359-data_criacao
                    AND hora_criacao    = wa_zsdt0359-hora_criacao
                    AND usuario_criacao = wa_zsdt0359-usuario_criacao
                    AND excluido        = wa_zsdt0359-excluido.
...
FORM salvar_reg .
  ...
  IF gv_modif IS NOT INITIAL AND gv_erro IS INITIAL.
    ...
    DELETE it_saida WHERE desc_finalidade IS INITIAL.
    ...
    IF it_saida IS NOT INITIAL.
      ...
      LOOP AT it_saida ASSIGNING <l_saida>.
        ...
        MOVE-CORRESPONDING <l_saida> TO wa_zsdt0359.

        IF wa_zsdt0359-finalidade IS INITIAL.
          ROLLBACK WORK.
          MESSAGE 'Finalidade é um campo obrigatório!' TYPE 'S'.
          RETURN.
          EXIT.
        ENDIF.

        MODIFY zsdt0359 FROM wa_zsdt0359.
      ENDLOOP.
