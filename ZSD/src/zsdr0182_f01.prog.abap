...
FORM criar_field_catalog.
  ...
  PERFORM estrutura_alv USING:
      ...
      0  'ZSDT0352'  'CFOP'             'IT_SAIDA' 'CFOP'                  'CFOP'             '10'  'X'    '' ' ' ' ' ' ' 'X' ' ' ' ',
      1  ''          'DESC_CFOP'        'IT_SAIDA' 'DESC_CFOP'             'Descrição'        '40'  ''     '' ' ' ' ' ' ' '' ' ' ' ',
      2  'ZSDT0352'  'DATA_CRIACAO'     'IT_SAIDA' 'DATA_CRIACAO'          'Data Criação'     '10'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      3  'ZSDT0352'  'HORA_CRIACAO'     'IT_SAIDA' 'HORA_CRIACAO'          'Hora Criação'     '10'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      4  'ZSDT0352'  'USUARIO_CRIACAO'  'IT_SAIDA' 'USUARIO_CRIACAO'       '  '               '30'  ''     '' ' ' ' ' ' ' 'X' ' ' ' ',
      5  'ZSDT0352'  'EXCLUIDO'         'IT_SAIDA' 'EXCLUIDO'              '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      6  'ZSDT0352'  'DATA_EXCLUSAO'    'IT_SAIDA' 'DATA_EXCLUSAO'         '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      7  'ZSDT0352'  'HORA_EXCLUSAO'    'IT_SAIDA' 'HORA_EXCLUSAO'         '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X',
      8  'ZSDT0352'  'USUARIO_EXCLUSAO' 'IT_SAIDA' 'USUARIO_EXCLUSAO'      '  '               '2'   'X'    '' ' ' ' ' ' ' '' ' ' 'X'.
...
FORM selecionar_dados .
  ...
  SELECT *
    INTO TABLE it_ZSDT0352
    FROM zsdt0352
    WHERE excluido EQ space.
  IF sy-subrc IS INITIAL.
    DATA(lt_ZSDT0352) = it_ZSDT0352.
    SORT lt_ZSDT0352 BY cfop.
    DELETE ADJACENT DUPLICATES FROM lt_ZSDT0352 COMPARING cfop.

    SELECT *
      FROM j_1bagnt
      INTO TABLE @DATA(lt_j_1bagnt)
      FOR ALL ENTRIES IN @lt_ZSDT0352
      WHERE cfop = @lt_ZSDT0352-cfop.
    IF sy-subrc IS INITIAL.
      SORT lt_j_1bagnt BY cfop.
    ENDIF.
  ENDIF.

  LOOP AT it_ZSDT0352 INTO wa_ZSDT0352.
    CLEAR: wa_saida.
    MOVE-CORRESPONDING wa_ZSDT0352 TO wa_saida.
...
FORM deletar_reg.
  ...
  MOVE-CORRESPONDING wa_saida TO wa_ZSDT0352.
  UPDATE zsdt0352 SET excluido          = abap_true
                      data_exclusao     = sy-datum
                      hora_exclusao     = sy-uzeit
                      usuario_exclusao  = sy-uname
                  WHERE cfop            = wa_ZSDT0352-cfop
                    AND data_criacao    = wa_ZSDT0352-data_criacao
                    AND hora_criacao    = wa_ZSDT0352-hora_criacao
                    AND usuario_criacao = wa_ZSDT0352-usuario_criacao.

  DELETE it_saida WHERE cfop            = wa_ZSDT0352-cfop
                         AND data_criacao    = wa_ZSDT0352-data_criacao
                         AND hora_criacao    = wa_ZSDT0352-hora_criacao
                         AND usuario_criacao = wa_ZSDT0352-usuario_criacao
                         AND excluido        = wa_ZSDT0352-excluido.
  ...
  IF gv_modif IS NOT INITIAL AND gv_erro IS INITIAL.
    ...
    IF it_saida IS NOT INITIAL.
      ...
      LOOP AT it_saida ASSIGNING <l_saida>.
        ...
        MOVE-CORRESPONDING <l_saida> TO wa_ZSDT0352.

        IF wa_ZSDT0352-cfop IS INITIAL.
          ROLLBACK WORK.
        ...
        MODIFY zsdt0352 FROM wa_ZSDT0352.
      ENDLOOP.
