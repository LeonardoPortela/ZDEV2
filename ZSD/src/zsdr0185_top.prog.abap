...
TYPES: BEGIN OF ty_saida,
         cfop             TYPE ZSDT0355-cfop,
         desc_cfop        TYPE j_1bagnt-cfotxt,
         data_criacao     TYPE ZSDT0355-data_criacao,
         hora_CRIACAO     TYPE ZSDT0355-hora_criacao,
         usuario_criacao  TYPE ZSDT0355-usuario_criacao,
         excluido         TYPE ZSDT0355-excluido,
         data_exclusao    TYPE ZSDT0355-data_exclusao,
         hora_EXCLUSAO    TYPE ZSDT0355-hora_exclusao,
         usuario_EXCLUSAO TYPE ZSDT0355-usuario_exclusao,
...
DATA: it_saida        TYPE TABLE OF ty_saida,
      ...
      it_ZSDT0355     TYPE TABLE OF ZSDT0355,
      wa_ZSDT0355     TYPE ZSDT0355,
      wa_ZSDT0355_aux TYPE ZSDT0355.
